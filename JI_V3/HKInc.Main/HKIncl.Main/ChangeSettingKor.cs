...
{
    /// <summary>
    /// 20210818 오세완 차장 사용처가 없어서 비번이 7글자 이하인 경우에 강제 변경 용도로 사용 처리
    /// </summary>
    public partial class ChangeSettingKor : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            // 20210818 오세완 차장 7글자 검증 로직 넣자. 
            //TextEdit te = sender as TextEdit;
            //string sValue = te.EditValue.GetNullToEmpty();
            //if(sValue != null)
            //{
            //    if(sValue.Length > 7)
            //    {
        ...
        {
            HKInc.Service.Handler.MessageBoxHandler.Show("프로그램이 종료됩니다. 재시작이 필요합니다.");
            Close();
        }
        ...
        void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //else
            //{
            //    if(txtNewPwd.EditValue != null )
            //    {
            //        if(txtNewPwd.EditValue.GetNullToEmpty().Length <= 7)
            //        {
            //            HKInc.Service.Handler.MessageBoxHandler.Show("비밀번호는 8글자 이상 입력하셔야 합니다.");
            //        }
            //    }
            //}
