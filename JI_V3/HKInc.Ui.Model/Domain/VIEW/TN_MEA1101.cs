...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    [Table("TN_MEA1101T")]
    public class TN_MEA1101 : BaseDomain.MES_BaseDomain
    {
        public TN_MEA1101()
        {
        }
        /// <summary>계측기코드</summary>         
        [ForeignKey("TN_MEA1100"), Key, Column("INSTR_CODE", Order = 0), Required(ErrorMessage = "InstrCode")] public string InstrCode { get; set; }
        /// <summary>순번</summary>               
        ...
        public virtual TN_MEA1100 TN_MEA1100 { get; set; }
    }
}