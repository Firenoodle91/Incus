...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    public class TN_STD4M001 : BaseDomain.MES_BaseDomain
    {
        ...
        [Column("REQ_DOC_FILE_NAME")] public string ReqDocFileName { get; set; }
        [Column("REQ_DOC_FILE_DATA")] public byte[] ReqDocFileData { get; set; }
        [Column("CHK_QC_FILE_1CHA_NAME")] public string QcFileName1 { get; set; }
        [Column("CHK_QC_FILE_1CHA_DATA")] public byte[] QcFileData1 { get; set; }
        [Column("CHK_QC_FILE_2CHA_NAME")] public string QcFileName2 { get; set; }
        [Column("CHK_QC_FILE_2CHA_DATA")] public byte[] QcFileData2 { get; set; }
        [Column("CHK_QC_FILE_3CHA_NAME")] public string QcFileName3 { get; set; }
        [Column("CHK_QC_FILE_3CHA_DATA")] public byte[] QcFileData3 { get; set; }

        [Column("ETC_FILE_NAME1")] public string EtcFileName1 { get; set; }
        [Column("ETC_FILE_DATA1")] public byte[] EtcFileData1 { get; set; }
        [Column("ETC_FILE_NAME2")] public string EtcFileName2 { get; set; }
        [Column("ETC_FILE_DATA2")] public byte[] EtcFileData2 { get; set; }
        [Column("ETC_FILE_NAME3")] public string EtcFileName3 { get; set; }
        [Column("ETC_FILE_DATA3")] public byte[] EtcFileData3 { get; set; }
        [Column("ETC_FILE_NAME4")] public string EtcFileName4 { get; set; }
        [Column("ETC_FILE_DATA4")] public byte[] EtcFileData4 { get; set; }
        [Column("ETC_FILE_NAME5")] public string EtcFileName5 { get; set; }
        [Column("ETC_FILE_DATA5")] public byte[] EtcFileData5 { get; set; }
