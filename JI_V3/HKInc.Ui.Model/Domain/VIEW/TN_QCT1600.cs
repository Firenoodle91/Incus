...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    public class TN_QCT1600 : BaseDomain.MES_BaseDomain
    {
        ...
        [Key, Column("DEP_DIVISION", Order = 4), Required(ErrorMessage = "DepDivision")] public string DepDivision { get; set; }

        /// <summary>순번</summary>                  
        [Key, Column("SEQ", Order = 5), Required(ErrorMessage = "Seq")] public Int32 Seq { get; set; }
