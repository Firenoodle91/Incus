...
{
    /// <summary>작업실적관리 마스터(리워크)</summary>	
    [Table("TN_MPS1205T")]
    public class TN_MPS1205 : BaseDomain.MES_BaseDomain
    {
        public TN_MPS1205()
        {
            TN_MPS1206List = new List<TN_MPS1206>();
            TN_MPS1207List = new List<TN_MPS1207>();         
        }
        ...
        public virtual ICollection<TN_MPS1206> TN_MPS1206List { get; set; }
        public virtual ICollection<TN_MPS1207> TN_MPS1207List { get; set; }
    }
}