...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR_NOT_IN_STATUS : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("PoQty", LabelConvert.GetLabelText("PoQty"), HorzAlignment.Far, FormatType.Numeric, "n0");
            GridExControl.MainGrid.AddColumn("InQty", LabelConvert.GetLabelText("InQty"), HorzAlignment.Far, FormatType.Numeric, "n0");
            //GridExControl.MainGrid.AddColumn("OKQty", LabelConvert.GetLabelText("PassQty"), HorzAlignment.Far, FormatType.Numeric, "n2");
            GridExControl.MainGrid.AddColumn("NotInQty", LabelConvert.GetLabelText("NotInQty"), HorzAlignment.Far, FormatType.Numeric, "n0");
        }
