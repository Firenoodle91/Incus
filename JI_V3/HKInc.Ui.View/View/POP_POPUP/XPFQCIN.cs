...
namespace HKInc.Ui.View.View.POP_POPUP
{
    public partial class XPFQCIN : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XPFQCIN(TEMP_XFPOP1000 obj, string lotno, object objimg)
        {
            InitializeComponent();
        ...
        public XPFQCIN(string workno,string processcode,string item,string mc ,string lotno)
        {
            InitializeComponent();
            GridExControl = gridEx1;
            //initGrid();
        ...
        public XPFQCIN(string workno, string processcode, string item, string mc, string lotno,string lsif)
        {
            InitializeComponent();
            GridExControl = gridEx1;
            //initGrid();
        ...
        public XPFQCIN(TEMP_XFPOP1000 obj, string lotno)
        {
            InitializeComponent();
            GridExControl = gridEx1;
            //initGrid();
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("CheckDataType", LabelConvert.GetLabelText("CheckDataType"), false);
            GridExControl.MainGrid.AddColumn("CheckList", "검사항목");
            GridExControl.MainGrid.AddColumn("CheckWay", "검사방법");
            GridExControl.MainGrid.AddColumn("CheckSpec", "규격", HorzAlignment.Near, true);
            GridExControl.MainGrid.AddColumn("CheckMin", "하한", HorzAlignment.Center, true);
            GridExControl.MainGrid.AddColumn("CheckMax", "상한", HorzAlignment.Center, true);
            GridExControl.MainGrid.AddColumn("Reading1", "검사값", HorzAlignment.Center, true);
            GridExControl.MainGrid.AddColumn("Judge", "판정");
           // GridExControl.MainGrid.AddColumn("DisplayOrder", "순서");
