...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 이동표 새 출력시 박스내 수량
    /// </summary>
    public partial class XPFITEMMOVEPRINT_BOX_RUS : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFITEMMOVEPRINT_BOX_RUS()
        {
            InitializeComponent();
        }

        public XPFITEMMOVEPRINT_BOX_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void InitCombo()
        {
            ...
            spin_BoxInQty.Properties.Mask.EditMask = "n2";
