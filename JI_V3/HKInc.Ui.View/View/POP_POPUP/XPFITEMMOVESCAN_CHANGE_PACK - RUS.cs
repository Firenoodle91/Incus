...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 이동표 교체 (포장)
    /// </summary>
    public partial class XPFITEMMOVESCAN_CHANGE_PACK_RUS : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFITEMMOVESCAN_CHANGE_PACK_RUS()
        {
            InitializeComponent();
        }

        public XPFITEMMOVESCAN_CHANGE_PACK_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
