...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 포장 작업완료
    /// </summary>
    public partial class XPFPACK_END_RUS : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFPACK_END_RUS()
        {
            InitializeComponent();
        }

        public XPFPACK_END_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
