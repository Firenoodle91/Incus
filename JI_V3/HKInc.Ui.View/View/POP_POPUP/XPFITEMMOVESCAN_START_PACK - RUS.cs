...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 작업 시작 시 이동표 스캔 (포장)
    /// </summary>
    public partial class XPFITEMMOVESCAN_START_PACK_RUS : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFITEMMOVESCAN_START_PACK_RUS()
        {
            InitializeComponent();
        }

        public XPFITEMMOVESCAN_START_PACK_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        private void Tx_ItemMoveNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                lup_PriviousProcessName.EditValue = ds.Tables[1].Rows[0][2].GetNullToEmpty();
                lup_NowProcessName.EditValue = ds.Tables[1].Rows[0][4].GetNullToEmpty();
                lup_NextProcessName.EditValue = ds.Tables[1].Rows[0][6].GetNullToEmpty();
            }
        }
