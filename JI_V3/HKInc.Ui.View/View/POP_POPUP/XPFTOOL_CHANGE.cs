...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 설비별 공구 리스트 등록
    /// </summary>
    public partial class XPFTOOL_CHANGE : Service.Base.PopupCallbackFormTemplate
    {
        #region 전역변수
        ...
        public XPFTOOL_CHANGE(PopupDataParam parameter, PopupCallback callback) : this()
        {
