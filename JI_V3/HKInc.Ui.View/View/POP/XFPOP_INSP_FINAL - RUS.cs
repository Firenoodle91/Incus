...
namespace HKInc.Ui.View.View.POP
{
    ...
    /// 최종검사POP (MES에서 사용)
    /// </summary>
    public partial class XFPOP_INSP_FINAL_RUS : Service.Base.ListMasterDetailFormTemplate
    {
        IService<TN_MPS1201> ModelService = (IService<TN_MPS1201>)ProductionFactory.GetDomainService("TN_MPS1201");

        public XFPOP_INSP_FINAL_RUS()
        {
            InitializeComponent();
        ...
        protected override void InitGrid()
        {
           ...
           // DetailGridExControl.SetToolbarButtonVisible(GridToolbarButton.DeleteRow, false);
            ...
            DetailGridExControl.MainGrid.AddColumn("ItemName1", LabelConvert.GetLabelText("ItemName1"), false); // 20210824 오세완 차장 품목명 누락 추가
        ...
        protected override void DeleteDetailRow()
        {
            ...
            IPopupForm form = ProductionPopupFactory.GetPopupForm(ProductionPopupView.XPFRESULT_INSP_FINAL, param, ResultAddCallback);
            form.ShowPopup(true);
        }
        ...
        private void BarWorkEnd_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            int cnt = ModelService.GetChildList<TN_QCT1100>(p => p.CheckDivision == MasterCodeSTR.InspectionDivision_Final && p.WorkNo == obj.WorkNo && p.ProductLotNo == obj.ProductLotNo).Count();
            if (cnt == 0) {
                MessageBoxHandler.Show("최종검사 치수데이터가 입력되어 있지 않습니다. 확인 부탁드립니다.");
                return;
            }
