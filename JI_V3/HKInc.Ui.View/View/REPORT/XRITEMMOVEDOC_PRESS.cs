...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    public partial class XRITEMMOVEDOC_PRESS : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRITEMMOVEDOC_PRESS(TEMP_ITEM_MOVE_NO_MASTER masterObj) : this()
        {
            ...
            cell_ItemName1.Text = cultureIndex == 1 ? itemObj.ItemName.GetNullToEmpty() : (cultureIndex == 2 ? itemObj.ItemNameENG.GetNullToEmpty() : itemObj.ItemNameCHN.GetNullToEmpty());
