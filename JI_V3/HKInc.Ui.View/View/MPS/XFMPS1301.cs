    ...
    public partial class XFMPS1301 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            lupItem.SetDefault(true, "ItemCode", DataConvert.GetCultureDataFieldName("ItemName"), ModelService.GetChildList<TN_STD1100>(p => (p.TopCategory == MasterCodeSTR.TopCategory_WAN || p.TopCategory == MasterCodeSTR.TopCategory_BAN) && 
                                                                                                                                             p.UseFlag == "Y").ToList()); // 20210615 오세완 차장 유미대리 요청에 따라 반제품도 추가해야 함
        }
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("ItemName1", LabelConvert.GetLabelText("ItemName1"), false); // 20210615 오세완 차장 화면설계서대로 품목명 추가
        ...
        protected override void DataLoad()
        {
            ...
            using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
            {
                ...
                //var result = context.Database.SqlQuery<TEMP_XFMPS1301>("USP_GET_MPS1301_LIST @WorkDate, @RateYn", date, rateYn).ToList();
                var result = context.Database.SqlQuery<TEMP_XFMPS1301>("USP_GET_MPS1301_LIST_V2 @WorkDate, @RateYn", date, rateYn).ToList(); // 20210615 오세완 차장 품목명 때문에 프로시저 교체
