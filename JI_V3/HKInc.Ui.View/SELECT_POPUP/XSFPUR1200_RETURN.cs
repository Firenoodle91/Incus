...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    /// 자재반품팝업
    /// </summary>
    public partial class XSFPUR1200_RETURN : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        IService<VI_PUR1304> ModelService = (IService<VI_PUR1304>)ProductionFactory.GetDomainService("VI_PUR1304");
        private bool IsmultiSelect = true;

        public XSFPUR1200_RETURN()
        {
            InitializeComponent();
        }

        public XSFPUR1200_RETURN(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void Confirm()
        {
            ...
            if (IsmultiSelect)
            {
                var returnList = new List<VI_PUR1304>();
                var dataList = ModelBindingSource.List as List<VI_PUR1304>;
            ...
            {
                param.SetValue(PopupParameter.ReturnObject, ModelService.Detached((VI_PUR1304)ModelBindingSource.Current));
            }
        ...
        private void MainView_RowClick(object sender, RowClickEventArgs e)
        {
            ...
            if (e.Clicks == 2)
            {
                var InMaster = (VI_PUR1304)ModelBindingSource.Current;
                if (IsmultiSelect)
                {
                    var returnList = new List<VI_PUR1304>();
                    if (InMaster != null)
