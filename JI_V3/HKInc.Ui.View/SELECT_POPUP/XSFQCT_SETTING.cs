...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    /// 설정검사 대상 Select 팝업
    /// </summary>
    public partial class XSFQCT_SETTING : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        IService<VI_INSP_SETTING_OBJECT> ModelService = (IService<VI_INSP_SETTING_OBJECT>)ProductionFactory.GetDomainService("VI_INSP_SETTING_OBJECT");
        private bool IsmultiSelect = true;

        public XSFQCT_SETTING()
        {
            InitializeComponent();
        }

        public XSFQCT_SETTING(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void Confirm()
        {
            ...
            var obj = (VI_INSP_SETTING_OBJECT)ModelBindingSource.Current;
            if (IsmultiSelect)
            {
                var returnList = new List<VI_INSP_SETTING_OBJECT>();
                if (obj != null)
