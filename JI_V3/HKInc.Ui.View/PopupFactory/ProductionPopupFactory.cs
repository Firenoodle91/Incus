...
namespace HKInc.Ui.View.PopupFactory
{
    class ProductionPopupFactory
    {
        private static Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>> EditFormList = new Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>>()
        {
            ...
            { ProductionPopupView.SELECT_STD1400, (param, callback) => new SELECT_POPUP.XSFSTD1400(param, callback)},
            ...
            #region TOOL
            { ProductionPopupView.XPFTOOL1004, (param, callback) => new View.TOOL_POPUP.XPFTOOL1004(param, callback)},
            #endregion
            ...
            { ProductionPopupView.XPFTOOL_LIFECNT, (param, callback) => new View.POP_POPUP.XPFTOOL_LIFECNT(param, callback)},
            { ProductionPopupView.XPFTOOL_CHANGE, (param, callback) => new View.POP_POPUP.XPFTOOL_CHANGE(param, callback)},
            { ProductionPopupView.XPFANDON, (param, callback) => new View.POP_POPUP.XPFANDON(param, callback)},
            #endregion
        };
