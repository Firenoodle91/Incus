...
{ 
    ...
    public class ProductionFactory
    {
        private static Dictionary<string, Func<object>> DomainList = new Dictionary<string, Func<object>>()
        {
            ...
            {"TN_STD1103_MASTER", () => new ProductionService<TN_STD1103_MASTER>()},
            {"TN_STD1104", () => new ProductionService<TN_STD1104>()},
            {"TN_STD1105", () => new ProductionService<TN_STD1105>()},
            ...
            {"TN_QCT1102", () => new ProductionService<TN_QCT1102>()},          // 2022-09-26 김진우 추가
            ...
            {"TN_UPH_DATA", () => new ProductionService<TN_UPH_DATA>()},
            {"TN_MEA1400", () => new ProductionService<TN_MEA1400>()},
            {"TN_MTTF1000", () => new ProductionService<TN_MTTF1000>()},
            ...
            #region TOOL
            {"TN_TOOL1000", () => new ProductionService<TN_TOOL1000>()},
            ...
            {"TN_TOOL1004", () => new ProductionService<TN_TOOL1004>()},
            {"TN_TOOL1005", () => new ProductionService<TN_TOOL1005>()},
            {"TN_TOOL1100", () => new ProductionService<TN_TOOL1100>()},
            {"TN_TOOL1101", () => new ProductionService<TN_TOOL1101>()},
            #endregion
            ...
            {"VI_PUR_INOUT_LIST", () => new ProductionService<VI_PUR_INOUT_LIST>()}, //2022-05-03 JI버전 자재재고
            {"VI_STD1100_BOMTREE", () => new ProductionService<VI_STD1100_BOMTREE>()},// 20210201 오세완 차장 bom관리 품목코드 콤보박스 컨트롤 조회용
            {"VI_UPH_REPORT", () => new ProductionService<VI_UPH_REPORT>()},
            {"VI_SPC_VALUE", () => new ProductionService<VI_SPC_VALUE>()},
