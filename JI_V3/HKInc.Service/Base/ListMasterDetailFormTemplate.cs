    ...
    public partial class ListMasterDetailFormTemplate : BaseForm
    {
        ...
        protected override void InitControls()
        {
            ...
            if (MasterGridExControl != null)
            {
                ...
                if(IsMasterGridFocusedRowChangedEnabled)
        ...
        {
            if (DetailGridExControl != null) DetailGridExControl.MainGrid.PostEditor();
            try { DetailExportClicked(); } catch (Exception ex) { MessageBoxHandler.ErrorShow(ex); }
        }
        ...
        protected virtual void DetailExportClicked()
        {
