    ...
    public partial class ChangeSetting : DevExpress.XtraEditors.XtraForm
    {
        ...
        void SetLoginPathRadioGroup()
        {
            ...
            if (GetDomainUser(out domainName, out domainUserId))
                ...
                loginPath = GetLoginPathRegistry(HKInc.Utils.Common.GlobalVariable.LoginId);
        ...
        void SetNotificationPathRadioGroup()
        {
            ...
            string notiMethod = GetNotificationRegistry(string.IsNullOrEmpty(HKInc.Utils.Common.GlobalVariable.LoginId) ? HKInc.Utils.Common.GlobalVariable.LoginId : HKInc.Utils.Common.GlobalVariable.LoginId);
