...
namespace HKInc.Main
{
    public partial class LoginFormHKInc : XtraForm
    {
        ...
        void DoLoingCheck()
        {
            UserLogin = LoginFactory.GetUserLogin();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (comboBox1.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    GlobalVariable.ProcessCode = 10;// comboBox1.SelectedItem.GetNullToEmpty();// "P03";
                    break;
                case 2:
                    GlobalVariable.ProcessCode = 11;// comboBox1.SelectedItem.GetNullToEmpty();// "P05";
                    break;
                case 3:
                    GlobalVariable.ProcessCode = 6;// comboBox1.SelectedItem.GetNullToEmpty();// "P06";
                    break;
                //case 4:
