...
namespace HKInc.Ui.View.SYS
{
    public partial class ScreenList : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.MainView.Columns["Description"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(gridEx1, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.SetRepositoryItemLookUpEdit("ModuleId", 
