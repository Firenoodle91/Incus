...
namespace HKInc.Ui.View.MPS
{
    public partial class XFMPS1500 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            //lupItem.SetDefault(true, "ItemCode", "ItemNm1", ModelService.GetChildList<TN_STD1100>(p => p.UseYn == "Y"&&(p.TopCategory=="P01"||p.TopCategory=="P05")).OrderBy(o=>o.ItemNm1).ToList());
        ...
        {
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("BOTTOM_CATEGORY", DbRequesHandler.GetCommCode(MasterCodeSTR.CARTYPE), "Mcode", "Codename");
