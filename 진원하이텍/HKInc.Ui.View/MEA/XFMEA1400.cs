...
namespace HKInc.Ui.View.MEA
{
    public partial class XFMEA1400 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("ProcessCode", "공정코드");
            ...
            GridExControl.MainGrid.AddColumn("StPostion1", "위치1");
            GridExControl.MainGrid.AddColumn("StPostion2", "위치2");
            GridExControl.MainGrid.AddColumn("StPostion3", "위치3");
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.SetRepositoryItemLookUpEdit("CheckCycle",  DbRequesHandler.GetCommCode(MasterCodeSTR.CHECKCYCLE).ToList(), "Mcode", "Codename");
            ...
            GridExControl.MainGrid.SetRepositoryItemLookUpEdit("ProcessCode", DbRequesHandler.GetCommCode(MasterCodeSTR.Process, 1), "Mcode", "Codename");
        }
        protected override void DataLoad()
        {
            ...
            if (useyn == "Y")
            {
                GridBindingSource.DataSource = ModelService.GetList(p => p.MoldCode.Contains(tx_MCnm.Text) || p.MoldMcode.Contains(tx_MCnm.Text)||p.MoldName.Contains(tx_MCnm.Text))
