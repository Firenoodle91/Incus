...
namespace HKInc.Ui.View.SELECT_Popup
{
    ...
    public partial class XSFMACHINE_CHECK_COPY : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        {
            lup_Machine.SetDefault(true, "MachineCode","MachineName", ModelService.GetChildList<TN_MEA1000>(p => p.UseYn == "Y" && p.DailyCheckFlag == "Y").ToList());
        }
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.SetEditable(true, "_Check");
        }
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("Division", DbRequesHandler.GetCommTopCode(MasterCodeSTR.MachineStandardCheckDivision), "CodeVal", "CodeName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckPosition", DbRequesHandler.GetCommTopCode(MasterCodeSTR.MachineCheckPosition), "CodeVal","CodeName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckList", DbRequesHandler.GetCommTopCode(MasterCodeSTR.MachineCheckList), "CodeVal","CodeName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckWay", DbRequesHandler.GetCommTopCode(MasterCodeSTR.MachineCheckWay), "CodeVal","CodeName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckCycle", DbRequesHandler.GetCommTopCode(MasterCodeSTR.CHECKCYCLE), "CodeVal","CodeName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckStandardDate", DbRequesHandler.GetCommTopCode(MasterCodeSTR.MachineCheckStandardDate), "CodeVal","CodeName");
