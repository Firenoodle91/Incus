...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XSFSTD1100 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("Spec1","선경");
            gridEx1.MainGrid.AddColumn("Spec2","외경");
            gridEx1.MainGrid.AddColumn("Spec3","자유고");
            gridEx1.MainGrid.AddColumn("Spec4", "권수");
        ...
        protected override void InitRepository()
        {
            ...
            //gridEx1.MainGrid.SetRepositoryItemCheckEdit("UseYn", "N");
