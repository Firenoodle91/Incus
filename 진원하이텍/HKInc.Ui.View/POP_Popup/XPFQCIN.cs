...
namespace HKInc.Ui.View.POP_Popup
{
    public partial class XPFQCIN : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XPFQCIN(TP_POPJOBLIST obj,string lotno)
        {
            ...
            //QcLoad(MasterCodeSTR.INSPECTION_TYP_C);
        }
        ...
        private void MainView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                lup_qc.ReadOnly = true; ;
                tx_qc.ReadOnly = false;
                tx_qc.Focus();
            }
        }
        ...
        {
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ProcessGu", DbRequesHandler.GetCommCode(MasterCodeSTR.QCKIND), "Mcode", "Codename");
        ...
        {
            qctype = qc;
            GridBindingSource.DataSource = ModelService.GetList(p => p.ItemCode == lsobj.ItemCode 
                                                                //&& (p.ProcessGu == qc || p.ProcessGu== MasterCodeSTR.INSPECTION_TYP_G)
                                                                && (p.ProcessGu == qc)
                                                                && p.ProcessCode == lsobj.Process && p.UseYn == "Y").ToList();
        ...
        /// 초중종검사
        /// </summary>
        private void btn_Fme_Click(object sender, EventArgs e)
        {
            QcLoad(MasterCodeSTR.INSPECTION_TYP_C);
        }
        ...
        {
            QcLoad(MasterCodeSTR.INSPECTION_TYP_G);
        }
    }
}
