...
namespace HKInc.Ui.View.REPORT
{
    public partial class XRORD2000 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRORD2000(string cust,string emp) : this()
        {
            ...
            decimal amt = DbRequesHandler.GetCellValue("SELECT     sum(isnull([OUT_QTY], 0) * isnull([OUT_PRICE],0))   FROM [TN_ORD2001T] where OUTPRT_NO = '" + emp + "' group by OUTPRT_NO", 0).GetDecimalNullToZero();
