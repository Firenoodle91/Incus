...
namespace HKInc.Ui.View.MPS
{
    public partial class XFBAN1100 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ProductItemcode", ModelService.GetChildList<TN_STD1100>(p => p.UseYn == "Y" && p.TopCategory != "P03").OrderBy(o=>o.ItemNm1).ToList(), "ItemCode", "ItemNm1");
