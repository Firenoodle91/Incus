...
namespace HKInc.Ui.View.MEA
{
    public partial class XFMEA1500 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemLookUpEdit("CheckCycle", DbRequesHandler.GetCommCode(MasterCodeSTR.CHECKCYCLE).ToList(), "Mcode", "Codename");
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemLookUpEdit("ReqType", DbRequesHandler.GetCommCode(MasterCodeSTR.MOLDReqType).ToList(), "Mcode", "Codename");
        ...
        protected override void DataLoad()
        {
            ...
            MasterGridBindingSource.DataSource = ModelService.GetList(p => (string.IsNullOrEmpty(lMachinecode) ? true : (p.MoldMcode.Contains(lMachinecode) || p.MoldCode.Contains(lMachinecode)||p.MoldName.Contains(lMachinecode)))).ToList();
