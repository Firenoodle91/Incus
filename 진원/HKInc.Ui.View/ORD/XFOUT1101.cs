...
namespace HKInc.Ui.View.ORD
{
    public partial class XFOUT1101 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("Spec1", "선경", true, HorzAlignment.Center);
            MasterGridExControl.MainGrid.AddColumn("Spec2", "외경", true, HorzAlignment.Center);
            MasterGridExControl.MainGrid.AddColumn("Spec3", "자유고", true, HorzAlignment.Center);
            MasterGridExControl.MainGrid.AddColumn("Spec4", "권수", true, HorzAlignment.Center);
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("SrcCode", ModelService.GetChildList<TN_STD1100>(P => P.UseYn == "Y"&&(P.TopCategory=="P03"||P.TopCategory == "P02")).OrderBy(o => o.ItemNm).ToList(), "ItemCode", "ItemNm1");
        ...
        protected override void InitCombo()
        {
            ...
            lupItemcode.SetDefault(true, "ItemCode", "ItemNm1", ModelService.GetList());
