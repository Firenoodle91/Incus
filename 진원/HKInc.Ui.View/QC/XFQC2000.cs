...
namespace HKInc.Ui.View.QC
{
    public partial class XFQC2000 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        private void AddList(object sender, HKInc.Utils.Common.PopupArgument e)
        {
            ...
            TN_STD1100 TN_STD1100Data = ModelService.GetChildList<TN_STD1100>(p => p.ItemCode == partList.ItemCode).FirstOrDefault();

            TN_QCT1200 QCT1200 = new TN_QCT1200();

            QCT1200.No = DbRequesHandler.GetRequestNumber(qctype);
            QCT1200.FmeNo = qctype;
            QCT1200.WorkNo = partList.WorkNo;
            QCT1200.WorkDate = partList.WorkDate;
            QCT1200.CheckDate = DateTime.Today;
            QCT1200.FmeDivision = DbRequesHandler.GetCellValue("exec SP_QCSTEP_STEP '" + qctype + "','" + partList.WorkDate + "','" + partList.WorkNo + "','" + partList.ProcessCode + "','" + DateTime.Today + "'", 0);
