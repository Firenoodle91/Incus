...
namespace HKInc.Utils.Common
{
    public class GlobalVariable
    {
       ...
       // public static string AdUserId { get { return userInfo.ADUser; } }
        public static string UserName { get { return userInfo.UserName; } }
        public static string EmployeeNo { get { return userInfo.EmployeeNo; } }

        //public static bool IsPOPUser { get { return userInfo.IsPopUser == "Y" ? true : false; } }
        public static string IsPOPUser {get{return string.IsNullOrEmpty(userInfo.IsPopUser) ? string.Empty : userInfo.IsPopUser;}} 
        ...
        public static string DBPasswd { get; set; }
        ...
        public static string ALamST1 { get; set; }
        public static string ALamSM1 { get; set; }
        public static string ALamST2 { get; set; }
        public static string ALamSM2 { get; set; }
