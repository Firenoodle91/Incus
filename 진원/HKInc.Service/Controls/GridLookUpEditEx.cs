...
namespace HKInc.Service.Controls
{
    ...
    public partial class GridLookUpEditEx : GridLookUpEdit
    {
        ...
        public void SetDefault(bool bDeleteButtonVisible = true, string valueMember = "CodeId", string displayMember = "CodeName", object dataSource = null, TextEditStyles textEditStyles = TextEditStyles.Standard, HorzAlignment horz = HorzAlignment.Near, EventHandler PopupEvent = null)
        {
            ...
            //if (valueMember == "ItemCode" && displayMember == "ItemNm1")
            if (valueMember == "ItemCode")
            {
                //Properties.View.OptionsView.ShowColumnHeaders = true;
                Properties.PopupFormMinSize = new Size(400, 300);

                Properties.View.Columns[0].Visible = false;
                Properties.View.Columns[1].Visible = false;

                Properties.View.Columns.Add(new GridColumn { FieldName = valueMember, Caption = "품목코드", Visible = true });
                Properties.View.Columns.Add(new GridColumn { FieldName = "ItemNm1", Caption = "품번", Visible = true });
                Properties.View.Columns.Add(new GridColumn { FieldName = "ItemNm", Caption = "품명", Visible = true });
            }
        }
