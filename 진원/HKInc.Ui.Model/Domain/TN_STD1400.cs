...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_STD1400 : BaseDomain.MES_BaseDomain
    {
        ...
        [Key, Column("CUSTOMER_CODE",Order =0), StringLength(20), Required(ErrorMessage = "Customer Code is required.")]
        public string CustomerCode { get; set; }

        [Column("CUSTOMER_NAME"), StringLength(100)]
        public string CustomerName { get; set; }

      
        [Column("DEFAULT_COMPANY_PLAG")]
        public string DefaultCompanyPlag { get; set; }


     

        [Column("CUSTOMER_CATEGORY_CODE")]
        public string CustomerCategoryCode { get; set; }

        [Column("CUSTOMER_CATEGORY_TYPE")]
        ...
        [Column("EMP_IN_TELEPHONE")]
        public string EmpInTelephone { get; set; }
        ...
        [Column("USE_PLAG"), Required(ErrorMessage = "UseFlag is required.")]
        public string UseFlag { get; set; }
        [Column("CUST_TYPE")]
        public string CustType { get; set; }

        [NotMapped]
        public string ReqCustcode { get { return CustomerCode; } }
    }
}
