...
namespace HKInc.Ui.View.View.MPS_POPUP
{
    ...
    public partial class XPFMPS1600 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        public XPFMPS1600(VI_SRC_STOCK_SUM item )
        {
            ...
            //tx_ItemName1.Text = item.TN_STD1100.ItemName1;
            tx_lotno.Text = "";
        ...
        public XPFMPS1600(VI_SRC_USE item)
        {
            ...
            tx_lotno.Text = item.SrcLotNo.GetNullToEmpty();
        ...
        public XPFMPS1600(VI_SRC_STOCK item)
        {
            InitializeComponent();
        ...
        protected override void DataSave()
        {
            ...
            if (isnew == "NEW")
            {
                sql = "INSERT INTO TN_SRC1001T (STOCK_ADJUST_DATE, SRC_CODE,SRC_IN_LOT_NO ,IN_QTY, USE_QTY, INS_DATE, INS_ID)" +
                      "VALUES ( '" + dp_dt.DateTime.Date.ToString().Substring(0, 10) + "', " +
                      "'" + tx_itemCode.EditValue.GetNullToEmpty() + "', " +
                      "'" + tx_lotno.EditValue.GetNullToEmpty() + "', " +
                      "'" + inqty + "', " +
                      "'" + outqty + "', " +
                ...
                sql = "UPDATE TN_SRC1001T " +
                      "SET IN_QTY = '" + inqty + "' " +
                      ", USE_QTY = '" + outqty + "' " +
                      ", SRC_IN_LOT_NO = '" + tx_lotno.EditValue.GetNullToEmpty() + "' " +
