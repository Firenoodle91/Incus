...
namespace HKInc.Ui.View.View.MOLD
{
    ...
    public partial class XFMOLD1300 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InOutId", ModelService.GetChildList<User>(p => p.Active == "Y"), "LoginId", DataConvert.GetCultureDataFieldName("UserName"));
