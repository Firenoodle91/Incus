...
namespace HKInc.Ui.View.PopupFactory
{
    class ProductionPopupFactory
    {
        private static Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>> EditFormList = new Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>>()
        {
            ...
            { ProductionPopupView.PFSTD1100_V2, (param, callback) => new View.STD_POPUP.XPFSTD1100_V2(param, callback)}, // 20220119 오세완 차장 케이즈이노텍 스타일 품목기준정보 팝업
            ...
            {ProductionPopupView.XPFWORK_START, (param, callback) => new View.POP_POPUP.XPFWORKSTART(param, callback) }, // 20220204 오세완 차장 케이즈이노텍 스타일 팝업 추가
            #endregion
        };
