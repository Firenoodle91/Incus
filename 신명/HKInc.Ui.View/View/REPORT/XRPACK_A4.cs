...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    public partial class XRPACK_A4 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRPACK_A4(TEMP_XFPOP_PACK TEMP_XFPOP_PACK, int perBoxQty, string printDate, int printQty) : this()
        {
            var cultureIndex = DataConvert.GetCultureIndex();
            
            var itemCode = TEMP_XFPOP_PACK.ItemCode;
            var itemName = cultureIndex == 1 ? TEMP_XFPOP_PACK.ItemName : (cultureIndex == 2 ? TEMP_XFPOP_PACK.ItemNameENG : TEMP_XFPOP_PACK.ItemNameCHN);
