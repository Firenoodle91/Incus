...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 실적등록 팝업 (기본)
    /// </summary>
    public partial class XPFRESULT_TOOL : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFRESULT_TOOL()
        {
            InitializeComponent();
        }

        public XPFRESULT_TOOL(PopupDataParam parameter, PopupCallback callback) : this()
        {
            ...
            GridExControl.DataSource = BadBindingSource;
        ...
        protected override void InitControls()
        {
            ...
            GridExControl.MainGrid.MainView.Click += MainView_Click;
        ...
        {
            if (BadBindingSource.Count == 0) return;
        ...
        protected override void InitGrid()
        {
            ...
            //GridExControl.MainGrid.AddColumn("BadQty", LabelConvert.GetLabelText("BadQty"));
            GridExControl.MainGrid.MainView.Columns["BadType"].Caption = LabelConvert.GetLabelText("BadType");
            GridExControl.MainGrid.MainView.Columns["BadQty"].Caption = LabelConvert.GetLabelText("BadQty");
        ...
        {
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("BadType", DbRequestHandler.GetCommTopCode(MasterCodeSTR.BadType_POP), "CodeVal", Service.Helper.DataConvert.GetCultureDataFieldName("CodeName"));
        }
            ...
            try
            {
              ...
              //  detailNewObj.BadType = badType;
                ...
                if (TEMP_XFPOP1000_Obj.ProcessSeq == 1)
                {
                    ...
                    if (wanBomObj != null)
                    {
                        banBomObj = ModelService.GetChildList<TN_STD1300>(p => p.ParentBomCode == wanBomObj.BomCode && p.MgFlag == "Y").FirstOrDefault();
                    }
                    if (banBomObj != null)
        ...
        private void BanUsingQty(decimal useQty)
        {
            ...
            TN_SRC1000 newObj = new TN_SRC1000();
            newObj.WorkNo = TN_LOT_MST.WorkNo;
            newObj.ProductLotNo = TN_LOT_MST.ProductLotNo;
            newObj.ParentSeq = TN_LOT_DTL.Seq;
            newObj.Seq = TN_LOT_DTL.TN_SRC1000List.Count == 0 ? 1 : TN_LOT_DTL.TN_SRC1000List.Max(p => p.Seq) + 1;
            //newObj.SrcInLotNo = TN_LOT_DTL.SrcInLotNo;
            newObj.SrcInLotNo = TN_LOT_DTL.SrcInLotNo == "" ? "##" : TN_LOT_DTL.SrcInLotNo;
            newObj.SpendQty = resultQty * useQty;
