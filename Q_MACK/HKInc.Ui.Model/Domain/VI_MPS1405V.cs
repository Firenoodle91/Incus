...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class VI_MPS1405V
    {
        ...
        [Column("ItemNm")] public string ItemNm { get; set; }                       // 2022-02-16 김진우 추가
        [Column("ItemNm1")] public string ItemNm1 { get; set; }                     // 2022-02-16 김진우 추가
        [Column("MachineName")] public string MachineName { get; set; }             // 2022-04-13 김진우 추가
        [Key,Column("RowId",Order =3)]        public decimal RowId { get; set; }

        [NotMapped] public string EditRowFlag { get; set; }                     // 수정시 구분을 위한 추가        2022-07-19 김진우
