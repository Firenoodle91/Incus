...
namespace HKInc.Ui.View.STD
{
    public partial class XFSTD1500 :  HKInc.Service.Base.TreeListFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            TreeListExControl.TreeList.Columns["Unit"].ColumnEdit = HKInc.Service.Factory.RepositoryFactory.GetRepositoryItemLookUpEdit( DbRequestHandler.GetCommCode(MasterCodeSTR.Unit), "Mcode", "Codename");
