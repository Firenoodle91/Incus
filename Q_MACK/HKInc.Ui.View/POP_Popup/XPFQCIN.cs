...
namespace HKInc.Ui.View.POP_Popup
{
    public partial class XPFQCIN : HKInc.Service.Base.ListFormTemplate
    {
        ...
        {
            lup_qc.SetDefault(true, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.QCOKNG));
            lupXseq.SetDefault(false, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.XSEQ));
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("ProcessGu", "검사종류");
        ...
        {
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ProcessGu", DbRequestHandler.GetCommCode(MasterCodeSTR.QCKIND), "Mcode", "Codename");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckName", DbRequestHandler.GetCommCode(MasterCodeSTR.QCPOINT), "Mcode", "Codename");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckProv", DbRequestHandler.GetCommCode(MasterCodeSTR.QCTYPE), "Mcode", "Codename");
        }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            TN_QCT1200 qc = new TN_QCT1200()
            {
                ...
                No = DbRequestHandler.GetRequestNumber("Q03"),
                FmeNo = "Q03",// qctype,
                ...
                FmeDivision = DbRequestHandler.GetCellValue("exec SP_QCSTEP_STEP 'Q03','" + lsobj.WorkDate + "','" + lsobj.WorkNo + "','" + lsobj.Process + "','" + DateTime.Today + "'", 0),
