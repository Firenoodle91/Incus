...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XFSPUR1200 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("ItemCode", "품목코드"); // 20220217 오세완 차장 공통사항으로 수정 요창한 것 수정
            gridEx1.MainGrid.AddColumn("TN_STD1100.ItemNm", "품목");
            gridEx1.MainGrid.AddColumn("TN_STD1100.ItemNm1", "품명");
        ...
        {
            // 20220217 오세완 차장 품목코드, 품목, 품번을 전부 출력하게 수정하기 때문에 불필요
            //gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("ItemCode", ModelService.GetChildList<TN_STD1100>(p => p.UseYn == "Y").OrderBy(o => o.ItemNm).ToList(), "ItemCode", "ItemNm");
        }
