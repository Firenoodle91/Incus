...
{
    public partial class XPFSTOP : XtraForm
    {
            ...
            public XPFSTOP(string obj)
        {
            ...
            machine = obj;
            DataSet ds = DbRequestHandler.GetDataQury("SELECT       [MCODE]      ,[CODE_NAME] FROM [TN_STD1000T] where CODE_MAIN='P003' and CODE_MID!='00'");
        ...
        private void btn_click(object sender, EventArgs e)
        {
            ...
            if (ctl != null)
            {
                TN_MPS1600 obj = new TN_MPS1600()
                {
                    ...
                    StopSeq = DbRequestHandler.GetRequestNumber("STOP"),
                    MachineCode = machine,
                    StopCode = ctl.Name,
