    ...
    public partial class XFMEA1300 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        private void MainView_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            ...
            if (e.RowHandle >= 0)
            {
                ...
                if (NextCheck == null)
                {
                    switch (checkturn.GetNullToEmpty())         // 2022-03-07 김진우 GetNullToEmpty 추가
                    {
                        case "18":
        ...
        private void MainView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                switch (tn.CorTurn.GetNullToEmpty())        // 2022-02-18 김진우 GetNullToEmpty 추가
                {
                    case "18":
        ...
        private void chechkDate()
        {
            ...
            switch (tn.CorTurn.GetNullToEmpty())            // 2022-03-07 김진우 GetNullToEmpty 추가
            {
                case "18":
                    tn.NxcorDate = dt.AddDays(1);
                    break;
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("InstrNo", "계측기관리번호");
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemLookUpEdit("Maker", DbRequestHandler.GetCommCode(MasterCodeSTR.TOOLMAKER), "Mcode", "Codename");      // 2022-04-15 김진우 추가
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CheckGu", DbRequestHandler.GetCommCode(MasterCodeSTR.CheckGu), "Mcode", "Codename");
        }
        ...
        protected override void DataLoad()
        {
            ...
            string lMachinecode = tx_Instr.Text;

            MasterGridBindingSource.DataSource = ModelService.GetList(p => (p.InstrNo.Contains(tx_Instr.Text) || p.InstrNm.Contains(tx_Instr.Text))
