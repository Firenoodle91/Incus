...
{
    public partial class POP_PopupCallbackFormTemplate : BaseForm, IPopupCallbackForm
    {
        ...
        public POP_PopupCallbackFormTemplate()
        {
            InitializeComponent();
        }

        public POP_PopupCallbackFormTemplate(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void BaseForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                {
                    DialogResult result = MessageBoxHandler.Show(MessageHelper.GetStandardMessage(30), LabelConvert.GetLabelText("Confirm"), MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
