...
namespace HKInc.Service.Controls
{
    ...
    public partial class GridLookUpEditEx : GridLookUpEdit
    {
        ...
        public void SetDefault(bool bDeleteButtonVisible = true, string valueMember = "CodeId", string displayMember = "CodeName", object dataSource = null, TextEditStyles textEditStyles = TextEditStyles.Standard, HorzAlignment horz = HorzAlignment.Near, EventHandler PopupEvent = null)
        {
            ...
            // 20220219 오세완 차장 SearchGridLookUpEditEx 와 동일하게 처리 
        ...
        /// <summary>
        /// 20220219 오세완 차장 품목코드 3단 출력으로 변경 
        /// </summary>
        /// <param name="edit"></param>
        /// <param name="fieldName"></param>
        /// <param name="valueMember"></param>
        /// <param name="displayMember"></param>
        private void ItemCodeColumnSetting(DevExpress.XtraEditors.Repository.RepositoryItemGridLookUpEdit edit, string fieldName, string valueMember, string displayMember)
        {
            ...
            else
            {
                edit.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
                {
                    ...
                    Caption = "품목",                   // 2022-04-25 김진우 품번에서 품목으로 수정
                    Visible = true
                });

                edit.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
                {
                    FieldName = "ItemNm1",              // 2022-04-25 김진우 ItemNm 에서 ItemNm1로 수정
                    Caption = "품번",                   // 2022-04-25 김진우 품명에서 품번으로 수정
                    Visible = true
                });
            }
        }
