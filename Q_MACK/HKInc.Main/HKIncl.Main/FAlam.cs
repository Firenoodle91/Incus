...
namespace HKInc.Main
{
    public partial class FAlam : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public FAlam()
        {
            ...
            cb_time1.Text = HKInc.Service.Service.DbRequestHandler.GetCellValue(sql, 0);
            cb_mm1.Text = HKInc.Service.Service.DbRequestHandler.GetCellValue(sql, 1);
            cb_time2.Text = HKInc.Service.Service.DbRequestHandler.GetCellValue(sql, 2);
            cb_mm2.Text = HKInc.Service.Service.DbRequestHandler.GetCellValue(sql, 3);
        }
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            HKInc.Service.Service.DbRequestHandler.SetDataQury(sql);
            this.Close();
        }
