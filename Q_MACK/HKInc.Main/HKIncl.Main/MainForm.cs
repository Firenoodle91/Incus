...
namespace HKInc.Main
{
    public partial class MainForm : XtraForm, IMainFormMessage, IReloadDashboard, IToolBar
    {
        ...
        void SetToolbar()
        {
            ...
            ButtonList.Add(ToolbarButton.Screen, barButtonScreen);
        ...
        void ToolbarButtonClick(object sender, ItemClickEventArgs e)
        {
            ...
            else if (e.Item.Tag.GetIntNullToZero() == (int)ToolbarButton.Screen) OpenScreen();
     ...
     //       SetToolbarButtonVisible(ToolbarButton.Pop, true);
        ...
        void OpenPop()
        {
            HKInc.Ui.View.POP.XFPOP001_V2 form = new HKInc.Ui.View.POP.XFPOP001_V2();
            form.Show();
        }
        ...
        void OpenScreen()
        {
            HKInc.Ui.View.POP.FPOP010 form = new HKInc.Ui.View.POP.FPOP010();
            form.Show();
        }
        ...
        void SetMidPage()
        {
            ...
            this.mdiManager.AppearancePage.HeaderActive.Font = new Font(this.mdiManager.AppearancePage.HeaderActive.Font, FontStyle.Bold);
            this.mdiManager.AppearancePage.HeaderActive.ForeColor = Color.Blue;
        }
        #endregion
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.Text = "(주)큐맥 제조수행 시스템 [" + GlobalVariable.DatabaseIP.GetNullToEmpty() + ", " + GlobalVariable.ProductionDataBaseName.GetNullToEmpty() + "]";
            ...
            beepPlay1.sTime = GlobalVariable.ALamST1;
            beepPlay1.sMin= GlobalVariable.ALamSM1;

            beepPlay1.eTime = GlobalVariable.ALamST2;
            beepPlay1.eMin = GlobalVariable.ALamSM2;
        ...
        private void beepPlay1_Click(object sender, EventArgs e)
        {
            //FAlam fm = new FAlam();
            //fm.ShowDialog();
        }

        private void beepPlay1_Click_1(object sender, EventArgs e)
        {

        }

        private void beepPlay1_beepevent(object sender, EventArgs e)
        {
            Alarm fm = new Alarm();         // 2022-08-18 김진우 추가
            //FAlam1 fm = new FAlam1();
            fm.ShowDialog();
        }
    }
}