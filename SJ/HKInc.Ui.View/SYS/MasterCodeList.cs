...
namespace HKInc.Ui.View.SYS
{
    ...
    public partial class MasterCodeList : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            LayoutControlHandler.SetRequiredGridHeaderColor<CodeMaster>(MasterGridExControl);
            LayoutControlHandler.SetRequiredGridHeaderColor<CodeMaster>(DetailGridExControl);
        ...
        protected override void DataLoad()
        {
            ...
            radioValue = rbo_UseFlag.SelectedValue.GetNullToEmpty();
        ...
        protected override void DeleteDetailRow()
        {
            ...
            if (obj != null)
            {
                DialogResult result = MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_50), LabelConvert.GetLabelText("MasterCode")), HelperFactory.GetLabelConvert().GetLabelText("Confirm"), MessageBoxButtons.YesNo);
        ...
        private void LoadDetail()
        {
            ...
            if (obj != null)
            {
                DetailGridBindingSource.DataSource = obj.CodeMasterDetailList
                                                        .Where(p=> (radioValue == "A" ? true : p.Active == radioValue))
