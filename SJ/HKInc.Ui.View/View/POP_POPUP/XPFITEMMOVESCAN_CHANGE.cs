...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 이동표교체
    /// </summary>
    public partial class XPFITEMMOVESCAN_CHANGE : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFITEMMOVESCAN_CHANGE()
        {
            InitializeComponent();
        }

        public XPFITEMMOVESCAN_CHANGE(PopupDataParam parameter, PopupCallback callback) : this()
        {
