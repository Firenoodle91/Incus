...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    public partial class XPFPACK_END : Service.Base.PopupCallbackFormTemplate
    {
        ...
        {
            var sumObj = ModelService.GetChildList<TN_MPS1201>(p => p.WorkNo == TEMP_XFPOP_PACK.WorkNo && p.ProcessCode == TEMP_XFPOP_PACK.ProcessCode && p.ProcessSeq == TEMP_XFPOP_PACK.ProcessSeq).ToList();
