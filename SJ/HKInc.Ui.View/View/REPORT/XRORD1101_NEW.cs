...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    /// 출고증
    /// </summary>
    public partial class XRORD1101_NEW : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRORD1101_NEW()
        {
            InitializeComponent();

            cell_No.BeforePrint += Cell_No_BeforePrint;
            cell_OrderNo.BeforePrint += Cell_OrderSeq_BeforePrint;
        ...
        public XRORD1101_NEW(List<TN_ORD1101> list) : this()
        {
        ...
        {
            if (cell_OrderNo.Text == "-0")
                cell_OrderNo.Text = string.Empty;
        }
