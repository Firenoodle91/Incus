...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    /// 출고증
    /// </summary>
    public partial class XRORD1101_NEW3 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRORD1101_NEW3(List<TN_ORD1101> list) : this()
        {
            ...
            {
                IService<TN_MPS1200> ModelService = (IService<TN_MPS1200>)ProductionFactory.GetDomainService("TN_MPS1200");
                cell_ManagerName.Text = ModelService.GetChildList<User>(p => p.LoginId == managerCode).First().UserName + "　　　(인)";                
            }
            else
            {
                cell_ManagerName.Text = "　　　(인)";
            }
