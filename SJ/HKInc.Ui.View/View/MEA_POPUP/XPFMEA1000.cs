...
namespace HKInc.Ui.View.View.MEA_POPUP
{
    ...
    public partial class XPFMEA1000 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void AddControlList()
        {
            ...
            ControlEnableList.Add("ProcessCode", lup_ProcessCode);
        ...
        {
            lup_ProcessCode.SetDefault(true, "CodeVal", Service.Helper.DataConvert.GetCultureDataFieldName("CodeName"), DbRequestHandler.GetCommCode(MasterCodeSTR.Process, 1));
