...
namespace HKInc.Ui.View.View.ORD
{
    ...
    public partial class XFORD1100 : HKInc.Service.Base.ListMasterDetailSubDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            //DetailGridExControl.MainGrid.AddColumn("TN_STD1100.CarType", LabelConvert.GetLabelText("CarType")); // 20220209 오세완 차장 케이즈이노텍은 차종 필요 없을 듯 하여 삭제 처리
            ...
            DetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "OrderQty", "OrderCost", "Memo", "CustomerWorkNo", "CustomerOrderPartName", "DlvDate"); // 20220209 오세완 차장 컬럼 추가되어 작성할 수 있게 처리

            //SubDetailGridExControl.MainGrid.AddColumn("DelivNo", LabelConvert.GetLabelText("DelivNo"), false);
            SubDetailGridExControl.MainGrid.AddColumn("DelivNo", LabelConvert.GetLabelText("DelivNo")); // 20220103 오세완 차장 이태식 차장이 출력 요구하여 처리
        ...
        protected override void InitRepository()
        {
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemDateEdit("DlvDate"); // 20220209 오세완 차장 납기 준수일 추가
