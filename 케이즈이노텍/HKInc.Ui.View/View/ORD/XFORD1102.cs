...
namespace HKInc.Ui.View.View.ORD
{
    ...
    public partial class XFORD1102 : Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("OrderQty", LabelConvert.GetLabelText("OrderQty"), HorzAlignment.Far, FormatType.Numeric, "#,0.##");
        ...
        protected override void DataLoad()
        {
            ...
            using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
            {
                ...
                var result = context.Database.SqlQuery<TEMP_XFORD1102_MASTER>("USP_GET_XFORD1102_MASTER @DelivDateFr, @DelivDateTo, @ItemCode ,@CustomerCode ,@DelivState, @JobState"
                                                                                , DelivDateFr, DelivDateTo, ItemCode, CustomerCode, DelivState, JobState).ToList();
