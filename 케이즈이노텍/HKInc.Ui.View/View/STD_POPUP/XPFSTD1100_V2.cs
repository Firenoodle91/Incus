...
namespace HKInc.Ui.View.View.STD_POPUP
{
    /// <summary>
    /// 20211210 오세완 차장 
    /// 인천정밀 대표가 요구한 케이즈 스타일 품목기준정보 팝업
    /// </summary>
    public partial class XPFSTD1100_V2 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void AddControlList()
        {
            ...
            ControlEnableList.Add("ItemName", me_ItemName);
            ...
            // 20220311 오세완 차장 컬러코드 및 약칭 추가 
            ControlEnableList.Add("Temp1", tx_Colorcode);
            ControlEnableList.Add("Temp2", tx_Color_nickname);
            // 20220314 오세완 차장 컬러명 추가 
            ControlEnableList.Add("ColorName", tx_Colorname);
        ...
        {
            // 20211210 오세완 차장 인천정밀 대표님 요구 사항으로 자유 입력으로 변경
        ...
        protected override void DataLoad()
        {
            ...
            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                var newObj = new TN_STD1100()
                {
                    ...
                    // 20211210 오세완 차장 인천정밀 대표님이 수동 입력 요구하셔서 기능 해제
        ...
        private void SetControlEnableToTopCategory()
        {
            ...
            else if (topCategory == MasterCodeSTR.TopCategory_WAN || topCategory == MasterCodeSTR.TopCategory_BAN || topCategory == MasterCodeSTR.TopCategory_BAN_Outsourcing) // 20210524 오세완 차장 반제품을 자사 / 타사로 구분해서 타사를 추가처리
            {
                ...
                spin_ProcessPackQty.EditValue = null;
                     ...
                     topCategory == MasterCodeSTR.TopCategory_Paint_material || topCategory == MasterCodeSTR.TopCategory_Injection)
            {
                // 20211227 오세완 차장 안료품 및 사출품 제어 추가 
                ...
                chk_StockInspFlag.ReadOnly = false;
                //chk_StockInspFlag.EditValue = "Y";
                chk_StockInspFlag.EditValue = "N"; // 20220103 오세완 차장 이태식 차장 요청으로 기본 설정을 N으로 변경
