...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    /// 초중종물 대상 Select 팝업
    /// </summary>
    public partial class XSFQCT_FME : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        IService<VI_INSP_FME_OBJECT> ModelService = (IService<VI_INSP_FME_OBJECT>)ProductionFactory.GetDomainService("VI_INSP_FME_OBJECT");
        ...
        public XSFQCT_FME(PopupDataParam parameter, PopupCallback callback) : this()
        {
            this.PopupParam = parameter;
            this.Callback = callback;
            this.Text = LabelConvert.GetLabelText("Inspection_FME_Object");
        ...
        protected override void Confirm()
        {
            ...
            //if (IsmultiSelect)
            //{
            //    var returnList = new List<VI_INSP_FME_OBJECT>();
            //    var dataList = ModelBindingSource.List as List<VI_INSP_FME_OBJECT>;
            ...
            //else
            //{
            //    param.SetValue(PopupParameter.ReturnObject, ModelService.Detached((VI_INSP_FME_OBJECT)ModelBindingSource.Current));
            //}
            //ReturnPopupArgument = new PopupArgument(param);
            //ActClose();

            var obj = (VI_INSP_FME_OBJECT)ModelBindingSource.Current;
            if (IsmultiSelect)
            {
                var returnList = new List<VI_INSP_FME_OBJECT>();
                if (obj != null)
