...
namespace HKInc.Ui.Model.Domain.VIEW
{
   ...
   [Table("TN_ORD1001T")]
    public class TN_ORD1001 : BaseDomain.MES_BaseDomain
    {
        ...
        /// <summary>
        /// 20220209 오세완 차장
        /// 연우 작업지시번호, 엑셀 업로드 때문에 추가 처리 
        /// </summary>
        [Column("CUSTOMER_WORK_NO")]
        public string CustomerWorkNo { get; set; }

        /// <summary>
        /// 20220209 오세완 차장
        /// 연우 후공정부서 및 거래처, 엑셀 업로드 때문에 추가 처리 
        /// </summary>
        [Column("CUSTOMER_ORDER_PART_NAME")]
        public string CustomerOrderPartName { get; set; }
        /// <summary>메모</summary>                 
