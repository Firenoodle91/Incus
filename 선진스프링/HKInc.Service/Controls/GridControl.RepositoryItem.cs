    ...
    partial class GridControlEx
    {
        public void SetRepositoryItem(string fieldName, RepositoryItem item, bool CustomOnlyNumeric = false)
        {
            ...
            else if (item.GetType() == typeof(RepositoryItemDateEdit))
            {
                ...
                if(con.VistaCalendarInitialViewStyle == VistaCalendarInitialViewStyle.YearsGroupView)
                {

                }
                else if (con.VistaCalendarInitialViewStyle == VistaCalendarInitialViewStyle.YearView)
                {
        ...
        {
            var culture = HKInc.Service.Helper.DataConvert.GetCultureIndex();
            ...
            if (displayMember == "ItemCode")
            {
                ...
                edit.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
                {
                    FieldName = HKInc.Service.Helper.DataConvert.GetCultureDataFieldName("ItemName"),
            ...
            else
            {
                ...
                {
                    FieldName = HKInc.Service.Helper.DataConvert.GetCultureDataFieldName("ItemName"),
                    Caption = HelperFactory.GetLabelConvert().GetLabelText(HKInc.Service.Helper.DataConvert.GetCultureDataFieldName("ItemName")),
                    Visible = true
                });
            }
        }
