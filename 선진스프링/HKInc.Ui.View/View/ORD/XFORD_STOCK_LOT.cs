...
namespace HKInc.Ui.View.View.ORD
{
    ...
    public partial class XFORD_STOCK_LOT : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        List<TN_ORD1201> TN_ORD1201_List = new List<TN_ORD1201>();
        public XFORD_STOCK_LOT()
        {
            ...
            DetailGridExControl.MainGrid.MainView.CustomColumnDisplayText += DetailMainView_CustomColumnDisplayText;
        }
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("OutCustomer", "출고업체", HorzAlignment.Center, true);
        }
        ...
        protected override void MasterFocusedRowChanged()
        {
            if (searchDivision == "당월")
            {
                ...
                TN_ORD1201_List.AddRange(ModelService.GetChildList<TN_ORD1201>(p => p.TN_ORD1200.ItemCode == masterObj.ItemCode).ToList());
            }
            else
            {
        ...
        private void DetailMainView_CustomColumnDisplayText(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs e)
        {
            if (e.Column.FieldName == "OutCustomer")
            {
                var productLotNo = DetailGridExControl.MainGrid.MainView.GetListSourceRowCellValue(e.ListSourceRowIndex, "ProductLotNo").GetNullToEmpty();
                var obj = TN_ORD1201_List.Where(p => p.ProductLotNo == productLotNo).FirstOrDefault();
                if (obj != null)
                {
                    e.DisplayText = obj.TN_ORD1200.TN_STD1400.CustomerName;
                }
            }
        }
