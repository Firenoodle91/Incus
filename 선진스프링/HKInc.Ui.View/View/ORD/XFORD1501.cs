...
namespace HKInc.Ui.View.View.ORD
{
    ...
    public partial class XFORD1501 : Service.Base.SixGridFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            SixGridExControl.MainGrid.AddColumn("InQty", LabelConvert.GetLabelText("InQty"), HorzAlignment.Far, FormatType.Numeric, MasterCodeSTR.Numeric_N2);
        ...
        protected override void FiveViewFocusedRowChanged()
        {
            ...
            if (ChkZeroSearch.Checked == true)
            {
                SixGridBindingSource.DataSource = masterObj.TN_MAT_DEAD_DTL_List.Where(p => p.StockQty > 0 ).OrderBy(p => p.ItemCode).ThenBy(p => p.InLotNo).ToList();
            }
            else
            {
