...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    public partial class XPFRESULT_DEFAULT : Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            //lup_WorkId.SetDefaultPOP(false, "LoginId", "UserName", ModelService.GetChildList<User>(p => (string.IsNullOrEmpty(procTeamCode) ? true : p.ProductTeamCode == procTeamCode)
            //                                                                                        && p.Active == "Y"
