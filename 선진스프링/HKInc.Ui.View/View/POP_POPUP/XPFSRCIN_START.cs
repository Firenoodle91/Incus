...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    public partial class XPFSRCIN_START : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFSRCIN_START(PopupDataParam parameter, PopupCallback callback) : this()
        {
            ...
            spin_ItemCodeChange.Click += Spin_Click;
        ...
        protected override void InitCombo()
        {
            ...
            spin_ItemCodeChange.Properties.Mask.MaskType = MaskType.Numeric;
            spin_ItemCodeChange.Properties.Mask.EditMask = "n1";
            spin_ItemCodeChange.Properties.Mask.UseMaskAsDisplayFormat = true;
            spin_ItemCodeChange.Properties.Buttons[0].Visible = false;
        ...
        private void Btn_Start_Click(object sender, EventArgs e)
        {
            ...
            if (!machineCode.IsNullOrEmpty())
            {
                ...
                var itemCodeChangeTime = spin_ItemCodeChange.EditValue.GetDecimalNullToZero();
                var obj = ModelService.GetChildList<TN_MPS1302>(p => p.Date == Date 
                                                                && p.MachineMCode == machineCode
                ...
                if (obj == null)
                {
                    ModelService.InsertChild(new TN_MPS1302()
                    {
                        Date = Date,
                        MachineMCode = machineCode,
                        WorkNo = TEMP_XFPOP1000_Obj.WorkNo,
                        ProcessCode = TEMP_XFPOP1000_Obj.ProcessCode,
                        ProcessSeq = TEMP_XFPOP1000_Obj.ProcessSeq,
                        PlanStop = 0,
                        ItemCodeChange = itemCodeChangeTime,
                        SrcSoldOut = 0,
                        ReAdjust = 0,
                        MachineBroken = 0,
                        WorkLack = 0,
                ...
                {
                    obj.ItemCodeChange += itemCodeChangeTime;
