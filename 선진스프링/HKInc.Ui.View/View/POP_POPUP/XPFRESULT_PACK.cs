...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    public partial class XPFRESULT_PACK : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFRESULT_PACK(PopupDataParam parameter, PopupCallback callback) : this()
        {
            ...
            btn_CustomerLotNoChange.Click += Btn_CustomerLotNoChange_Click;
        }

        private void Btn_CustomerLotNoChange_Click(object sender, EventArgs e)
        {
            tx_CustomerLotNo.ReadOnly = false;
        }
        ...
        protected override void InitControls()
        {
            ...
            if(MasterObj.TN_MPS1202List.Count == 0)
                tx_CustomerLotNo.EditValue = MasterObj.TN_MPS1200.Temp1.GetNullToNull();
            else
                tx_CustomerLotNo.EditValue = MasterObj.TN_MPS1202List.OrderBy(p => p.RowId).Last().Temp1.GetNullToNull();
        ...
        protected override void DataSave()
        {
            ...
            {
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_69), LabelConvert.GetLabelText("BadQty"), LabelConvert.GetLabelText("PackQty2")));
                return;
            }

            if (resultQty == 0)
            {
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_40), LabelConvert.GetLabelText("PackQty2")));
                return;
            }
            ...
            if (!customerLotNo.IsNullOrEmpty())
            {
                var list = MasterObj.TN_MPS1200.TN_MPS1100.TN_MPS1200List.Where(p => p.WorkNo == MasterObj.WorkNo).ToList();
            ...
            detailNewObj.Temp1 = customerLotNo;
