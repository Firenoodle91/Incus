...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 작업 시작 시 이동표 스캔 (최종검사)
    /// </summary>
    public partial class XPFITEMMOVESCAN_START_INSP_FINAL : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFITEMMOVESCAN_START_INSP_FINAL()
        {
            InitializeComponent();
        }

        public XPFITEMMOVESCAN_START_INSP_FINAL(PopupDataParam parameter, PopupCallback callback) : this()
        {
