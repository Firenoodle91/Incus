...
namespace HKInc.Ui.View.View.POP
{
    ...
    public partial class XFPOP1000 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XFPOP1000()
        {
            ...
            lup_ProcTeamCode.EditValueChanged += Lup_ProcTeamCode_EditValueChanged;
        }

        private void Lup_ProcTeamCode_EditValueChanged(object sender, EventArgs e)
        {
            if (!lup_ProcTeamCode.EditValue.IsNullOrEmpty() && IsFirstLoaded)
                ActRefresh();
        }
        ...
        protected override void InitCombo()
        {
            ...
            lup_ProcTeamCode.SetDefaultPOP(true, "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"), DbRequestHandler.GetCommTopCode(MasterCodeSTR.ProductTeamCode));//, DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor);
            lup_Process.SetDefaultPOP(true, "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"), processList);//, DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor);
            ...
            lup_Item.SetDefaultPOP(true, "ItemCode", "ItemCode", ModelService.GetChildList<TN_STD1100>(p => p.UseFlag == "Y" && (p.TopCategory == MasterCodeSTR.TopCategory_WAN)).ToList());//, DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor);

            //lup_ProcTeamCode.SetFontSize(new Font("맑은 고딕", 15f));
            //lup_Process.SetFontSize(new Font("맑은 고딕", 15f));
            //lup_Machine.SetFontSize(new Font("맑은 고딕", 15f));
            //lup_Item.SetFontSize(new Font("맑은 고딕", 15f));
            ...
            var userObj = ModelService.GetChildList<Model.Domain.User>(p => p.LoginId == GlobalVariable.LoginId).FirstOrDefault();
            if (userObj != null) 
                lup_ProcTeamCode.EditValue = userObj.ProductTeamCode;
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("WorkNo", LabelConvert.GetLabelText("WorkNo"), HorzAlignment.Center, true);            
            ...
            gridEx1.MainGrid.AddColumn("ItemCode", LabelConvert.GetLabelText("ItemCode"), HorzAlignment.Center, true);
            gridEx1.MainGrid.AddColumn(DataConvert.GetCultureDataFieldName("ItemName"), LabelConvert.GetLabelText("ItemName"), HorzAlignment.Center, true);
            ...
            gridEx1.MainGrid.AddColumn("SumResultQty", LabelConvert.GetLabelText("SumResultQty"), HorzAlignment.Far, FormatType.Numeric, "#,0");
        ...
        private void SetButtonEnable(string jobStates)
        {
            ...
            //작업설정검사 체크
            var checkObj = ModelService.GetChildList<TN_QCT1001>(p => p.TN_QCT1000.ItemCode == obj.ItemCode
                                                                    && p.CheckDivision == MasterCodeSTR.InspectionDivision_Setting
            ...
            //품질검사 체크
            var checkObj2 = ModelService.GetChildList<TN_QCT1001>(p => p.TN_QCT1000.ItemCode == obj.ItemCode
                                                                    && p.CheckDivision == MasterCodeSTR.InspectionDivision_Frequently
                                                                    && p.ProcessCode == obj.ProcessCode
                                                                    && p.UseFlag == "Y"
                                                                    ).FirstOrDefault();
            var checkObj3 = ModelService.GetChildList<TN_QCT1001>(p => p.TN_QCT1000.ItemCode == obj.ItemCode
                                                                    && p.CheckDivision == MasterCodeSTR.InspectionDivision_FME
                                                                    && p.ProcessCode == obj.ProcessCode
                                                                    && p.UseFlag == "Y"
                                                                    ).FirstOrDefault();
            var checkObj4 = ModelService.GetChildList<TN_QCT1001>(p => p.TN_QCT1000.ItemCode == obj.ItemCode
                                                                    && p.CheckDivision == MasterCodeSTR.InspectionDivision_Process
                                                                    && p.ProcessCode == obj.ProcessCode
                                                                    && p.UseFlag == "Y"
                                                                    ).FirstOrDefault();
            if (checkObj2 == null && checkObj3 == null && checkObj4 == null)
            {
                btn_QualityAdd.Enabled = false;
            }
        }
        ...
        private void Btn_JobSetting_Click(object sender, EventArgs e)
        {
            ...
            var jobSettingForm = new POP_POPUP.XPFJOBSETTING(obj, tx_ProductLotNo.EditValue.GetNullToEmpty(), lup_ProcTeamCode.EditValue.GetNullToEmpty());
                ...
                if (obj.ProcessSeq == 1) //첫번째 공정일 경우 자재투입
                {
                    if (obj.JobStates == MasterCodeSTR.JobStates_Wait) //대기상태
                    {
                        ...
                        if (banBomObj != null)
                        {
                            ...
                            param.SetValue(PopupParameter.Value_1, lup_ProcTeamCode.EditValue.GetNullToEmpty());
        ...
        private void WorkStartSrcCallback(object sender, PopupArgument e)
        {
            ...
            var srcItemCode = e.Map.GetValue(PopupParameter.Value_1).GetNullToNull();
            var srcOutLotNo = e.Map.GetValue(PopupParameter.Value_2).GetNullToNull();
            ...
            //var itemMoveNo = DbRequestHandler.GetSeqMonth("IMV");
        ...
        private void Btn_ResultAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!obj.MachineCode.IsNullOrEmpty())
            {
                if (!VI_MACHINE_DAILY_CHECK_LIST.Any(p => p.MachineMCode == obj.MachineCode))
                {
            ...
            if (TN_MPS1200.ToolUseFlag == "Y")
            {
                if (obj.ProcessCode == MasterCodeSTR.Process_Heat)
                {
                    ...
                    if (checkObj == null)
                    {
                        ...
                        param.SetValue(PopupParameter.Value_3, lup_ProcTeamCode.EditValue.GetNullToEmpty());
        ...
        private void Btn_QualityAdd_Click(object sender, EventArgs e)
        {
            ...
            var inspectionForm = new POP_POPUP.XPFINSPECTION(obj, tx_ProductLotNo.EditValue.GetNullToEmpty(), lup_ProcTeamCode.EditValue.GetNullToEmpty());
        ...
        private void SrcChangeCallback(object sender, PopupArgument e)
        {
            ...
            if (productLotNo != tx_ProductLotNo.EditValue.GetNullToEmpty())
            {
                ...
                if (!obj.WorkNo.Contains("WNO_D"))
                {
                    var jobSettingForm = new POP_POPUP.XPFJOBSETTING(obj, productLotNo, lup_ProcTeamCode.EditValue.GetNullToEmpty());
                    jobSettingForm.ShowDialog();
                }
            } 
        ...
        {
            var machineCheckForm = new POP_POPUP.XPFMACHINECHECK(lup_ProcTeamCode.EditValue.GetNullToEmpty());
        ...
        private void Btn_ItemMovePrint_Click(object sender, EventArgs e)
        {
            ...
            if (obj.ProcessCode != "P01")
            {
                ...
                if (checkObj == null)
                {
                    ...
                    var checkYn= ModelService.GetChildList<TN_QCT1100>(p=>p.WorkNo==obj.WorkNo&&p.CheckDivision== MasterCodeSTR.InspectionDivision_Setting).FirstOrDefault();
                    if (checkYn == null)
                    {
                        MessageBoxHandler.Show(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_121), LabelConvert.GetLabelText("Warning"));
                        return;
                    }
                    else { ItemMovePrint(obj); }
                }
