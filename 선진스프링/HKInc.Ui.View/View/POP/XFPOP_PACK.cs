...
namespace HKInc.Ui.View.View.POP
{
    ...
    public partial class XFPOP_PACK : Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("CustomerLotNo", LabelConvert.GetLabelText("CustomerLotNo"), HorzAlignment.Center, true);
            DetailGridExControl.MainGrid.AddColumn("ResultQty", LabelConvert.GetLabelText("PackQty2"), HorzAlignment.Far, FormatType.Numeric, "#,0.##");
            ...
            DetailGridExControl.MainGrid.AddColumn("ResultSumQty", LabelConvert.GetLabelText("PackSumQty"), HorzAlignment.Far, FormatType.Numeric, "#,0.##");
        ...
        private void WorkStartItemMoveCallback(object sender, PopupArgument e)
        {
            ...
            var customerLotNo = e.Map.GetValue(PopupParameter.Value_4).GetNullToNull();
        ...
        private void BarWorkEnd_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
            {
                context.Database.CommandTimeout = 0;
                var WorkNo = new SqlParameter("@WorkNo", obj.WorkNo);
                var ProcessSeq = new SqlParameter("@ProcessSeq", obj.ProcessSeq);
