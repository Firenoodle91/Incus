...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    ///  자주검사 대상 Select 팝업
    /// </summary>
    public partial class XSFQCT_FREQNTLY : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XSFQCT_FREQNTLY()
        {
            InitializeComponent();
        }

        public XSFQCT_FREQNTLY(PopupDataParam parameter, PopupCallback callback) : this()
        {
            this.PopupParam = parameter;
            this.Callback = callback;
            this.Text = LabelConvert.GetLabelText("Inspection_FREQNTLY_Object");
        ...
        protected override void Confirm()
        {
            ...
            //    var dataList = ModelBindingSource.List as List<VI_INSP_FREQNTLY_OBJECT>;
            ...
            //else
            //{
            //    param.SetValue(PopupParameter.ReturnObject, ModelService.Detached((VI_INSP_FREQNTLY_OBJECT)ModelBindingSource.Current));
            //}
