...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    public partial class XSFORD1101 : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XSFORD1101(PopupDataParam parameter, PopupCallback callback) : this()
        {
            ...
            this.Text = LabelConvert.GetLabelText("ShipmentDayPlanList");
            ...
            tx_OutRepNo.KeyDown += Tx_OutRepNo_KeyDown;
        }

        private void Tx_OutRepNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                var value = tx_OutRepNo.EditValue.GetNullToEmpty();
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("TN_ORD1100.TN_ORD1001.EndMonthDate", LabelConvert.GetLabelText("EndMonthDate"), HorzAlignment.Center, FormatType.DateTime, "yyyy-MM");
            GridExControl.MainGrid.AddColumn("DelivNo", LabelConvert.GetLabelText("DelivNo"));
            GridExControl.MainGrid.AddColumn("OutRepNo", LabelConvert.GetLabelText("OutRepNo"));
            ...
            GridExControl.MainGrid.AddColumn("StockQty", LabelConvert.GetLabelText("StockQty"), HorzAlignment.Far, FormatType.Numeric, MasterCodeSTR.Numeric_N0);
            ...
            GridExControl.MainGrid.AddColumn("TN_ORD1100.DelivQty", LabelConvert.GetLabelText("DelivQty"), HorzAlignment.Far, FormatType.Numeric, MasterCodeSTR.Numeric_N0);
            GridExControl.MainGrid.AddColumn("TN_ORD1103.OutDatePlan", LabelConvert.GetLabelText("OutDatePlan"), HorzAlignment.Center, FormatType.DateTime, "yyyy-MM-dd");
            GridExControl.MainGrid.AddColumn("OutPlanQty", LabelConvert.GetLabelText("OutPlanQty"), HorzAlignment.Far, FormatType.Numeric, MasterCodeSTR.Numeric_N0);
            //GridExControl.MainGrid.AddColumn("TN_ORD1103.OutDatePlan", LabelConvert.GetLabelText("OutDatePlan"));
            GridExControl.MainGrid.AddColumn("TN_ORD1100.DelivId", LabelConvert.GetLabelText("DelivId"), false);
        ...
        protected override void InitRepository()
        {
            ...
            //GridExControl.MainGrid.SetRepositoryItemDateEdit("TN_ORD1103.OutDatePlan");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("TN_ORD1100.DelivId", ModelService.GetChildList<User>(p => p.Active == "Y"), "LoginId", "UserName");
        ...
        protected override void DataLoad()
        {
            ...
            var outRepNo = tx_OutRepNo.EditValue.GetNullToEmpty();

            bindingSource.DataSource = ModelService.GetList(p => (p.TN_ORD1103.OutDatePlan >= frDate && p.TN_ORD1103.OutDatePlan <= toDate)
                                                                    && (string.IsNullOrEmpty(itemCode) ? true : p.ItemCode == itemCode)
                                                                    && (string.IsNullOrEmpty(customerCode) ? true : p.CustomerCode == customerCode)
                                                                    && (string.IsNullOrEmpty(outRepNo) ? true : p.OutRepNo == outRepNo)
