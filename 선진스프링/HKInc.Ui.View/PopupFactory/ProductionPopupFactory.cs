...
namespace HKInc.Ui.View.PopupFactory
{
    class ProductionPopupFactory
    {
        private static Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>> EditFormList = new Dictionary<ProductionPopupView, Func<PopupDataParam, PopupCallback, IPopupForm>>()
        {
            ...
            { ProductionPopupView.XPFSTD1100_BARCODE_PRINT, (param, callback) => new View.STD_POPUP.XPFSTD1100_BARCODE_PRINT(param, callback)},
            ...
            { ProductionPopupView.SELECT_BANPROD_STOCK, (param, callback) => new SELECT_POPUP.XSFBANPROD_STOCK(param, callback)},
            ...
            { ProductionPopupView.XPFFIFO, (param, callback) => new View.POP_POPUP.XPFFIFO(param, callback)},
