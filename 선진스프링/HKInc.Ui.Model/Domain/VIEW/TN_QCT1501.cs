...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    public class TN_QCT1501 : BaseDomain.MES_BaseDomain
    {
        ...
        [Column("READING10")] public string Reading10 { get; set; }
        /// <summary>측정값11</summary>             
        [Column("READING11")] public string Reading11 { get; set; }
        /// <summary>측정값12</summary>             
        [Column("READING12")] public string Reading12 { get; set; }
        /// <summary>측정값13</summary>             
        [Column("READING13")] public string Reading13 { get; set; }
        /// <summary>판정</summary>                
        ...
        /// <summary>최종검사초기MIN값</summary>               
        [Column("TEMP1")] public string Temp1 { get; set; }
        /// <summary>최종검사초기MAX값</summary>               
