...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    public class TN_MPS1200 : BaseDomain.MES_BaseDomain
    {
        public TN_MPS1200()
        {
            ...
            TN_MPS1302List = new List<TN_MPS1302>();
        }
        ...
        [ForeignKey("TN_MPS1100"), Column("PLAN_NO"), Required(ErrorMessage = "PlanNo")] public string PlanNo { get; set; }
        ...
        public virtual ICollection<TN_MPS1302> TN_MPS1302List { get; set; }
    }
}