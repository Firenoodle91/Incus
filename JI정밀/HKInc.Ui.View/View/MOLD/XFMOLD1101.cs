...
namespace HKInc.Ui.View.View.MOLD
{
    ...
    public partial class XFMOLD1101 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("StateId", ModelService.GetChildList<User>(p => p.Active == "Y"), "LoginId", "UserName");
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("WorkId", ModelService.GetChildList<User>(p => p.Active == "Y"), "LoginId", "UserName");
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CommitId", ModelService.GetChildList<User>(p => p.Active == "Y"), "LoginId", "UserName");
