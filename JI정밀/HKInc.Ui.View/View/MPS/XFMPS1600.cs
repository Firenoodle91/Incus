...
namespace HKInc.Ui.View.View.MPS
{
    ...
    public partial class XFMPS1600 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("TN_STD1100.Unit", LabelConvert.GetLabelText("Unit"), HorzAlignment.Center, true);
        ...
        {
            //MasterGridExControl.MainGrid.SetRepositoryItem("Unit", DbRequestHandler.GetCommCode(MasterCodeSTR.Unit), "CodeVal", Service.Helper.DataConvert.GetCultureDataFieldName("CodeName"));
