...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 설비별 공구 리스트 등록 (러시아)
    /// </summary>
    public partial class XPFTOOL_LIFECNT_RUS : Service.Base.PopupCallbackFormTemplate
    {
        #region 전역변수
        ...
        public XPFTOOL_LIFECNT_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("ToolCode", "имя инструмента");      // 공구명
            gridEx1.MainGrid.AddColumn("BaseCNT", "базовая продолжительность жизни", HorzAlignment.Far, FormatType.Numeric, "n0");      // 기본수명
            gridEx1.MainGrid.AddColumn("LifeCNT", "Оставшийся срок службы инструмента", HorzAlignment.Far, FormatType.Numeric, "n0");       // 남은수명
