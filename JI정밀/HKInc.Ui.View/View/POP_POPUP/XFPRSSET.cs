...
{
    public partial class XFPRSSET : Form
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
          ...
          ini.IniWriteValue("Serial", "port", cb_combo.SelectedItem.GetNullToEmpty(), aa);
            ...
            HKInc.Service.Controls.HKRS232.lsPort = cb_combo.SelectedItem.GetNullToEmpty();
            HKInc.Service.Controls.HKRS232.lsmc = cb_mc.EditValue.GetNullToEmpty();
