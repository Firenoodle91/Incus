...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// </summary>
    public partial class XPFRAW_MATERIAL_IN_RUS : Service.Base.PopupCallbackFormTemplate
    {
        #region 전역변수
        ...
        public XPFRAW_MATERIAL_IN_RUS()
        {
            InitializeComponent();
        }

        public XPFRAW_MATERIAL_IN_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
