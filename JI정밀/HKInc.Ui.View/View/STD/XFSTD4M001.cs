...
namespace HKInc.Ui.View.View.STD
{
    ...
    public partial class XFSTD4M001 : Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("TN_STD1100." + DataConvert.GetCultureDataFieldName("ItemName1"), LabelConvert.GetLabelText("ItemName1"), false);
            ...
            GridExControl.MainGrid.AddColumn("TN_STD1100.BottomCategory", LabelConvert.GetLabelText("BottomCategory"), false);
            ...
            GridExControl.MainGrid.AddColumn("QcFileName1", LabelConvert.GetLabelText("CheckFirstFile"));
            ...
            GridExControl.MainGrid.AddColumn("QcFileName2", LabelConvert.GetLabelText("CheckSecondFile"));
            ...
            GridExControl.MainGrid.AddColumn("QcFileName3", LabelConvert.GetLabelText("CheckThirdFile"));
            ...
            GridExControl.MainGrid.AddColumn("ReqDocFileName", LabelConvert.GetLabelText("RequestDocument"));
            GridExControl.MainGrid.AddColumn("EtcFileName1", LabelConvert.GetLabelText("EtcFile1"));
            GridExControl.MainGrid.AddColumn("EtcFileName2", LabelConvert.GetLabelText("EtcFile2"));
            GridExControl.MainGrid.AddColumn("EtcFileName3", LabelConvert.GetLabelText("EtcFile3"));
            GridExControl.MainGrid.AddColumn("EtcFileName4", LabelConvert.GetLabelText("EtcFile4"));
            GridExControl.MainGrid.AddColumn("EtcFileName5", LabelConvert.GetLabelText("EtcFile5"));
            ...
            GridExControl.MainGrid.Columns["QcFileName1"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["QcFileName1"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["QcFileName1"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["QcFileName2"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["QcFileName2"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["QcFileName2"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["QcFileName3"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["QcFileName3"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["QcFileName3"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["ReqDocFileName"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["ReqDocFileName"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["ReqDocFileName"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["EtcFileName1"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["EtcFileName1"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["EtcFileName1"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["EtcFileName2"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["EtcFileName2"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["EtcFileName2"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["EtcFileName3"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["EtcFileName3"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["EtcFileName3"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["EtcFileName4"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["EtcFileName4"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["EtcFileName4"].AppearanceCell.Font, FontStyle.Underline);
            GridExControl.MainGrid.Columns["EtcFileName5"].AppearanceCell.ForeColor = Color.Blue;
            GridExControl.MainGrid.Columns["EtcFileName5"].AppearanceCell.Font = new Font(GridExControl.MainGrid.Columns["EtcFileName5"].AppearanceCell.Font, FontStyle.Underline);
        }
        ...
        protected override void DataLoad()
        {
            ...
            GridBindingSource.DataSource = ModelService.GetList(p => (string.IsNullOrEmpty(itemCodeName) ? true : (p.ItemCode.Contains(itemCodeName) 
                                                                                                                || (p.TN_STD1100.ItemName.Contains(itemCodeName) 
                                                                                                                || p.TN_STD1100.ItemNameENG.Contains(itemCodeName) 
                                                                                                                || p.TN_STD1100.ItemNameCHN.Contains(itemCodeName))))
                                                                 //&& (string.IsNullOrEmpty(productTeamCode) ? true : p.TN_STD1100.ProcTeamCode == productTeamCode)
                                                                 ).ToList();
