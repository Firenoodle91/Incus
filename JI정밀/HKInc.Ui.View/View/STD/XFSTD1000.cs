...
namespace HKInc.Ui.View.View.STD
{
    public partial class XFSTD1000 : HKInc.Service.Base.ListMasterDetailSubDetailTreeDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("ToolUseFlag", LabelConvert.GetLabelText("ToolUseFlag"), false);
            ...
            TreeDetailGridExControl.MainGrid.AddColumn("CreateTime", LabelConvert.GetLabelText("CreateTime"), false);
            TreeDetailGridExControl.MainGrid.AddColumn("CreateId", LabelConvert.GetLabelText("CreateId"), false);
            TreeDetailGridExControl.MainGrid.AddColumn("UpdateTime", LabelConvert.GetLabelText("UpdateTime"), false);
            TreeDetailGridExControl.MainGrid.AddColumn("UpdateId", LabelConvert.GetLabelText("UpdateId"), false);

            MasterGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "CodeMain", "CodeName", "CodeNameENG", "CodeNameCHN", "UseYN", "Memo");
            DetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "CodeTop", "CodeName", "CodeNameENG", "CodeNameCHN", "DisplayOrder", "UseYN", "Memo", "ToolUseFlag", "Temp", "Temp1", "Temp2");
        ...
        protected override void InitRepository()
        {
            ...
            TreeDetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CreateId", ModelService.GetChildList<User>(p => true), "LoginId", "UserName");
            TreeDetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("UpdateId", ModelService.GetChildList<User>(p => true), "LoginId", "UserName");
        ...
        protected override void DataLoad()
        {
            ...
            DetailGridExControl.MainGrid.Columns["ToolUseFlag"].Visible = false;
        ...
        protected override void MasterFocusedRowChanged()
        {
            ...
            {
                DetailGridExControl.MainGrid.Columns["ToolUseFlag"].Visible = true;
                ...
                DetailGridExControl.MainGrid.Columns["Temp"].VisibleIndex = DetailGridExControl.MainGrid.Columns["ToolUseFlag"].VisibleIndex + 1;
