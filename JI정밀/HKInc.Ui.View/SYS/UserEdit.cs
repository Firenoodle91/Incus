...
namespace HKInc.Ui.View.SYS
{
    ...
    {                
        ...
        protected override void InitCombo()
        {
            ...
            lup_MainCustomerCode.SetDefault(true, "CustomerCode", Service.Helper.DataConvert.GetCultureDataFieldName("CustomerName"), UserService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList());
        ...
        protected override void DataLoad()
        {
            if(EditMode == PopupEditMode.New) // 신규 추가
            {
                userBindingSource.Add(new User()
                {
                    ...
                    //AES 관리 X
                    Password = "1",
                    MainYn = "02",                                          // 2021-11-04 김진우 주임  기본값으로 추가
        ...
        protected override void DataSave()
        {
            ...
            // 생성자가 없을 경우 강제 생성
            if (obj.CreateId.GetNullToEmpty() == "")
                obj.CreateId = obj.UpdateId.GetNullToEmpty() != "" ? obj.UpdateId : "Admin";
