...
{
    /// <summary>툴 이력관리 뷰</summary>	
    [Table("VI_TOOL1002_LIST")]
    public class VI_TOOL1002_LIST 
    {
        public VI_TOOL1002_LIST()
        {
        }

        [Key, Column("RowIndex", Order = 0)] public Int64 RowIndex { get; set; }
        /// <summary>작업지시번호</summary>           
        [ForeignKey("TN_MPS1201"), Key, Column("WORK_NO", Order = 1), Required(ErrorMessage = "WorkNo")] public string WorkNo { get; set; }
        /// <summary>공정코드</summary>               
        [ForeignKey("TN_MPS1201"), Key, Column("PROCESS_CODE", Order = 2), Required(ErrorMessage = "ProcessCode")] public string ProcessCode { get; set; }
        /// <summary>공정순번</summary>               
        [ForeignKey("TN_MPS1201"), Key, Column("PROCESS_SEQ", Order = 3), Required(ErrorMessage = "ProcessSeq")] public int ProcessSeq { get; set; }
        /// <summary>생산 LOT_NO</summary>            
        [ForeignKey("TN_MPS1201"), Key, Column("PRODUCT_LOT_NO", Order = 4), Required(ErrorMessage = "ProductLotNo")] public string ProductLotNo { get; set; }
