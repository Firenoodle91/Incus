...
namespace HKInc.Utils.Common
{
    ...
    {
        private static readonly float defaultFontSize = 9.25f;
        ...
        private static readonly Dictionary<Enum.DefaultValue, string> DefaultStringValueList = new Dictionary<Enum.DefaultValue, string>()
        {
            ...
            {Enum.DefaultValue.MainRegistryPath,            @"Software\HKInc" + RegistryCompanyName},
            {Enum.DefaultValue.LoginInfoRegistryPath,       @"LoginInfo"},
            {Enum.DefaultValue.MachineRegistryPath,         @"MachineInfo"}, //로그인 창 설비코드 선택 저장
            ...
            {Enum.DefaultValue.DefaultCultureName,          @"한국어"},
            {Enum.DefaultValue.SecondCultureName,           @"English"},
            {Enum.DefaultValue.ThirdCultureName,            @"中国"},
            ...
            {Enum.DefaultValue.DefaultFontName,             @"맑은 고딕"},
            ...
            {Enum.DefaultValue.PasswordCharReg,             @"[A-Za-z]+"}, // 20210818 오세완 차장 문자 한개만 검증할 수 있는 조건 추가
        ...
        public static string DefaultPOPFont { get { return @"맑은 고딕"; } }
