...
namespace HKInc.Utils.Common
{
    public class GlobalVariable
    {
        ...
        private static HKInc.Ui.Model.Domain.VIEW.TN_MEA1000 machineInfo;
        ...
        public static void SetMachine(HKInc.Ui.Model.Domain.VIEW.TN_MEA1000 machine)
        {
            machineInfo = machine;
        }
        ...
        public static HKInc.Ui.Model.Domain.VIEW.TN_MEA1000 MachineInfo { get { return machineInfo; } }

        public static decimal UserId { get { return userInfo.UserId; } }
        public static string LoginId { get { return userInfo.LoginId; } }
        public static string MachineCode { get { return machineInfo.MachineMCode; } }
        ...
        public static string MachineInfoPath { get { return DefaultValueList.GetDefaultStringValue(Enum.DefaultValue.MachineRegistryPath); } } //레지스트리 설비코드 경로
        ...
        /// <summary>
        /// 20210818 오세완 차장 문자 1개만 있어도 된다는 비밀번호 확인 규칙 정규식 반환
        /// </summary>
        public static string PasswordCharReg
        {
            get
            {
                return DefaultValueList.GetDefaultStringValue(Enum.DefaultValue.PasswordCharReg);
            }
        }
