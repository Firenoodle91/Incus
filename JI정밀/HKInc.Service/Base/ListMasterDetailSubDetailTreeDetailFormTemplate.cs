...
namespace HKInc.Service.Base
{
    ...
    /// Grid 4개 템플릿
    /// </summary>
    public partial class ListMasterDetailSubDetailTreeDetailFormTemplate : BaseForm 
    {
        ...
        #region Construct
        public ListMasterDetailSubDetailTreeDetailFormTemplate()
        {
            InitializeComponent();            
        }        
        ...
        protected override void InitControls()
        {
            ...
            {                
                ...
                DetailGridExControl.Menu = FormMenu == null ? 0 : FormMenu.MenuId.GetNullToZero();
            ...
            if (TreeDetailGridExControl != null)
            {
                ...
                TreeDetailGridExControl.Menu = FormMenu == null ? 0 : FormMenu.MenuId.GetNullToZero();
