...
namespace HKInc.Service.Controls
{
    ...
    public partial class SearchLookUpEditEx : SearchLookUpEdit
    {
        ...
        public void SetSmall (bool bDeleteButtonVisible = true, string valueMember = "CodeVal", string displayMember = "CodeName", object dataSource = null, 
            TextEditStyles textEditStyles = TextEditStyles.Standard, HorzAlignment horz = HorzAlignment.Center, EventHandler PopupEvent = null)
        {
            DataSourceClear();
            ...
            SetHAlignment(HorzAlignment.Center);
            ...
            {
                MachineMCodeColumnSmallSetting(Properties, valueMember, valueMember, displayMember);
            }

            this.Properties.View.RowHeight = 40;
            SetFontSize(new Font("맑은 고딕", 13));
        }
        ...
        private void MachineMCodeColumnSmallSetting(RepositoryItemSearchLookUpEdit edit, string fieldName, string valueMember, string displayMember)
        {
            var culture = DataConvert.GetCultureIndex();
