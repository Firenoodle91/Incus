...
{
    /// <summary>작업실적관리 디테일(리워크)</summary>	
    [Table("TN_MPS1206T")]
    public class TN_MPS1206 : BaseDomain.MES_BaseDomain
    {
        public TN_MPS1206()
        {
        }
        /// <summary>작업지시번호</summary>           
        [ForeignKey("TN_MPS1205"), Key, Column("WORK_NO", Order = 0), Required(ErrorMessage = "WorkNo")] public string WorkNo { get; set; }
        /// <summary>공정코드</summary>               
        [ForeignKey("TN_MPS1205"), Key, Column("PROCESS_CODE", Order = 1), Required(ErrorMessage = "ProcessCode")] public string ProcessCode { get; set; }
        /// <summary>공정순번</summary>               
        [ForeignKey("TN_MPS1205"), Key, Column("PROCESS_SEQ", Order = 2), Required(ErrorMessage = "ProcessSeq")] public int ProcessSeq { get; set; }
        /// <summary>생산 LOT_NO</summary>            
        [ForeignKey("TN_MPS1205"), Key, Column("PRODUCT_LOT_NO", Order = 3), Required(ErrorMessage = "ProductLotNo")] public string ProductLotNo { get; set; }
        ...
        public virtual TN_MPS1205 TN_MPS1205 { get; set; }
    }
}