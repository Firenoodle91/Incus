...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    /// 유형별 불량률화면
    /// </summary>
    public partial class XRREP4000 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("BadTypeName", LabelConvert.GetLabelText("BadType"));
            GridExControl.MainGrid.AddColumn("BadSumQty", LabelConvert.GetLabelText("SumBadQty2"), HorzAlignment.Far, FormatType.Numeric, "n0");
        ...
        protected override void DataLoad()
        {
            ...
            using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
            {
                ...
                var result = context.Database
                      .SqlQuery<TEMP_XRREP4000>("SP_FAIL_RAT @type, @fromdt,@todt ,@item", lType, fdt, tdt, itemcode).ToList();
            ...
            List<TEMP_XRREP4000> ds = GridBindingSource.DataSource as List<TEMP_XRREP4000>;
            //타이틀설정
            ...
            //X축설정 (Series)
            Chart1.DataSource = ds.GroupBy(p => new { p.ProcessName, p.BadTypeName }).Select(p => new TEMP_XRREP4000
            {
                ProcessName = p.Key.ProcessName
                 ,
                BadTypeName = p.Key.BadTypeName
                 ,
                BadRate = p.Sum(c => c.BadSumQty).GetDecimalNullToZero() == 0 ? 0 : (p.Sum(c => c.BadQty) / p.Sum(c => c.BadSumQty).GetDecimalNullToZero()) * 100
            }).ToList();
            Chart1.SeriesDataMember = "ProcessName";
            Chart1.SeriesTemplate.ArgumentDataMember = "BadTypeName";
