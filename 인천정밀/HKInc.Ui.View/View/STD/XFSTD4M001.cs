...
namespace HKInc.Ui.View.View.STD
{
    ...
    public partial class XFSTD4M001 : Service.Base.ListFormTemplate
    {
        ...
        protected override void DataLoad()
        {
            ...
            GridBindingSource.DataSource = ModelService.GetList(p => (string.IsNullOrEmpty(itemCodeName) ? true : (p.ItemCode.Contains(itemCodeName) || (p.TN_STD1100.ItemName.Contains(itemCodeName) || p.TN_STD1100.ItemName1.Contains(itemCodeName) || p.TN_STD1100.ItemNameENG.Contains(itemCodeName) || p.TN_STD1100.ItemNameCHN.Contains(itemCodeName))))
