...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR_STOCK : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        {
            lup_Item.SetDefault(true, true, "ItemCode", DataConvert.GetCultureDataFieldName("ItemName"), ModelService.GetChildList<TN_STD1100>(p => p.UseFlag == "Y" && 
                                                                                                                                              (p.TopCategory == MasterCodeSTR.TopCategory_MAT || p.TopCategory == MasterCodeSTR.TopCategory_BU)).ToList());            
