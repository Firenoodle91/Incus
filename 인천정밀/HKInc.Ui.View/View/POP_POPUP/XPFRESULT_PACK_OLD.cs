...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 실적등록 팝업 (포장)
    /// </summary>
    public partial class XPFRESULT_PACK_OLD : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFRESULT_PACK_OLD()
        {
            InitializeComponent();
        }

        public XPFRESULT_PACK_OLD(PopupDataParam parameter, PopupCallback callback) : this()
        {
