...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 실적등록 팝업 (기본)
    /// </summary>
    public partial class XPFRESULT_INSP_FINAL_OLD : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFRESULT_INSP_FINAL_OLD()
        {
            InitializeComponent();
        }

        public XPFRESULT_INSP_FINAL_OLD(PopupDataParam parameter, PopupCallback callback) : this()
        {
