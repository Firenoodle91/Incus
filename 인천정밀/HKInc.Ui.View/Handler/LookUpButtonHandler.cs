...
namespace HKInc.Ui.View.Handler
{
    class LookUpButtonHandler<TEntity> where TEntity : class
    {
        ...
        public LookUpButtonHandler(GridLookUpEditEx edit, ProductionPopupView popupView, PopupCallback callback = null, string constraint = null, object Value_1 = null)
        {
            lookupEditor = edit;
            PopupView = popupView;
            ...
            IsMultiSelect = false;
            lookupEditor.Value_1 = Value_1;
        }

        public LookUpButtonHandler(GridLookUpEditEx edit, ProductionPopupView popupView, PopupCallback callback, IUserRight userRight, PopupEditMode editMode, string constraint = null, object Value_1 = null) : this(edit, popupView, callback, constraint, Value_1)
        {
            this.UserRight = userRight;
            this.EditMode = editMode;
        }

        public LookUpButtonHandler(GridLookUpEditEx edit, GridLookUpEditEx cascadingLookUpEditor, string gridFilter, string constraint = null, object Value_1 = null)
        {
            lookupEditor = edit;
            lookupEditor.Constraint = constraint;
            IsMultiSelect = false;
        ...
        public LookUpButtonHandler(GridLookUpEditEx edit, ProductionPopupView popupView, GridLookUpEditEx cascadingLookUpEditor) : this(edit, popupView)
        {
            CascadingLookupEditor = cascadingLookUpEditor;
        ...
        public LookUpButtonHandler(string gridFilter, GridLookUpEditEx edit, ProductionPopupView popupView, GridLookUpEditEx cascadingLookUpEditor) : this(edit, popupView, null)
        {
            CascadingLookupEditor = cascadingLookUpEditor;
            GridFilter = gridFilter;
        ...
        public void ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Kind == DevExpress.XtraEditors.Controls.ButtonPredefines.Ellipsis)
            {
                ...
                param.SetValue(PopupParameter.Value_1, lookupEditor.Value_1); //제약조건    
