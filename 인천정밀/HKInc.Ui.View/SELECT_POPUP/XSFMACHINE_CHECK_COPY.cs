...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    public partial class XSFMACHINE_CHECK_COPY : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        {
            lup_Machine.SetDefault(true, "MachineMCode", DataConvert.GetCultureDataFieldName("MachineName"), ModelService.GetList(p => true));
        }
        ...
        protected override void DataLoad()
        {
            ...
            {
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_34), LabelConvert.GetLabelText("MachineName")));   // 2021-05-21 김진우 주임 추가
                GridExControl.MainGrid.Clear();
            }
            else
            {
