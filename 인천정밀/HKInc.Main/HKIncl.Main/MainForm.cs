...
namespace HKInc.Main
{
    ...
    {   
        ...
        void OpenPop()
        {
            //var popForm = new Ui.View.View.POP.XFPOP_SELECT();
            //popForm.Show();

            // 20211104 오세완 차장 pop가 1개 뿐이라서 바로 연결처리
            HKInc.Ui.View.View.POP.XFPOP1000 form = new Ui.View.View.POP.XFPOP1000();
            form.Show();
        ...
        public void ReloadNotice()
        {
            ...
            Notice obj = NoticeService.GetList(p => 1==1).FirstOrDefault();
            if (obj != null)            
