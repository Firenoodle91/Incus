...
namespace HKInc.Service.Base
{
    ...
    /// Grid 3개 템플릿
    /// </summary>
    public partial class ListMasterDetailSubDetailFormTemplate : BaseForm 
    {
        ...
        #region Construct
        public ListMasterDetailSubDetailFormTemplate()
        {
            InitializeComponent();            
        }        
        ...
        protected override void InitControls()
        {
            ...
            if (SubDetailGridExControl != null)
            {
                ...
                SubDetailGridExControl.Menu = FormMenu == null ? 0 : FormMenu.MenuId.GetNullToZero();
