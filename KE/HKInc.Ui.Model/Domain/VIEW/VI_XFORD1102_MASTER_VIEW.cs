...
{
    /// <summary>납기회의목록 상세보기</summary>	
    [Table("VI_XFORD1102_MASTER_VIEW")]
    public class VI_XFORD1102_MASTER_VIEW
    {        
        /// <summary>고유번호(가상번호)</summary>           
        [Key, Column("RowIndex")] public long RowIndex { get; set; }
        /// <summary>납품계획번호</summary>             
        [Column("DELIV_NO")] public string DelivNo { get; set; }
        /// <summary>생산계획번호</summary>             
        [Column("PLAN_NO")] public string PlanNo { get; set; }
        ...
        [ForeignKey("TN_STD1100_TOOL"), Column("SRC_CODE")] public string SrcItemCode { get; set; }
