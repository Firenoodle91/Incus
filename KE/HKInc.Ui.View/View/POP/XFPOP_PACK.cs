...
namespace HKInc.Ui.View.View.POP
{
    ...
    public partial class XFPOP_PACK : Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            //var barFinalInsp = new DevExpress.XtraBars.BarButtonItem();
            //barFinalInsp.Id = 5;
            //barFinalInsp.ImageOptions.Image = IconImageList.GetIconImage("maps/weightedpies");
            //barFinalInsp.ItemShortcut = new DevExpress.XtraBars.BarShortcut((Keys.Alt | Keys.I));
            //barFinalInsp.Name = "barFinalInsp";
            //barFinalInsp.PaintStyle = DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph;
            //barFinalInsp.ShortcutKeyDisplayString = "Alt+I";
            //barFinalInsp.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
            //barFinalInsp.Caption = LabelConvert.GetLabelText("FinalInsp") + "[Alt+I]";
            //barFinalInsp.ItemClick += barFinalInsp_ItemClick;

            // 20211223 오세완 차장 케이즈이노텍은 박스라벨 생략하기로 함
            //DetailGridExControl.BarTools.AddItem(barOutBoxBarcodePrint);

            // 20211223 오세완 차장 케이즈이노텍은 이동표가 없어서 교체도 필요 없음
            //DetailGridExControl.BarTools.AddItem(barItemMoveChange);
            //DetailGridExControl.BarTools.AddItem(barFinalInsp);
        ...
        protected override void DetailAddRowClicked()
        {
            ...
            // 20211223 오세완 차장 이동표가 없어서 무조건 시작하는 로직으로 변경
        ...
        //    if (qcRev.TN_QCT1001List.Where(p => p.CheckDivision == MasterCodeSTR.InspectionDivision_Shipment
        ...
        //    var inspectionForm = new POP_POPUP.XPFINSPECTION_PACK(obj, obj.ProductLotNo);
        ...
        private void SetButtonEnable(string jobStates = null)
        {
            if (jobStates == MasterCodeSTR.JobStates_Wait) //대기
            {
                ...
                // 20211223 오세완 차장 이동표교체, 박스포장 버튼 생략해서 여기도 생략처리
        ...
        //private void barFinalInsp_ItemClick(object sender, ItemClickEventArgs e)
        //{
        //    var obj = DetailGridBindingSource.Current as TEMP_XFPOP_PACK;
        //    if (obj == null) return;
        ...
        //    var inspectionForm = new POP_POPUP.XPFINSPECTION_FINAL_PACK(obj, obj.ProductLotNo, obj.ItemMoveNo);
        //    if (inspectionForm.ShowDialog() != DialogResult.OK) { }
        //    else
        //        ActRefresh();
        //}
