...
namespace HKInc.Ui.View.View.MPS
{
    ...
    public partial class XFMPS1001 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            //DetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "ProcessCode", "ProcessSeq", "MachineGroupCode", "OutProcFlag", "JobSettingFlag", "MachineFlag", "ToolUseFlag", "StdWorkDay");

            // 20210520 오세완 차장 재가동TO여부 추가, 툴사용여부 & 설비사용여부 제외
            //DetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "ProcessCode", "ProcessSeq", "MachineGroupCode", "OutProcFlag", "RestartToFlag", "StdWorkDay");
