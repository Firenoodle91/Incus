...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 최종검사 POP 팝업 창(포장관리)
    /// </summary>
    public partial class XPFINSPECTION_FINAL_PACK : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XPFINSPECTION_FINAL_PACK(TEMP_XFPOP_PACK obj, string productLotNo, string itemMoveNo)
        {
            InitializeComponent();
        ...
        protected override void DataSave()
        {
            ...
            #region 실적INSERT
/*
            TN_MPS1201 MasterObj = QcModelService.GetChildList<TN_MPS1201>(p => p.WorkNo == TEMP_XFPOP_PACK.WorkNo
