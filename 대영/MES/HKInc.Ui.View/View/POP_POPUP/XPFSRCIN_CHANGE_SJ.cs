...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 원소재교체
    /// </summary>
    public partial class XPFSRCIN_CHANGE_SJ : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFSRCIN_CHANGE_SJ()
        {
            InitializeComponent();

        }

        public XPFSRCIN_CHANGE_SJ(PopupDataParam parameter, PopupCallback callback) : this()
        {
