...
namespace HKInc.Ui.View.View.POP
{
    /// <summary>
    /// 20210716 오세완 차장
    /// 프레스 POP, plc user control V2 사용 버전
    /// 20200721 오세완 차장
    /// USER CONTROL에서 DB를 직접 접근해서 INSERT 및 UPDATE를 하려 했으나 실패한 버전, 사용 안함
    /// </summary>
    public partial class XFPOP_PLC_V3 : HKInc.Service.Base.ListFormTemplate
    {
        #region 전역변수
        ...
        public XFPOP_PLC_V3()
        {
            ...
            ti_AutoUpdate.Tick += Ti_AutoUpdate_Tick;
        }
        ...
        /// <summary>
        /// 20210716 오세완 차장 plc통신 시작 및 실적 update시간 timer설정
        /// </summary>
        private void Init_Plc()
        {
            plc_Modbus.Start();
            ti_AutoUpdate.Interval = plc_Modbus.UpdatePeriod;
            ti_AutoUpdate.Start();
        }
        ...
        /// <summary>
        /// 20210716 오세완 차장 Update주기에 맞는 시간일 때 호출됨
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Ti_AutoUpdate_Tick(object sender, EventArgs e)
        {
            ti_AutoUpdate.Stop();
