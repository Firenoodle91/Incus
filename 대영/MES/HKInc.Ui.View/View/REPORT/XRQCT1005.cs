...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    public partial class XRQCT1005 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void SetData(TN_QCT1100 obj)
        {
            ...
            foreach (var s in d_Result)
            {
                ...
                data.Insp_Seq = s.InspSeq;
                data.Seq = s.Seq.GetNullToZero();
            ...
            if (s_Result != null)
            {
                ...
                {
                    XRQCT1005_DATA data = list.Where(x => x.WorkNo == scmQC.WorkNo && x.InLotNo == scmQC.InLotNo && x.Insp_Seq == s.InspSeq && x.Seq == s.Seq && x.CheckList == s.CheckList).LastOrDefault();
        ...
        private void SetTitle(TN_QCT1100 obj)
        {
            ...
            cellItemName.Text = obj.TN_STD1100.ItemName1.GetNullToEmpty();
            //cellItemName.Text = string.Format("{0} / {1}", obj.TN_STD1100.ItemName.GetNullToEmpty(), obj.TN_STD1100.ItemName1.GetNullToEmpty());
    ...
    { 
        ...
        public decimal Insp_Seq { get; set; }
