...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR1100 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("ProdItem", LabelConvert.GetLabelText("ProdItem"), false);
            ...
            MasterGridExControl.MainGrid.AddColumn("CustomerConfirm", LabelConvert.GetLabelText("CustomerConfirm"));
            MasterGridExControl.MainGrid.AddColumn("CustomerConfirmDate", LabelConvert.GetLabelText("CustomerConfirmDate"), HorzAlignment.Default, FormatType.DateTime, "yyyy-MM-dd");

            MasterGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "PoDate", "DueDate", "PoCustomerCode", "Memo", "ProdItem", "PoId");
            ...
            DetailGridExControl.MainGrid.AddColumn("Memo1", LabelConvert.GetLabelText("CustomerMemo"));
            DetailGridExControl.MainGrid.AddColumn("CustomerConfirm", LabelConvert.GetLabelText("CustomerConfirm"));
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("PoId", ModelService.GetChildList<User>(p => p.ScmYn == "N" && p.Active == "Y" && p.MainYn == "02"), "LoginId", "UserName");
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CustomerConfirm", DbRequestHandler.GetCommTopCode(MasterCodeSTR.CustomerConfirm), "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"));
            ...
            DetailGridExControl.MainGrid.MainView.Columns["Memo1"].ColumnEdit = new Service.Controls.CommentGridButtonEdit(DetailGridExControl, "Memo1", false);
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CustomerConfirm", DbRequestHandler.GetCommTopCode(MasterCodeSTR.CustomerConfirm), "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"));
        ...
        protected override void DataLoad()
        {
            ...
            {
                string po = masterdata[i].PoNo;
                var scm = ModelService.GetChildList<SCM_VI_PUR1100_SCM>(p => p.PoNo == po).FirstOrDefault();
                if (scm == null)
                {
                    masterdata[i].CustomerConfirm = "01";

                }
                else
                {
                    masterdata[i].Memo1 = scm.Memo.GetNullToEmpty();
                    masterdata[i].CustomerConfirm = scm.CustomerConfirm.GetNullToEmpty();
                    masterdata[i].CustomerConfirmDate = scm.CustomerConfirmDate;
        ...
        protected override void MasterFocusedRowChanged()
        {
            ...
            var detaildata = masterObj.TN_PUR1101List.OrderBy(p => p.PoSeq).ToList();
            for (int i = 0; i < detaildata.Count(); i++)
            {
                string po = detaildata[i].PoNo;
                int poseq = detaildata[i].PoSeq;
                var scmdtile = ModelService.GetChildList<SCM_VI_PUR1101_SCM>(p => p.PoNo == po && p.PoSeq == poseq).FirstOrDefault();
                if (scmdtile == null)
                {
                    detaildata[i].CustomerConfirm = "01";

                }
                else
                {
                    detaildata[i].Memo1 = scmdtile.Memo.GetNullToEmpty();
                    detaildata[i].CustomerConfirm = scmdtile.CustomerConfirm.GetNullToEmpty();
            ...
            DetailGridBindingSource.DataSource = detaildata;
        ...
        protected override void AddRowClicked()
        {
            TN_PUR1100 newobj = new TN_PUR1100()
            {
                ...
                PoFlag = "N",
                //CustomerConfirmDate = DateTime.Today,
                //CustomerConfirm = "01",
        ...
        protected override void FileChooseClicked()
        {
            ...
            {
                if (scm.CustomerConfirm != "01")
                {
                    MessageBox.Show("거래처입고접수가 된 항목은 발주확정취소가 불가합니다.");
                    return;
                }
            }
