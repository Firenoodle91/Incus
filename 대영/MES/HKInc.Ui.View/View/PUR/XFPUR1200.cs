...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR1200 : Service.Base.ListMasterDetailFormTemplate
    {
        ...
        {            
            ...
            lup_InId.SetDefault(true, "LoginId", "UserName", ModelService.GetChildList<User>(p => p.ScmYn == "N" && p.Active == "Y" && p.MainYn == "02").ToList());
        ...
        {
            IsMasterGridButtonFileChooseEnabled = UserRight.HasEdit;  //재입고기능 숨기기
            ...
            MasterGridExControl.MainGrid.AddColumn("InCustomerDate", LabelConvert.GetLabelText("InCustomerDate"));
            MasterGridExControl.MainGrid.AddColumn("InCustomerId", LabelConvert.GetLabelText("InCustomerId"));
            MasterGridExControl.MainGrid.AddColumn("InCustConfirmFlag", LabelConvert.GetLabelText("InCustConfirmFlag"), false);
            MasterGridExControl.MainGrid.AddColumn("InConfirmFlag", LabelConvert.GetLabelText("InConfirmFlag"), HorzAlignment.Center, true);
            MasterGridExControl.MainGrid.AddColumn("Memo", LabelConvert.GetLabelText("Memo"));
            MasterGridExControl.MainGrid.AddColumn("Memo1", LabelConvert.GetLabelText("CustomerMemo"));
            MasterGridExControl.MainGrid.AddColumn("SCMYN",false);
            ...
            //barButtonDisposal.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
            ...
            DetailGridExControl.MainGrid.AddColumn("NotInConfirmFlag", LabelConvert.GetLabelText("NotInConfirm"), HorzAlignment.Center, true);
            ...
            */
            ...
            var barButtonNotInConfirm = new DevExpress.XtraBars.BarButtonItem();
            barButtonNotInConfirm.Id = 5;
            barButtonNotInConfirm.ImageOptions.Image = IconImageList.GetIconImage("actions/deletelist");
            barButtonNotInConfirm.ItemShortcut = new DevExpress.XtraBars.BarShortcut((Keys.Alt | Keys.Q));
            barButtonNotInConfirm.Name = "barButtonNotInConfirm";
            barButtonNotInConfirm.PaintStyle = DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph;
            barButtonNotInConfirm.ShortcutKeyDisplayString = "Alt+Q";
            barButtonNotInConfirm.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
            barButtonNotInConfirm.Caption = LabelConvert.GetLabelText("NotInConfirm") + "[Alt+Q]";
            barButtonNotInConfirm.ItemClick += BarButtonNotInConfirm_ItemClick;
            DetailGridExControl.BarTools.AddItem(barButtonNotInConfirm);
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InId", ModelService.GetChildList<User>(p => p.ScmYn == "N" && p.Active == "Y" && p.MainYn == "02"), "LoginId", "UserName");
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InCustomerId", ModelService.GetChildList<User>(p => true), "LoginId", "UserName");
            ...
            MasterGridExControl.MainGrid.MainView.Columns["Memo1"].ColumnEdit = new Service.Controls.CommentGridButtonEdit(MasterGridExControl, "Memo1", false);
        ...
        protected override void MasterFocusedRowChanged()
        {
            ...
            DetailGridBindingSource.DataSource = masterObj.TN_PUR1201List.OrderBy(p => p.InSeq).ToList();
        ...
        private void DetailFocused()
        {
            ...
            if (masterObj == null)
            {
                DetailGridExControl.BarTools.ItemLinks[4].ImageOptions.Image = IconImageList.GetIconImage("actions/apply");
                DetailGridExControl.BarTools.ItemLinks[4].Caption = LabelConvert.GetLabelText("InConfirm") + "[Alt+T]";
                DetailGridExControl.BarTools.ItemLinks[5].ImageOptions.Image = IconImageList.GetIconImage("actions/deletelist");
                DetailGridExControl.BarTools.ItemLinks[5].Caption = LabelConvert.GetLabelText("NotInConfirm") + "[Alt+Q]";
                return;
            }
            ...
            {
                DetailGridExControl.BarTools.ItemLinks[4].ImageOptions.Image = IconImageList.GetIconImage("actions/cancel");
                DetailGridExControl.BarTools.ItemLinks[4].Caption = LabelConvert.GetLabelText("InConfirmCancel") + "[Alt+T]";
            }
            else
            {
                DetailGridExControl.BarTools.ItemLinks[4].ImageOptions.Image = IconImageList.GetIconImage("actions/apply");
            ...
            if (detailObj.NotInConfirmFlag == "Y")
            {
                DetailGridExControl.BarTools.ItemLinks[5].ImageOptions.Image = IconImageList.GetIconImage("actions/close");
                DetailGridExControl.BarTools.ItemLinks[5].Caption = LabelConvert.GetLabelText("NotInConfirmCancel") + "[Alt+Q]";
            }
            else
            {
                DetailGridExControl.BarTools.ItemLinks[5].ImageOptions.Image = IconImageList.GetIconImage("actions/deletelist");
        ...
        protected override void AddRowClicked()
        {
            ...
            IPopupForm form = ProductionPopupFactory.GetPopupForm(ProductionPopupView.SELECT_PUR1100_NEW, param, MasterAddRowPopupCallback);
        ...
        private void MasterAddRowPopupCallback(object sender, Utils.Common.PopupArgument e)
        {
            ...
            var returnList = (List<VI_PUR_SCM>)e.Map.GetValue(PopupParameter.ReturnObject);

            foreach (var returnObj in returnList)
            {

                //var scmynchk = ModelService.GetChildList<TN_STD1400>(p => p.CustomerCode == returnObj.PoCustomerCode).FirstOrDefault();

                if (returnObj.ScmYn == "Y")
                {
                    //    var incustomer_confirmchk = ModelService.GetChildList<TN_PUR1200_SCM>(p => p.PoNo == returnObj.PoNo 
                    //                                                                            && p.InCustomerCode == returnObj.PoCustomerCode).FirstOrDefault();
                    //    if (incustomer_confirmchk.InCustConfirmFlag == "N")
                    //    {
                    //        MessageBox.Show("발주번호" + incustomer_confirmchk.PoNo + "의 협력사 입고접수가 완료되지 않았습니다. 입고가 불가합니다.");
                    //    }
                    //    else
                    //    {
                    ...
                    newObj.InCustConfirmFlag = returnObj.InCustConfirmFlag;
                    newObj.Memo1 = returnObj.Memo1;
                    newObj.InConfirmFlag = "N";
                    newObj.SCMYN = returnObj.ScmYn;
        ...
        protected override void DetailAddRowClicked()
        {
            ...
            param.SetValue(PopupParameter.Value_1, obj.SCMYN);
            param.SetValue(PopupParameter.Value_2, obj.InNo);
         
            IPopupForm form = ProductionPopupFactory.GetPopupForm(ProductionPopupView.SELECT_PUR1101_NEW, param, DetailAddRowPopupCallback);
            form.ShowPopup(true);
        }
        ...
        private void DetailAddRowPopupCallback(object sender, HKInc.Utils.Common.PopupArgument e)
        {
            ...
            {
                var returnList = (List<SCM_VI_PUR1201_SCM>)e.Map.GetValue(PopupParameter.ReturnObject);
                ...
                foreach (var v in returnList)
                {
                    //var poDetailObj = ModelService.GetChildList<VI_PUR1101_SCM>(p => p.PoNo == v.PoNo && p.PoSeq == v.PoSeq && p.InNo == masterObj.InNo).FirstOrDefault();
                    var newObj = new TN_PUR1201();
                    newObj.InNo = v.InNo;
                    newObj.InSeq = v.InSeq.GetIntNullToZero();
                    ...
                    newObj.InQty = v.InQty.GetNullToZero();
                  //  newObj.InCost = v.PoCost;
                    ...
                    newObj.InCustomerLotNo = v.InCustomerlot_no;
                    newObj.NewRowFlag = "Y";
                    newObj.InConfirmFlag = "N";
        ...
        private void BarButtonInConfirm_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)//PHS
        {

            var masterlObj = MasterGridBindingSource.Current as TN_PUR1200;
            if (masterlObj == null) return;
            ...
            if (InInspectionState == "대기" && detailObj.TN_STD1100.StockInspFlag.GetNullToEmpty() == "Y" && detailObj.InConfirmFlag == "N")
            {
                MessageBoxHandler.Show("수입검사를 진행후 확정하여 주십시오.");
                return;
            ...
            int rowchk = DetailGridExControl.MainGrid.MainView.DataRowCount;

            for (int i = 0; i < DetailGridExControl.MainGrid.MainView.DataRowCount; i++)
            {
                if(DetailGridExControl.MainGrid.MainView.GetRowCellValue(i, "InConfirmFlag").ToString().GetNullToEmpty() == "Y")
                {
                    confirmchk++;
                }
            }

            if(rowchk == confirmchk)
            {
                masterlObj.InConfirmFlag = "Y";
            }
            else
            {
          
               
                masterlObj.InConfirmFlag = "N";
            }

        }

        private void BarButtonNotInConfirm_ItemClick(object sender, ItemClickEventArgs e)
        {
            var masterlObj = MasterGridBindingSource.Current as TN_PUR1200;
            if (masterlObj == null) return;
            ...
            detailObj.NotInConfirmFlag = detailObj.NotInConfirmFlag == "Y" ? "N" : "Y";
            DetailGridExControl.BestFitColumns();
            DetailFocused();
        }
        ...
        private void BarButtonPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                // 20210819 오세완 차장 대영 요청으로 10*6 크기로 변경 처리
                var mainReport = new REPORT.XRPUR1201_V2();
                foreach (var v in printList.OrderByDescending(p => p.InSeq).ToList())
                {
                    ...
                    if (printQty <= 1)
                    {
                        ...
                        // 20210819 오세완 차장 대영 요청으로 10*6 크기로 변경 처리
                        var report = new REPORT.XRPUR1201_V2(v);
        ...
        private void MainView_ShowingEditor(object sender, CancelEventArgs e)
        {
            ...
            var scmyn = ModelService.GetChildList<TN_STD1400>(p => p.CustomerCode == masterObj.InCustomerCode).FirstOrDefault();

            if (masterObj.InCustConfirmFlag == "Y" && scmyn.ScmYn == "Y")
            {
                if (fieldName == "InCustomer" || fieldName == "InCustomerCode")
                    e.Cancel = true;
            }
            else
            {
