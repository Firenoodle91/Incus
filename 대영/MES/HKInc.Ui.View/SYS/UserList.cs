...
namespace HKInc.Ui.View.SYS
{
    ...
    public partial class UserList : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("MainYn", LabelConvert.GetLabelText("MainYn"));
            GridExControl.MainGrid.AddColumn("CustomerCode", LabelConvert.GetLabelText("CustomerName"));
            GridExControl.MainGrid.AddColumn("ScmYn", LabelConvert.GetLabelText("ScmYn"));
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.SetRepositoryItemCheckEdit("ScmYn", "N");
