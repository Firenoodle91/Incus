...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    {
        IService<VI_INSP_IN_OBJECT_V2> ModelService = (IService<VI_INSP_IN_OBJECT_V2>)ProductionFactory.GetDomainService("VI_INSP_IN_OBJECT_V2");
        ...
        protected override void Confirm()
        {
            ...
            var obj = (VI_INSP_IN_OBJECT_V2)ModelBindingSource.Current;
            if (IsmultiSelect)
            {
                var returnList = new List<VI_INSP_IN_OBJECT_V2>();
                if (obj != null)
