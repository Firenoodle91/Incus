...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    [Table("SCM_VI_QCT1101_SCM")]
    public class SCM_VI_QCT1101_SCM
    {
        public SCM_VI_QCT1101_SCM()
        {
        }
        /// <summary>검사번호</summary>            
        [ForeignKey("SCM_VI_QCT1100_SCM"), Key, Column("INSP_NO", Order = 0), Required(ErrorMessage = "InspNo")] public string InspNo { get; set; }
       ...
       public virtual SCM_VI_QCT1100_SCM SCM_VI_QCT1100_SCM { get; set; }
