...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    [Table("SCM_VI_QCT1100_SCM")]
    public class SCM_VI_QCT1100_SCM 
    {
        public SCM_VI_QCT1100_SCM()
        {
            TN_QCT1101List = new List<TN_QCT1101>();
            TN_QCT1101List_SCM = new List<SCM_VI_QCT1101_SCM>();
        }
        ...
        /// <summary>검사결과</summary>                  
        [Column("CHECK_RESULT_CUST"), Required(ErrorMessage = "CheckResult")] public string CheckResultCust { get; set; }
        /// <summary>파일명</summary>                    
