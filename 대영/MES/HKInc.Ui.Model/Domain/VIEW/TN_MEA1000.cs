...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    public class TN_MEA1000 : BaseDomain.MES_BaseDomain
    {
        ...
        /// 2021-06-02 김진우 주임 추가
        /// <summary> 제작일자 </summary>
        [Column("MANUFACTURE_DATE")] public DateTime? ManufactureDate { get; set; }
        /// <summary>
        /// 2021-06-07 김진우 주임 추가
        /// 비가동품질관리여부
        /// </summary>
        [Column("MSTOP_CHECK_M_FLAG")] public string MachineStopCheckManageFlag { get; set; }
        /// <summary>점수</summary>            
        ...
        /// <summary> 2021-06-03 김진우 주임 추가 </summary>
        ...
        //    get
        //    {
        //        if (TN_MEQ1300List.Count > 0)
        //        {
        //            return TN_MEQ1300List.Where(p => p.MachineMCode == MachineMCode).OrderBy(o => o.QcDate).LastOrDefault().Grade;
        ...
        //        if (TN_MEQ1300List.Count > 0)
        //        {
        //            return TN_MEQ1300List.Where(p => p.MachineMCode == MachineMCode).OrderBy(o => o.QcDate).LastOrDefault().TotalScore;
        ...
        //[NotMapped]
        //public DateTime? MachineGDate
        //{
        //    get
        //    {
        //        if (TN_MEQ1300List.Count > 0)
        //        {
        //            return TN_MEQ1300List.Where(p => p.MachineMCode == MachineMCode).OrderBy(o => o.QcDate).LastOrDefault().QcDate;
