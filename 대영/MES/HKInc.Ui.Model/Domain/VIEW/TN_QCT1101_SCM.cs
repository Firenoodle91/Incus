...
{
    /// <summary>검사 디테일(SCM)</summary>	
    [Table("TN_QCT1101T_SCM")]
    public class TN_QCT1101_SCM : BaseDomain.MES_BaseDomain
    {
        public TN_QCT1101_SCM()
        {
        }
        /// <summary>검사번호</summary>            
        [ForeignKey("TN_QCT1100"), Key, Column("INSP_NO", Order = 0), Required(ErrorMessage = "InspNo")] public string InspNo { get; set; }
