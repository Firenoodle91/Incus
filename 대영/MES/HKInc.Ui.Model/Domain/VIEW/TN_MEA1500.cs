...
namespace HKInc.Ui.Model.Domain.VIEW
{
    ...
    [Table("TN_MEA1500T")]
    public class TN_MEA1500 : BaseDomain.MES_BaseDomain
    {
        public TN_MEA1500()
        {
            TN_MEA1501List = new List<TN_MEA1501>();
        }
        /// <summary>계측기코드</summary>          
        [Key, Column("RBID_CODE"), Required(ErrorMessage = "RBIDCode")] public string RBIDCode { get; set; }
        /// <summary>계측기명</summary>            
        [Column("RBID_NAME"), Required(ErrorMessage = "RBIDName")] public string RBIDName { get; set; }
        /// <summary>계측기명(영문)</summary>      
        [Column("RBID_NAME_ENG")] public string RBIDNameENG { get; set; }
        /// <summary>계측기명(중문)</summary>      
        [Column("RBID_NAME_CHN")] public string RBIDNameCHN { get; set; }
        /// <summary>계측기종류</summary>                
        [Column("RBID_KIND")] public string RBIDKind { get; set; }
        /// <summary>규격</summary>                
        ...
        public virtual ICollection<TN_MEA1501> TN_MEA1501List { get; set; }
    }
}