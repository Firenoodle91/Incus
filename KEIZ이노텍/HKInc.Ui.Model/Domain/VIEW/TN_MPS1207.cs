...
{
    /// <summary>작업실적관리 불량 디테일(리워크)</summary>	
    [Table("TN_MPS1207T")]
    public class TN_MPS1207 : BaseDomain.MES_BaseDomain
    {
        public TN_MPS1207()
        {
        }
        ...
        [Key, Column("IN_SEQ", Order = 5), Required(ErrorMessage = "InSeq")] public int InSeq { get; set; }
