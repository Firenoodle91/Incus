    ...
    public partial class XPFQCT1700 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        private void BtnFile_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (fileData != null)
            {
                ...
                tn.ClaimFiledata = fileData;
            }
        }


        private void BtnFile_EditValueChanged_OLD(object sender, EventArgs e)
        {
            ButtonEdit obj = sender as ButtonEdit;
            string fname = "";
            ...
            //try
            //{
            //    fname = obj.EditValue.ToString().Substring(0, 4);
            //}
            //catch { fname = ""; }
            //if (fname != "http")
            //{
            ...
            //    obj.Tag = FileHandler.FtpImageToByte(obj.EditValue.ToString());
            //    byte[] fileData2 = obj.Tag as byte[];
            //    TN_QCT1700 tn = ModelBindingSource.Current as TN_QCT1700;
            //    pictureEdit1.EditValue = fileData2;
            //    tn.ClaimFile = buttonEdit1.EditValue.ToString();
            //    tn.ClaimFiledata = fileData2;
        ...
        protected override void InitCombo()
        {
            ...
            lupempid.SetDefault(false, "LoginId", "UserName", ORD1000Service.GetChildList<UserView>(p=>p.Active=="Y").ToList());
            lupitem.SetDefaultItem(false, "ItemCode", "ItemNm1", ORD1000Service.GetChildList<TN_STD1100>(p => p.UseYn == "Y").OrderBy(o=>o.ItemNm1).ToList());
            lupftype.SetDefault(false, "Mcode", "Codename", DbRequesHandler.GetCommCode(MasterCodeSTR.QCFAIL));
        }
        protected override void DataLoad()
        {
            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                ...
                ModelBindingSource.Add(new TN_QCT1700 { ClaimNo = DbRequesHandler.GetRequestNumber("CQC"),Seq=1,ResultDate=DateTime.Today });
