...
namespace HKInc.Ui.View.PUR
{
    ...
    public partial class XFPUR1800 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        private void DetailView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.Name == "InSre")
            {
                ...
                for (int i = 0; i < gv.RowCount; i++)
                {
                    switch (gv.GetRowCellValue(i, gv.Columns["InSre"]).ToString())
                    {
                        case "39": i39cnt++; break;
                        case "40": i40cnt++; break;
                        
                    }
                }
                if (i40cnt == rowcont) { hobj.InSre = "40"; }           
                else if(i40cnt<rowcont) { hobj.InSre = "39"; }
                else { hobj.InSre = "40"; }
                MasterGridExControl.MainGrid.BestFitColumns();
            }
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("InSeq", "순번", HorzAlignment.Center, true);
            DetailGridExControl.MainGrid.AddColumn("InLotno", "입고LOT", HorzAlignment.Center, true);
            ...
            DetailGridExControl.MainGrid.AddColumn("InQty", "입고수량", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "#,###.##");
            DetailGridExControl.MainGrid.AddColumn("Cost", "입고단가", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "#,###.##");
            DetailGridExControl.MainGrid.AddColumn("Amt", "입고금액", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "#,###.##");
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InSre", DbRequesHandler.GetCommCode(MasterCodeSTR.INPUTSTATUS), "Mcode", "Codename"); // 20220111 오세완 차장 입고상태 공통코드로 변경
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InSre", DbRequesHandler.GetCommCode(MasterCodeSTR.INPUTSTATUS), "Mcode", "Codename"); // 20220111 오세완 차장 입고상태 공통코드로 변경
