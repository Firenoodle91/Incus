...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XFSORD2001 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("ItemCode", ModelService.GetChildList<TN_STD1100>(p => p.TopCategory != "P03" && p.UseYn == "Y").OrderBy(o => o.ItemNm).ToList(), "ItemCode", "ItemNm1");
