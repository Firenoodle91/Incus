...
namespace HKInc.Service.Base
{
    public partial class TreeListFormTemplate : BaseForm 
    {
        ...
        protected bool IsGridButtonExportEnabled
        {
            ...
            set { _IsButtonExportEnabled = value; TreeListExControl.SetToolbarButtonVisible(GridToolbarButton.Export, value); }
        }

        protected bool IsGridButtonFileChooseEnabled
        {
            get { return _IsButtonFileChooseEnabled; }
            set { _IsButtonFileChooseEnabled = value; TreeListExControl.SetToolbarButtonVisible(GridToolbarButton.FileChoose, value); }
        }
