...
{
    public partial class ListMasterDetailDetailFormTemplate : BaseForm 
    {
        ...
        #region Construct
        public ListMasterDetailDetailFormTemplate()
        {
            InitializeComponent();            
        }        
        ...
        {
            if (DetailGridExControl != null) SubDetailGridExControl.MainGrid.PostEditor();
