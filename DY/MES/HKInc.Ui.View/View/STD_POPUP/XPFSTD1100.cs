...
namespace HKInc.Ui.View.View.STD_POPUP
{
    ...
    public partial class XPFSTD1100 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void AddControlList()
        {
            ...
            ControlEnableList.Add("ItemName1", tx_ItemName1);
        ...
        protected override void InitCombo()
        {
            ...
            // 20211029 오세완 차장 신부장님 요청으로 소분류 구분 추가
            lup_BottomCategory.SetDefault(true, "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"), DbRequestHandler.GetCommCode(MasterCodeSTR.BottomType, 1));
