...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR_NOT_IN_STATUS : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("ItemName1", LabelConvert.GetLabelText("ItemName1")); // 20210824 오세완 차장 품목명 누락 추가
        ...
        protected override void DataLoad()
        {
            ...
            using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
            {
                ...
                var vResult = context.Database.SqlQuery<TEMP_XFPUR_NOT_IN_STATUS>("USP_GET_PUR_NOT_IN_STATUS_V2 @SearchDateFr,@SearchDateTo,@SrcItemCode", SearchDateFr, SearchDateTo, ItemCode).ToList(); // 20211216 오세완 차장 scm에서 미입고된 수량이 잘 출력되지 않는 현상을 수정한 버전으로 교체
