...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    public partial class XPFMACHINECHECK : Service.Base.ListFormTemplate
    {
        ...
        public XPFMACHINECHECK(TEMP_XFPOP1000 pWork)
        {
            InitializeComponent();
        ...
        /// <summary>
        /// 20220110 오세완 차장
        /// 작업지시를 통해서 설비코드를 불러오는 로직 때문에 초기화 분리
        /// </summary>
        ...
        protected override void InitRepository()
        {
            ...
            // 20220114 오세완 차장 프레스 공정으로부터 작업지시에 설비가 지정되어 있는 경우에 그 값으로 설비점검을 처음 진행할 수 있게 처리
            if (workObj != null)
            {
                lup_Machine.EditValue = workObj.MachineCode.GetNullToEmpty();
            }
        }
        ...
        private void Search(string machineCode)
        {
            ...
            // 20220124 오세완 차장 비가동된 설비도 일상점검을 실시하게 해 달라고 하여 신부장님이 요구하여 생략 처리
