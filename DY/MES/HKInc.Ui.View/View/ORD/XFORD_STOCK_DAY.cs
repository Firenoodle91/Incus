...
namespace HKInc.Ui.View.View.ORD
{
    ...
    public partial class XFORD_STOCK_DAY : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn(DataConvert.GetCultureDataFieldName("Date"), LabelConvert.GetLabelText("Date"), HorzAlignment.Center, FormatType.DateTime, "yyyy-MM-dd");
