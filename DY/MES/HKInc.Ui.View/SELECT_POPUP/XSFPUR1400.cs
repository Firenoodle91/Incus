...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    /// 외주발주마스터 Select 팝업
    /// </summary>
    public partial class XSFPUR1400 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XSFPUR1400(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void InitCombo()
        {
            ...
            lup_PoCustomer.SetDefault(true, "CustomerCode", "CustomerName", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList());
        ...
        protected override void DataLoad()
        {
            ...
            {
                var newList = PopupParam.GetValue(PopupParameter.Value_1) as List<TN_PUR1500>;
                poNoList.AddRange(newList.Select(p => p.PoNo));
            }
            ...
            ModelBindingSource.DataSource = ModelService.GetList(p => (p.PoDate >= dt_PoDate.DateFrEdit.DateTime && p.PoDate <= dt_PoDate.DateToEdit.DateTime)
                                                                ...
                                                                //&& (!poNoList.Contains(p.PoNo))
                                                                )
                                                                .Where(p => p.NotInFlag)
                                                                //.Where(p => p.TN_PUR1401List.Sum(c => c.NotInQty) > 0)
                                                                .OrderBy(o => o.PoDate)
                                                                .ThenBy(o => o.PoNo)
                                                                .ToList();
        ...
        protected override void Confirm()
        {
            ...
            if (IsmultiSelect)
            {
                var returnList = new List<TN_PUR1400>();
                var dataList = ModelBindingSource.List as List<TN_PUR1400>;
            ...
            {
                param.SetValue(PopupParameter.ReturnObject, ModelService.Detached((TN_PUR1400)ModelBindingSource.Current));
            }
        ...
        private void MainView_RowClick(object sender, RowClickEventArgs e)
        {
            ...
            if (e.Clicks == 2)
            {
                var poMaster = (TN_PUR1400)ModelBindingSource.Current;
                if (IsmultiSelect)
                {
                    var returnList = new List<TN_PUR1400>();
                    if (poMaster != null)
