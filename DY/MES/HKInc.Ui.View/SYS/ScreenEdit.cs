...
namespace HKInc.Ui.View.SYS
{
    ...
    {                
        ...
        protected override void InitCombo()
        {
            ...
            lupModuleId.SetDefault(false, "ModuleId", Service.Helper.DataConvert.GetCultureDataFieldName("ModuleName", "ModuleName2", "ModuleName3"), ScreenService.GetChildList<Module>(p => true).ToList());
