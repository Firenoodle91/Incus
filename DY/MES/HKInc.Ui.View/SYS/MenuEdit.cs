...
namespace HKInc.Ui.View.SYS
{
    ...
    {                
        ...
        {            
            ...
            ControlEnableList.Add("SCM_YN", checkEdit1);
        ...
        protected override void InitCombo()
        {
            ...
            lupUpperMenuId.DisplayMember = Service.Helper.DataConvert.GetCultureDataFieldName("MenuName", "MenuName2", "MenuName3");
            lupUpperMenuId.ShowColumns = false;
            lupUpperMenuId.AddColumn(lupUpperMenuId.DisplayMember);
            lupUpperMenuId.AddColumn("IconIndex", false);                        
            lupUpperMenuId.DataSource = upperMenuList.OrderBy(p=>p.SortOrder).ToList();
            ...
            lupScreenId.SetDefault(true, "ScreenId", Service.Helper.DataConvert.GetCultureDataFieldName("ScreenName", "ScreenName2", "ScreenName3"), screenList);
            ...
            dateCreateTime.SetFormat(DateFormat.DateAndTimeSecond);
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("Export", false);
            gridEx1.MainGrid.AddColumn("Print", false);
            gridEx1.MainGrid.AddColumn("Reload", LabelConvert.GetLabelText("ReloadFlag"));
            ...
            gridEx1.MainGrid.SetEditable("Read", "Insert", "Write", "Export", "Print", "Reload");  
        }
        ...
        protected override void InitRepository()
        {
            ...
            gridEx1.MainGrid.SetRepositoryItemLookUpEdit("UserGroupId", userGroupList, "UserGroupId", "UserGroupName");
            ...
            gridEx1.MainGrid.SetRepositoryItemCheckEdit("Reload", "N");
