...
namespace HKInc.Ui.Model.Context
{
    public class ProductionContext : DbContext
    {
        ...
        /// <summary>
        /// 20211018 오세완 차장 bom type master 추가
        /// </summary>
        public virtual DbSet<TN_STD1320> TN_STD1320 { get; set; }

        /// <summary>
        /// 20211018 오세완 차장 bom type detail 추가
        /// </summary>
        public virtual DbSet<TN_STD1321> TN_STD1321 { get; set; }
        ...
        public virtual DbSet<TN_PUR1200_SCM> TN_PUR1200_SCM { get; set; }
        public virtual DbSet<TN_PUR1201_SCM> TN_PUR1201_SCM { get; set; }
        public virtual DbSet<TN_PUR1304> TN_PUR1304 { get; set; }
        public virtual DbSet<TN_PUR1305> TN_PUR1305 { get; set; }
        ...
        public virtual DbSet<TN_MPS1205> TN_MPS1205 { get; set; }
        public virtual DbSet<TN_MPS1206> TN_MPS1206 { get; set; }
        public virtual DbSet<TN_MPS1207> TN_MPS1207 { get; set; }
        ...
        public virtual DbSet<TN_QCT1700> TN_QCT1700 { get; set; }
        public virtual DbSet<TN_QCT1800> TN_QCT1800 { get; set; }

        /// <summary>
        /// 20210917 오세완 차장 출하검사 마스터 추가
        /// </summary>
        public virtual DbSet<TN_QCT1900> TN_QCT1900 { get; set; }

        /// <summary>
        /// 20210917 오세완 차장 출하검사 디테일 추가
        /// </summary>
        public virtual DbSet<TN_QCT1901> TN_QCT1901 { get; set; }
        // public virtual DbSet<TN_QCT1101_SCM> TN_QCT1101_SCM { get; set; }
        #endregion
        ...
        public virtual DbSet<TN_MEA1300> TN_MEA1300 { get; set; }   // 2021-05-31 김진우 주임 추가
        public virtual DbSet<TN_MEA1301> TN_MEA1301 { get; set; }   // 2021-05-31 김진우 주임 추가
        public virtual DbSet<TN_MEA1302> TN_MEA1302 { get; set; }   // 2021-05-31 김진우 주임 추가
        public virtual DbSet<TN_MEA1305> TN_MEA1305 { get; set; }   // 2021-06-14 김진우 주임 추가
        public virtual DbSet<TN_MEQ1300> TN_MEQ1300 { get; set; }   // 2021-06-03 김진우 주임 추가
        public virtual DbSet<TN_MEQ1301> TN_MEQ1301 { get; set; }   // 2021-06-03 김진우 주임 추가

        /// <summary>
        /// 20210715 오세완 차장 PLC 통신 현황 
        /// </summary>
        public virtual DbSet<TN_MEA1600> TN_MEA1600 { get; set; }
        public virtual DbSet<TN_CHF2000> TN_CHF2000 { get; set; }
        public virtual DbSet<TN_CHF2001> TN_CHF2001 { get; set; }
        public virtual DbSet<TN_CHF2002> TN_CHF2002 { get; set; }
        public virtual DbSet<TN_CHF2003> TN_CHF2003 { get; set; }
        public virtual DbSet<TN_WEL2000> TN_WEL2000 { get; set; }   // 2021-06-08 김진우 주임 추가
        public virtual DbSet<TN_WEL2001> TN_WEL2001 { get; set; }   // 2021-06-08 김진우 주임 추가
        public virtual DbSet<TN_WEL2002> TN_WEL2002 { get; set; }   // 2021-06-08 김진우 주임 추가
        public virtual DbSet<TN_WEL2003> TN_WEL2003 { get; set; }   // 2021-06-08 김진우 주임 추가
        ...
        public virtual DbSet<VI_INSP_IN_OBJECT_V2> VI_INSP_IN_OBJECT_V2 { get; set; }
        public virtual DbSet<VI_INSP_IN_OBJECT_SCM> VI_INSP_IN_OBJECT_SCM { get; set; }
        ...
        /// <summary>
        /// 20210616 오세완 차장 대영스타일 반제품 재고 뷰 추가
        /// </summary>
        public virtual DbSet<VI_BAN_STOCK_ITEM_V2> VI_BAN_STOCK_ITEM_V2 { get; set; }
        ...
        public virtual DbSet<VI_PUR_SCM> VI_PUR_SCM { get; set; }
        public virtual DbSet<VI_PUR1101_SCM> VI_PUR1101_SCM { get; set; }
        public virtual DbSet<VI_PUR1304> VI_PUR1304 { get; set; }
        public virtual DbSet<VI_PUR1305> VI_PUR1305 { get; set; }
        public virtual DbSet<VI_STD1100_BOMTREE> VI_STD1100_BOMTREE { get; set; }     
        public virtual DbSet<VI_BAN_STOCK_ITEM_MOVE_NO> VI_BAN_STOCK_ITEM_MOVE_NO { get; set; }

        /// <summary>
        /// 2021-06-14 김진우 주임 추가
        /// 설비 금형 목록
        /// </summary>
        public virtual DbSet<VI_MACHINE_MOLD_LIST> VI_MACHINE_MOLD_LIST { get; set; }
        #endregion
        #region SCM
        public virtual DbSet<SCM_VI_PUR1100_SCM> SCM_VI_PUR1100_SCM { get; set; }
        public virtual DbSet<SCM_VI_PUR1101_SCM> SCM_VI_PUR1101_SCM { get; set; }
        public virtual DbSet<SCM_VI_PUR1200_SCM> SCM_VI_PUR1200_SCM { get; set; }
        public virtual DbSet<SCM_VI_PUR1201_SCM> SCM_VI_PUR1201_SCM { get; set; }
        public virtual DbSet<SCM_VI_QCT1100_SCM> SCM_VI_QCT1100_SCM { get; set; }
        public virtual DbSet<SCM_VI_QCT1101_SCM> SCM_VI_QCT1101_SCM { get; set; }
        public virtual DbSet<SCM_VI_PUR1305> SCM_VI_PUR1305 { get; set; }
        #endregion
        ...
        public virtual DbSet<TN_MOLD1600> TN_MOLD1600 { get; set; }
        public virtual DbSet<TN_MOLD1601> TN_MOLD1601 { get; set; }
        public virtual DbSet<TN_MOLD1602> TN_MOLD1602 { get; set; }
        public virtual DbSet<TN_MOLD1700> TN_MOLD1700 { get; set; }
        public virtual DbSet<TN_MOLD1701> TN_MOLD1701 { get; set; }
        #endregion
