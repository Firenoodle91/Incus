...
namespace HKInc.Ui.View.PUR
{
    ...
    public partial class XFPUR1600 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("PoSeq", "순번", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n0");
            ...
            DetailGridExControl.MainGrid.AddColumn("PoQty", "수량", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n0");
            DetailGridExControl.MainGrid.AddColumn("Amt", "발주가", HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n0");
        ...
        protected override void InitRepository()
        {
            ...
            //MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ItemCode", ModelService.GetChildList<TN_STD1100>(p => p.UseYn == "Y" && p.TopCategory != "P03").ToList(), "ItemCode", "ItemNm");
        ...
        {
            TN_PUR1600 obj = new TN_PUR1600() { PoNo=DbRequesHandler.GetRequestNumber("PO"),PoDate=DateTime.Today};
        ...
        protected override void DeleteDetailRow()
        {
            ...
            //    {
            //        gv.SetRowCellValue(i, gv.Columns["PoSeq"], i + 1);
            //    }
