...
namespace HKInc.Ui.View.QC
{
    ...
    public partial class XFQC2000 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("Temp1", "포장 LOT NO");
            ...
            DetailGridExControl.MainGrid.AddColumn("No", "검사번호",false, HorzAlignment.Center);
        ...
        protected override void AddRowClicked()
        {
            ...
            param.SetValue(PopupParameter.Value_1, "Q05");
            IPopupForm form = ProductionPopupFactory.GetPopupForm(ProductionPopupView.XSFQCT2000, param, AddList);
            form.ShowPopup(true);
        }
        ...
        {
            if (e == null) return;
            VI_ADD_QC2000_LIST partList = (VI_ADD_QC2000_LIST)e.Map.GetValue(PopupParameter.ReturnObject);
