...
namespace HKInc.Ui.View.SYS
{
    public partial class MasterCodeList : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("CodeName", "코드명");
            MasterGridExControl.MainGrid.AddColumn("CodeName2", "코드명2",false);
            MasterGridExControl.MainGrid.AddColumn("CodeName3", "코드명3",false);            
            ...
            MasterGridExControl.MainGrid.SetHeaderColor(Color.Red, "CodeName");
            ...
            DetailGridExControl.MainGrid.AddColumn("CodeName", "코드명");
            DetailGridExControl.MainGrid.AddColumn("CodeName2", "코드명2", false);
            DetailGridExControl.MainGrid.AddColumn("CodeName3", "코드명3", false);
            ...
            DetailGridExControl.MainGrid.SetHeaderColor(Color.Red, "CodeName");
