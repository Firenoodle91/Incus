...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XFSPUR1200 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("RemainReqQty", "발주잔량");
        ...
        {
            gridEx1.MainGrid.SetRepositoryItemSpinEdit("ReqQty", DefaultBoolean.Default, "n0", true, false);
            gridEx1.MainGrid.SetRepositoryItemSpinEdit("RemainReqQty", DefaultBoolean.Default, "n0", true, false);
            gridEx1.MainGrid.SetRepositoryItemSpinEdit("Temp1", DefaultBoolean.Default, "n0", true, false);
        ...
        protected override void DataLoad()
        {
            ...
            bindingSource.DataSource = ModelService.GetList(p => p.ReqNo == ReqNo).Where(p=>p.RemainReqQty > 0).ToList();
