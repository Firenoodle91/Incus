...
{
    public partial class XPFPACKLABEL : XtraForm
    {
        ...
        public XPFPACKLABEL(int resultQty,string lotNo, string itemCode, string itemName, TN_MPS1401 TN_MPS1401, int StdPackQty, bool popFlag = true)
        {
            InitializeComponent();
            ...
            {
                MessageBoxHandler.Show("실적이 존재하지 않습니다.", "경고");
                Close();
            }
