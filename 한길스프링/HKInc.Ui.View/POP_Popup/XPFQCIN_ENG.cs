...
{
    public partial class XPFQCIN_ENG : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XPFQCIN_ENG(TP_POPJOBLIST obj,string lotno)
        {
            InitializeComponent();
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("CheckName", "Inspection items");
            GridExControl.MainGrid.AddColumn("CheckProv", "Method of inspection");
            GridExControl.MainGrid.AddColumn("CheckStand", "Standard");
            GridExControl.MainGrid.AddColumn("UpQuad", "Upper limit");
            GridExControl.MainGrid.AddColumn("DownQuad", "Down limit");
            ...
            GridExControl.MainGrid.AddColumn("ChaeckFlag", "Judgment");
            GridExControl.MainGrid.SetGridFont(GridExControl.MainGrid.MainView, new Font(DefaultFont.FontFamily, 13, FontStyle.Bold));
        ...
        private void QcLoad(string qc)
        {
            ...
            if (qc == btn_step.Tag.ToString())
            {
                ...
                SetMessage(string.Format("Where to check : {0}", QCStepList.Where(p => p.Mcode == StepValue).First().Codename));
            }
            else SetMessage("");
        }
        ...
        private void acceptrun()
        {
            ...
            {
                MessageBox.Show("There is no data to apply.");
                return;
            }
