    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            else if(GlobalVariable.DefaultPOPType =="POP1")//일반공정
            {
                ...
                Application.Run(new Ui.View.POP.XFPOP004());

            }
            else if (GlobalVariable.DefaultPOPType == "POP1_ENG")//press 공정
            {
                //    string DefaultPOPWorkCenter = GlobalVariable.DefaultPOPWorkCenter;

                Application.Run(new Ui.View.POP.XFPOP004_ENG());
            ...
            else if (GlobalVariable.DefaultPOPType == "POP2")//press 공정
            {
                ...
                Application.Run(new Ui.View.REPORT.XFR6000());
