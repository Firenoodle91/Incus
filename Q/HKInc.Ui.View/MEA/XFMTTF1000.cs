...
namespace HKInc.Ui.View.MEA
{
    ...
    public partial class XFMTTF1000 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        public XFMTTF1000()
        {
            ...
            //DetailGridExControl.MainGrid.MainView.CellValueChanged += MainView_CellValueChanged;  // 작동안됨     2022-04-21 김진우 주석
        }

        protected override void InitCombo()
        {
            lupmc.SetDefault(true, "MachineCode", "MachineName", ModelService.GetChildList<TN_MEA1000>(p => p.UseYn == "Y").ToList());
        }
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemLookUpEdit("Maker",  DbRequestHandler.GetCommCode(MasterCodeSTR.MCMAKER), "Mcode", "Codename");
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("MM", DbRequestHandler.GetCommCode(MasterCodeSTR.MM), "Mcode", "Codename");
        }
        ...
        //    DataTable dt = DbRequestHandler.GetDTselect("exec SP_MTTF_DATA '" + tn1.YYYY + "','" + tn1.MM + "','" + tn1.MachineCode + "'");
        //    if (dt != null)
        //    {
