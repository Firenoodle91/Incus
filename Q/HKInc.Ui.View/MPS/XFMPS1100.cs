    ...
    public partial class XFMPS1100 :  HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitCombo()
        {
         //   luptem.SetDefault(true, "Mcode", "Codename", DbRequesHandler.GetCommCode(MasterCodeSTR.tem));
            //    lupitemCode.SetDefault(true, "ItemCode", "ItemNm", ModelService.GetChildList<TN_STD1100>(p => (p.TopCategory != "P03") && p.UseYn == "Y").OrderBy(o=>o.ItemNm1).ToList());
        }
        ...
        protected override void InitGrid()
        {
          ...
          //  MasterGridExControl.MainGrid.AddColumn("TN_STD1100.Temp5", "팀");
            ...
            DetailGridExControl.MainGrid.AddColumn("ItemCode", "품목명");
        ...
        protected override void InitRepository()
        {
          ...
          //  MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("TN_STD1100.Temp5", DbRequesHandler.GetCommCode(MasterCodeSTR.tem), "Mcode", "Codename");
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ItemCode", ModelService.GetChildList<TN_STD1100>(p => p.UseYn == "Y").OrderBy(o=>o.ItemNm1).ToList(), "ItemCode", "ItemNm");
        ...
        protected override void DetailAddRowClicked()
        {
            ...
            if (obj.PlanYn != "Y")
            {
                TN_MPS1300 newobj = new TN_MPS1300()
                {
                    ...
                    PlanNo = DbRequestHandler.GetRequestNumber("WP"),
