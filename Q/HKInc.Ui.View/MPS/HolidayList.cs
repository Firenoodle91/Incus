...
namespace HKInc.Ui.View.MPS
{
    ...
    {
        IService<Holiday> ModelService = (IService<Holiday>)ProductionFactory.GetDomainService("Holiday");
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("Date", "일자", HorzAlignment.Center, FormatType.DateTime, "d일");
            GridExControl.MainGrid.AddColumn("DayOfWeek", "요일", HorzAlignment.Center, FormatType.DateTime, "dddd");
            GridExControl.MainGrid.AddColumn("HolidayFlag", "휴일여부");
            GridExControl.MainGrid.AddColumn("OvertimeFlag", "특근여부");
            GridExControl.MainGrid.AddColumn("WorkTime", "근무시간(분)");
        ...
        protected override void DataLoad()
        {
            ...
            GridBindingSource.DataSource = ModelService.GetList(p => p.Date.Year == dt_YearMonth.DateTime.Year && 
                                                                     p.Date.Month == dt_YearMonth.DateTime.Month).OrderBy(p => p.Date).ToList();
