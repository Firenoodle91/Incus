    ...
    public partial class XFSTD1700 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitCombo()
        {
           // luptem.SetDefault(true, "Mcode", "Codename", DbRequesHandler.GetCommCode(MasterCodeSTR.tem));
            // lupitemcode.SetDefault(true, "ItemCode", "ItemNm", ModelService.GetChildList<TN_STD1100>(p=>p.UseYn=="Y").OrderBy(o=>o.ItemNm1).ToList());
        }
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("CarType", DbRequestHandler.GetCommCode(MasterCodeSTR.CARTYPE), "Mcode", "Codename");
