...
namespace HKInc.Ui.View.SYS
{
    public partial class UserSelect : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        {
         //   gridEx1.SetRepositoryItemLookUpEdit("GroupCode", MasterCode.GetMasterCode((int)MasterCodeEnum.UserGroupCode).ToList());
            gridEx1.SetRepositoryItemLookUpEdit("Rank", MasterCode.GetMasterCode((int)MasterCodeEnum.UserRankCode).ToList());
            gridEx1.SetRepositoryItemLookUpEdit("DepartmentCode", UserService.GetChildList<UserDepartment>(p => p.UseFlag != "N"), "DepartmentCode", "DepartmentName");
