...
namespace HKInc.Ui.View.QC_Popup
{
    public partial class XPFQCT1700 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            lupitem.SetDefault(false, "ItemCode", "ItemNm", ORD1000Service.GetChildList<TN_STD1100>(p => p.UseYn == "Y").OrderBy(o=>o.ItemNm1).ToList());
            lupftype.SetDefault(false, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.QCFAIL));
        }
        protected override void DataLoad()
        {
            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                ...
                ModelBindingSource.Add(new TN_QCT1700 { ClaimNo = DbRequestHandler.GetRequestNumber("CQC"),Seq=1,ResultDate=DateTime.Today });
