...
namespace HKInc.Ui.View.STD_Popup
{
    public partial class XPFSTD4M001 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            lupcartype.SetDefault(true,  "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.CARTYPE));
        ...
        protected override void DataLoad()
        {
            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                ...
                ModelBindingSource.Add(new TN_STD4M001 { L4mno = DbRequestHandler.GetRequestNumber("4M") });
