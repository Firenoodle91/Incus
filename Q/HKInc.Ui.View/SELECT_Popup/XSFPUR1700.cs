...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XSFPUR1700 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        {            
            gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("Process", DbRequestHandler.GetCommCode(MasterCodeSTR.Process), "Mcode", "Codename");
            gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("MachineCode", ModelService.GetChildList<TN_MEA1000>(p => p.UseYn == "Y").ToList(), "MachineCode", "MachineName");
            ...
            gridEx1.MainGrid.SetRepositoryItemLookUpEdit("JobStatus", MasterCode.GetMasterCode((int)MasterCodeEnum.PopStatus).ToList());
        ...
        protected override void DataLoad()
        {
            ...
            {
                bindingSource.DataSource = context.Database.SqlQuery<TP_PUR1700LIST>("SP_OUT_JOBLIST").ToList();
            }
