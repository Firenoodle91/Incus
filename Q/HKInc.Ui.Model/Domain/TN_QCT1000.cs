...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_QCT1000 : BaseDomain.MES_BaseDomain
    {
        ...
        /*public string CheckFlag             // 2022-02-23 김진우 오타 수정
        {
            get {
                string val1 = "";
                string val2 = "";
        ...
        } */ // 20020316 오세완 차장 pop에서 사용안한게 문제가 없으면 삭제할 예정 

        public virtual TN_STD1100 TN_STD1100 { get; set; }
        [NotMapped] public string X1 { get; set; } //측정치
        [NotMapped] public string X2 { get; set; }
        [NotMapped] public string X3 { get; set; }
        [NotMapped] public string X4 { get; set; }
        [NotMapped] public string X5 { get; set; }
        [NotMapped] public string X6 { get; set; }
        [NotMapped] public string X7 { get; set; }
        [NotMapped] public string X8 { get; set; }

        /// <summary>
        /// 20220316 오세완 차장 
        /// 판정결과
        /// </summary>
        [NotMapped] public string CheckFlag { get; set; }
