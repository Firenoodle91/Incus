...
namespace HKInc.Ui.View.View.ORD
{
    ...
    /// 개발납품계획관리
    /// </summary>
    public partial class XFORD1100_DEV : HKInc.Service.Base.ListMasterDetailSubDetailFormTemplate
    {
        IService<TN_ORD1000> ModelService = (IService<TN_ORD1000>)ProductionFactory.GetDomainService("TN_ORD1000");

        public XFORD1100_DEV()
        {
            InitializeComponent();
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("OrderNo", LabelConvert.GetLabelText("ReqDevelopmentNo"), false);
            ...
            DetailGridExControl.MainGrid.AddColumn("TN_STD1100.ProcTeamCode", LabelConvert.GetLabelText("ProductTeam"));
            ...
            SubDetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "DelivDate", "DelivQty", "ProductionFlag", "OutConfirmFlag", "Memo");
        ...
        protected override void InitRepository()
        {
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("TN_STD1100.ProcTeamCode", DbRequestHandler.GetCommTopCode(MasterCodeSTR.ProductTeamCode), "CodeVal", DataConvert.GetCultureDataFieldName("CodeName"));
        ...
        protected override void DataLoad()
        {
            ...
            MasterGridBindingSource.DataSource = ModelService.GetList(p => (string.IsNullOrEmpty(orderCustomerCode) ? true : p.OrderCustomerCode == orderCustomerCode)
                                                                        ...
                                                                        && (p.OrderType == "개발")
                                                                        && (p.ConfirmState == MasterCodeSTR.ApprovalFinish)
                                                                     )
                                                                     .OrderBy(p => p.OrderNo)
                                                                     .ToList();
        ...
        protected override void SubDetailAddRowClicked()
        {
            ...
            var obj = new TN_ORD1100()
            {
                ...
                DelivNo = DbRequestHandler.GetSeqMonth("DLV_D"),
        ...
        protected override void DeleteSubDetailRow()
        {
            ...
            {
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_48), LabelConvert.GetLabelText("DevlopmentDelivInfo"), LabelConvert.GetLabelText("OutInfo"), LabelConvert.GetLabelText("OutInfo")));
                return;
            }
            else if (SubObj.TN_MPS1100List.Count > 0)
            {
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_48), LabelConvert.GetLabelText("DevlopmentDelivInfo"), LabelConvert.GetLabelText("PlanInfo"), LabelConvert.GetLabelText("PlanInfo")));
                return;
            }
