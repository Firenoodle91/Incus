...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    public partial class XRPUR1100 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRPUR1100()
        {
            ...
            xrLabel4.Text = Utils.Common.GlobalVariable.COMPANY_NAME;           // 2021-11-03 김진우 주임 추가
        }
        ...
        public XRPUR1100(TN_PUR1100 masterObj) : this()
        {
            ...
            if (masterObj != null)
            {
                ...
                if(masterObj.TN_PUR1101List.Count > 0)
                {
                    ...
                    //cell_SumPoCost.Text = sumPoCost.GetDecimalNullToZero().ToString("#,#.##"); //단가 총 합계              // 2021-11-04 김진우 주임 주석처리
