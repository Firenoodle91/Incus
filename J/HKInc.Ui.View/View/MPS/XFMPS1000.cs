...
namespace HKInc.Ui.View.View.MPS
{
    ...
    public partial class XFMPS1000 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("MiddleCategory", LabelConvert.GetLabelText("MiddleCategory"), false);
            MasterGridExControl.MainGrid.AddColumn("BottomCategory", LabelConvert.GetLabelText("BottomCategory"), false);
            ...
            DetailGridExControl.MainGrid.AddColumn("FileData", "파일", false);
            ...
            DetailGridExControl.MainGrid.SetEditable(UserRight.HasEdit, "ProcessCode", "ProcessSeq", "MachineGroupCode", "FileName", "UseFlag", "ToolUseFlag", "OutProcFlag", "StdWorkDay");
        ...
        protected override void InitRepository()
        {
            ...
            //DetailGridExControl.MainGrid.MainView.Columns["FileName"].ColumnEdit.KeyDown += ColumnEdit_KeyDown;
              DetailGridExControl.MainGrid.MainView.Columns["FileName"].ColumnEdit = new Service.Controls.FileGridButtonEdit(gridEx2, "FileData", "FileName");
        ...
        private void MainView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            else if (e.Column.FieldName == "ProcessCode")
            {
                ...
                detailObj.ToolUseFlag = toolflag[0].ToolUseFlag.GetNullToN();
            }
        }
        ...
        private void AddTypeCallBack(object sender, HKInc.Utils.Common.PopupArgument e)
        {
            ...
            foreach (var v in processList)
            {
                var newObj = new TN_MPS1000()
                {
                    ...
                    //OutProcFlag = "N",
                    //RestartToFlag = v.RestartToFlag,
                    //JobSettingFlag = "N",
                    MachineFlag = "N",
                    ToolUseFlag = v.ToolUseFlag,
                    //StdWorkDay = "0"
                    StdWorkDay = v.StdWorkDay ,
