...
namespace HKInc.Ui.View.View.PUR
{
    ...
    public partial class XFPUR1200 : Service.Base.ListMasterDetailFormTemplate
    {
        ...
        {            
            lup_InId.SetDefault(true, "LoginId", "UserName", ModelService.GetChildList<User>(p => p.Active == "Y" && p.MainYn == "02").ToList());
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("InCustomerCode", LabelConvert.GetLabelText("InCustomerCode"));
            ...
            DetailGridExControl.MainGrid.AddColumn("TN_STD1100.StockInspFlag", LabelConvert.GetLabelText("StockInspFlag"), HorzAlignment.Center, false);
            DetailGridExControl.MainGrid.AddColumn("InInspectionState", LabelConvert.GetLabelText("InInspectionState"), HorzAlignment.Center, false);
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InId", ModelService.GetChildList<User>(p => p.Active == "Y" && p.MainYn == "02"), "LoginId", "UserName");
            ...
            //2021-11-08 조회조건 창고구분으로 변경, 업체 요청에 따라 조건 추가 될 수 있음 (ex. 소모품)
            DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("InWhCode", ModelService.GetChildList<TN_WMS1000>
                                                                            (p => p.WhDivision == MasterCodeSTR.WhCodeDivision_MAT && p.UseFlag == "Y")
                                                                             .ToList(), 
                                                                           "WhCode", DataConvert.GetCultureDataFieldName("WhName"), true);
