...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 대영 스타일 원소재교체
    /// </summary>
    public partial class XPFSRCIN_CHANGE_RUS : Service.Base.PopupCallbackFormTemplate
    {
        #region 전역변수
        ...
        public XPFSRCIN_CHANGE_RUS()
        {
            InitializeComponent();
        }

        public XPFSRCIN_CHANGE_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
