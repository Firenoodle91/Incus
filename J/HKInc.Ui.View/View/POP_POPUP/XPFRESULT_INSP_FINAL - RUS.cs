...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 실적등록 팝업 (기본)
    /// </summary>
    public partial class XPFRESULT_INSP_FINAL_RUS : Service.Base.PopupCallbackFormTemplate
    {
        ...
        TEMP_XFPOP_INSP_FINAL TEMP_XFPOP1000_Obj;
        protected BindingSource BadBindingSource = new BindingSource();
        public XPFRESULT_INSP_FINAL_RUS()
        {
            InitializeComponent(); BadBindingSource.DataSource = new List<fail_List>();// ModelService.GetChildList<temp_qty>(p => 1 == 1).ToList();
            gridEx1.DataSource = BadBindingSource;
            gridEx1.MainGrid.BestFitColumns();
        }

        public XPFRESULT_INSP_FINAL_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
        ...
        protected override void InitControls()
        {
            ...
            TEMP_XFPOP1000_Obj = (TEMP_XFPOP_INSP_FINAL)PopupParam.GetValue(PopupParameter.KeyValue);
        ...
        protected override void InitCombo()
        {
            ...
            //var machineGroupCode = TEMP_XFPOP1000_Obj.MachineCode.GetNullToNull();
