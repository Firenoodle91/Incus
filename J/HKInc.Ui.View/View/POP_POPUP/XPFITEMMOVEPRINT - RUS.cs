...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 이동표 출력
    /// </summary>
    public partial class XPFITEMMOVEPRINT_RUS : Service.Base.PopupCallbackFormTemplate
    {
        #region 전역변수
        ...
        #endregion
        public XPFITEMMOVEPRINT_RUS()
        {
            InitializeComponent();
        }

        public XPFITEMMOVEPRINT_RUS(PopupDataParam parameter, PopupCallback callback) : this()
        {
