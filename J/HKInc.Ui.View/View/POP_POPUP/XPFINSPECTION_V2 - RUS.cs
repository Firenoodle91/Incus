...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// </summary>
    public partial class XPFINSPECTION_V2_RUS : HKInc.Service.Base.ListFormTemplate
    {
        #region 전역변수
        ...
        public XPFINSPECTION_V2_RUS(TEMP_XFPOP1000 obj, string productLotNo)
        {
            InitializeComponent();
        ...
        protected override void InitCombo()
        {
            ...
            List<User> qcUser_Arr = QcModelService.GetChildList<User>(p => p.Active == "Y").ToList();
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("InspectionReportMemo", LabelConvert.GetLabelText("InspectionReportMemo"), HorzAlignment.Center, false);
            gridEx1.MainGrid.AddColumn("CheckSpec", LabelConvert.GetLabelText("CheckSpec"), HorzAlignment.Center, true);
            ...
            gridEx1.MainGrid.AddColumn("MaxReading", LabelConvert.GetLabelText("MaxReading"), HorzAlignment.Center, false);
            gridEx1.MainGrid.AddColumn("Reading1", "측정치", HorzAlignment.Center, true, 70);

            gridEx1.MainGrid.AddColumn("Reading2", LabelConvert.GetLabelText("Reading2"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading3", LabelConvert.GetLabelText("Reading3"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading4", LabelConvert.GetLabelText("Reading4"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading5", LabelConvert.GetLabelText("Reading5"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading6", LabelConvert.GetLabelText("Reading6"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading7", LabelConvert.GetLabelText("Reading7"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading8", LabelConvert.GetLabelText("Reading8"), HorzAlignment.Center, false, 70);
            gridEx1.MainGrid.AddColumn("Reading9", LabelConvert.GetLabelText("Reading9"), HorzAlignment.Center, false, 70);
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            foreach (var v in list)
            {
                var TN_QCT1101_NewObj = new TN_QCT1101()
                {
                    ...
                    ItemCode = v.ItemCode,
                    Seq = v.Seq,
                    FME_DIVISION = qcType == MasterCodeSTR.InspectionDivision_FME ? FME_checkpoint : MasterCodeSTR.CheckPoint_General,
                    CheckWay = v.CheckWay,
