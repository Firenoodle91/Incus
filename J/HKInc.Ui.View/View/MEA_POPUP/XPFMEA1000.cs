...
namespace HKInc.Ui.View.View.MEA_POPUP
{
    ...
    public partial class XPFMEA1000 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void AddControlList()
        {
            ...
            ControlEnableList.Add("ManufactureDate", dt_ManufactureDate);
            ControlEnableList.Add("Memo", tx_Memo);
            ControlEnableList.Add("MonitorLocation", lup_MonitorLocation);
            //ControlEnableList.Add("Class", lup_Class);
            //ControlEnableList.Add("ClassDate", dt_ClassDate);
            //ControlEnableList.Add("Score", spin_Score);
            //ControlEnableList.Add("MachineStopCheckManageFlag", chk_MachineStopCheckManageFlag);        // 2021-06-07 김진우 주임 추가         비가동 품질 관리 여부 추가
        ...
        protected override void InitCombo()
        {
            ...
            lup_MonitorLocation.SetDefault(true, "CodeVal", Service.Helper.DataConvert.GetCultureDataFieldName("CodeName"), DbRequestHandler.GetCommCode(MasterCodeSTR.MachineMonotoringLocation, 1));
            ...
            btn_FileName2.ButtonPressed += new HKInc.Service.Handler.EventHandler.FileButtonEditClickHandler(btn_FileName2, !UserRight.HasEdit, false, false).ButtonClick;
            ...
            btn_FileName3.ButtonPressed += new HKInc.Service.Handler.EventHandler.FileButtonEditClickHandler(btn_FileName3, !UserRight.HasEdit, false, false).ButtonClick;
            ...
            // 2022-10-13 김진우 추가
            chk_MonitoringYn.EditValueChanged += chk_MonitoringYn_EditValueChanged;
            if (chk_MonitoringYn.Checked)
                lup_MonitorLocation.Enabled = true;
            else
                lup_MonitorLocation.Enabled = false;
            lup_MonitorLocation.EditValueChanged += lup_MonitorLocation_EditValueChanged;
        }
        ...
        {
            //tx_MachineMCode.ReadOnly = true;      // 2022-10-16 김진우 주석처리
            //tx_MachineCode.ReadOnly = true;

            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                tx_MachineMCode.ReadOnly = true;       // 2022-10-19 김진우 추가
                var newObj = new TN_MEA1000()
                {
                    UseFlag = "Y",
                    Temp1 = "N",                // 2022-10-13 김진우 추가
                    DailyCheckFlag = "N",
            ...
            else
            {
                ...
                if (obj != null)
                {
                    ...
                    //{
                    //    chk_MonitoringYn.Checked = true;
                    //    lup_MonitorLocation.EditValue = obj.MonitorLocation;
                    //}
        ...
        protected override void DataSave()
        {
            ...
            string MonitoringLocation = lup_MonitorLocation.EditValue.GetNullToEmpty();         // 2022-10-13 김진우 추가

            if (EditMode == PopupEditMode.New)
            {
                // 2022-10-13 김진우 추가
                int b = Mea1000Service.GetList(p => p.MonitorLocation == MonitoringLocation && p.MachineMCode != obj.MachineMCode).Count;
                if (b >= 1)
                {
                    MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_177)));    // 중복된 모니터링 위치입니다.
                    return;
                }
        ...
        /// <param name="e"></param>
        private void lup_MonitorLocation_EditValueChanged(object sender, EventArgs e)
        {
            TN_MEA1000 Obj = ModelBindingSource.Current as TN_MEA1000;
            if (Obj == null) return;

            string EditValue = lup_MonitorLocation.EditValue.GetNullToEmpty();
            int b = Mea1000Service.GetList(p => p.MonitorLocation == EditValue && p.MachineMCode != Obj.MachineMCode).Count;
            if (b >= 1)
                MessageBoxHandler.Show(string.Format(MessageHelper.GetStandardMessage((int)StandardMessageEnum.M_177)));    // 중복된 모니터링 위치입니다.
        ...
        /// <summary>
        /// 모니터링 유무 체크해제시 위치값 제거 및 비활성화
        /// 2022-10-13 김진우 추가
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void chk_MonitoringYn_EditValueChanged(object sender, EventArgs e)
        {
            var Obj = ModelBindingSource.Current as TN_MEA1000;
