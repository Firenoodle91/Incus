...
namespace HKInc.Ui.View.SELECT_POPUP
{
    ...
    public partial class XSFMPS1200 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            GridExControl.MainGrid.AddColumn("ItemCode", LabelConvert.GetLabelText("ItemName"));
        ...
        protected override void DataLoad()
        {
            ...
            if (Constraint == "TN_PUR1400") //외주발주 디테일 추가 시
            {
                ...
                using (var context = new HKInc.Ui.Model.Context.ProductionContext(HKInc.Utils.Common.ServerInfo.GetConnectString(HKInc.Utils.Common.GlobalVariable.ProductionDataBase)))
                {
                    ...
                    var isnull = new SqlParameter("@NULL", "");

                   // var result = context.Database.SqlQuery<TEMP_XSFMPS1200>
                   //     ("USP_GET_XSFMPS1200 @NULL", isnull).ToList();

                    var result = context.Database.SqlQuery<TEMP_XSFMPS1200>
                        ("USP_GET_XSFMPS1200", "").ToList();
        ...
        protected override void Confirm()
        {
            ...
            if (IsmultiSelect)
            {
                ...
                var dataList = bindingSource.List as List<TEMP_XSFMPS1200>;
        ...
        private void MainView_RowClick(object sender, RowClickEventArgs e)
        {
            ...
            if (e.Clicks == 2)
            {
                var itemMaster = (TEMP_XSFMPS1200)bindingSource.Current;
                var returnList = new List<TEMP_XSFMPS1200>();
                if (itemMaster != null)
                    returnList.Add(itemMaster);
                param.SetValue(PopupParameter.ReturnObject, returnList);
