...
namespace HKInc.Service.Controls
{
    partial class GridControlEx
    {
        public void SetRepositoryItem(string fieldName, RepositoryItem item, bool CustomOnlyNumeric = false)
        {
            ...
            else if (item.GetType() == typeof(RepositoryItemDateEdit))
            {
                var con = item as RepositoryItemDateEdit;
                con.CellStyleProvider =  new CustomCellStyleProvider(con);
                con.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
            }
        }
        ...
        public RepositoryItemSpinEdit SetRepositoryItemSpinEdit(string fieldName, DefaultBoolean allownullinput = DefaultBoolean.Default, string editmask = "n0", bool usemaskasdisplayformat = true, bool spinButton = true)
        {
            ...
            obj.Buttons[0].Visible = false; //강제로 안보이게 요청함
            if (view.Columns[fieldName].OptionsColumn.ReadOnly)
                obj.Buttons[0].Visible = false;
            SetRepositoryItem(fieldName, obj);
            return obj;
        }
        public void SetRepositoryItemPictureEdit(string fieldName, int RowHeight, string NullText = "No Image", PictureSizeMode SizeMode = PictureSizeMode.Zoom)
        {
            RepositoryItemPictureEdit obj = new RepositoryItemPictureEdit();
            obj.CustomHeight = RowHeight;
            obj.SizeMode = SizeMode;
            obj.NullText = NullText;
            SetRepositoryItem(fieldName, obj);
        }
        
        public void SetRepositoryItemPictureEdit(string fieldName, string NullText = "No Image", PictureSizeMode SizeMode = PictureSizeMode.Zoom)
        {
            RepositoryItemPictureEdit obj = new RepositoryItemPictureEdit();
            obj.SizeMode = SizeMode;
            obj.NullText = NullText;
        ...
        public void SetRepositoryItemDateEdit(string fieldName, bool addDeleteButton = false, int? bestFitWidth = 110)
        {
            RepositoryItemDateEdit date = GetRepositoryItemDate(HKInc.Utils.Enum.DateFormat.Day);

            #region Event
            date.ButtonPressed += Lookup_ButtonPressed;
            #endregion

            if (addDeleteButton)
                AddButton(date, ButtonPredefines.Delete);

            if (bestFitWidth != null)
                date.BestFitWidth = (int)bestFitWidth;

            Columns[fieldName].AppearanceCell.TextOptions.HAlignment = HorzAlignment.Center;
            SetRepositoryItem(fieldName, date);
        }

        public void SetRepositoryItemDateEdit(string fieldName, HKInc.Utils.Enum.DateFormat dateFormat, bool addDeleteButton = false, int? bestFitWidth = 110)
        {
        ...
        public void SetRepositoryItemDateTimeEdit(string fieldName, bool addDeleteButton = false, int? bestFitWidth = 140)
        {
            RepositoryItemDateEdit date = GetRepositoryItemDate(HKInc.Utils.Enum.DateFormat.DateAndTime);

            //jdw 달력 Mask 설정 추가(HH:mm:ss 형식)
            date.CalendarTimeProperties.DisplayFormat.FormatString = "HH:mm:ss";
            date.CalendarTimeProperties.DisplayFormat.FormatType = FormatType.DateTime;
            date.CalendarTimeProperties.EditFormat.FormatString = "HH:mm:ss";
            date.CalendarTimeProperties.EditFormat.FormatType = FormatType.DateTime;
            date.CalendarTimeProperties.Mask.EditMask = "HH:mm:ss";
        ...
        public void SetRepositoryItemFullDateTimeEdit(string fieldName, bool addDeleteButton = false, int? bestFitWidth = 150)
        {
        ...
        public void SetRepositoryItemLookUpEdit(string fieldName, object dataSource, string valueMember = "CodeVal", string displayMember = "CodeName", bool addDeleteButton = false, bool addEllipsisButton = false, ButtonPressedEventHandler ellipsisButtonPressedHandler = null, string nullText = "", EventHandler gridLookUpBeforePopupHandler = null, TextEditStyles textEditStyles = TextEditStyles.DisableTextEditor)
        {
        ...
        /// <summary>
        /// 2021-07-15 김진우 주임 추가
        /// 기존에 ItemCode값이 Grid에 표시되어야 하는데 ItemName 값이 표시가 되어서 추가
        /// ItemName 값은 BOM 화면에서 사용하고 있어서 기존거 수정 불가하여 추가
        /// FieldName조건은 ItemCode 값이 기본
        /// </summary>
        /// <param name="fieldName"></param>
        /// <param name="dataSource"></param>
        /// <param name="valueMember"></param>
        /// <param name="displayMember"></param>
        /// <param name="addDeleteButton"></param>
        /// <param name="addEllipsisButton"></param>
        /// <param name="ellipsisButtonPressedHandler"></param>
        /// <param name="nullText"></param>
        /// <param name="gridLookUpBeforePopupHandler"></param>
        /// <param name="textEditStyles"></param>
        public void SetRepositoryItemCodeLookUpEdit(string fieldName, object dataSource, string valueMember = "ItemCode", string displayMember = "ItemCode", bool addDeleteButton = false, bool addEllipsisButton = false, ButtonPressedEventHandler ellipsisButtonPressedHandler = null, string nullText = "", EventHandler gridLookUpBeforePopupHandler = null, TextEditStyles textEditStyles = TextEditStyles.Standard)
        {
        ...
        public void SetRepositoryItemSearchLookUpEdit(string fieldName, object dataSource, string valueMember = "CodeVal", string displayMember = "CodeName", bool addDeleteButton = false, bool addEllipsisButton = false, ButtonPressedEventHandler ellipsisButtonPressedHandler = null, string nullText = "", EventHandler gridLookUpBeforePopupHandler = null, TextEditStyles textEditStyles = TextEditStyles.Standard)
        {
            ...
            //if (fieldName == "ItemCode" ) //품목LookUp Column Setting
            //{
            //    string displayMember1 = "ItemName1";

            //    ItemCodeColumnSettingEx(lookup, fieldName, valueMember, displayMember, displayMember1);
            //}

            //else if(fieldName == "ProductItemCode" || fieldName == "ToolCode")
            //{
            //    ItemCodeColumnSetting(lookup, fieldName, valueMember, displayMember);
            //}

            if (fieldName == "ItemCode" || fieldName == "ProductItemCode" || fieldName == "ToolCode") 
            {
                ItemCodeColumnSetting(lookup, fieldName, valueMember, displayMember);
            }
            ...
            {
                MachineMCodeColumnSetting(lookup, fieldName, valueMember, displayMember);
            }
            else
            {
                lookup.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
        ...
        private void AddButton(RepositoryItemDateEdit date, ButtonPredefines buttonKind)
        {
            if (this.Enabled)
            {
                date.Buttons.Add(new EditorButton() { Kind = buttonKind });
            }
        }
        ...
        private void DateEdit_ButtonPressed(object sender, ButtonPressedEventArgs e)
        {
        ...
        public void SetRepositoryItemButtonEdit(string fieldName, ButtonPressedEventHandler handler, string buttonCaption, TextEditStyles textEditStyle = TextEditStyles.HideTextEditor, float fontSize = 9)
        {
            RepositoryItemButtonEdit edit = new RepositoryItemButtonEdit();
            edit.TextEditStyle = textEditStyle;
            edit.Buttons.Clear();

            EditorButton btn = new EditorButton(ButtonPredefines.Glyph);
            btn.Caption = buttonCaption;
            btn.Appearance.Font = new Font(HKInc.Utils.Common.GlobalVariable.DefaultFontName, fontSize);
            btn.Appearance.ForeColor = Color.Blue;
            edit.Buttons.Add(btn);

            edit.ButtonClick += handler;

            SetRepositoryItem(fieldName, edit);
        }

        public void SetRepositoryItemButtonEdit(string fieldName, ButtonPressedEventHandler handler, string buttonCaption, Font font, TextEditStyles textEditStyle = TextEditStyles.HideTextEditor)
        {
            RepositoryItemButtonEdit edit = new RepositoryItemButtonEdit();
            edit.TextEditStyle = textEditStyle;
            edit.Buttons.Clear();
        ...
        public RepositoryItemCheckEdit SetRepositoryItemCheckEdit(string fieldName, string nullValue = null)
        {
        ...
        private void ItemCodeColumnSettingEx(RepositoryItemSearchLookUpEdit edit, string fieldName, string valueMember, string displayMember, string displayMember1)
        {
            edit.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
            {
                FieldName = valueMember,
            ...
            edit.View.Columns.Add(new DevExpress.XtraGrid.Columns.GridColumn
            {
                FieldName = displayMember1,
                Caption = HelperFactory.GetLabelConvert().GetLabelText(displayMember1),
                Visible = true
            });
