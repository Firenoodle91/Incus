...
namespace HKInc.Service.Controls
{
    public class FileGridButtonEdit : GridButtonEdit
    {
        ...
        public FileGridButtonEdit(GridEx gridEx, bool userRight, string fileField = "File", string fileNameField = "FileName")
        {
            ...
            SetFileButtonEdit((GridView)gridEx.MainGrid.MainView, fileField, fileNameField, userRight);
        }
        ...
        private void SetFileButtonEdit(GridView gv, string fileField, string fileNameField, bool? btnShow = null)
        {
            ...
            if (btnShow != null && btnShow == false)
            {
                Buttons.Clear();
                Buttons.Add(new EditorButton(ButtonPredefines.Search));
                //Buttons.Remove(ButtonPredefines.Ellipsis);
            }
            else
            {
                Buttons.Add(new EditorButton(ButtonPredefines.Search));
