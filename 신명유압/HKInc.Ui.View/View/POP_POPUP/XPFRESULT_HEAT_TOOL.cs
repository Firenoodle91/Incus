...
namespace HKInc.Ui.View.View.POP_POPUP
{
    ...
    /// 실적등록 팝업 (열처리_툴교체)
    /// </summary>
    public partial class XPFRESULT_HEAT_TOOL : Service.Base.PopupCallbackFormTemplate
    {
        ...
        public XPFRESULT_HEAT_TOOL()
        {
            InitializeComponent();
        }

        public XPFRESULT_HEAT_TOOL(PopupDataParam parameter, PopupCallback callback) : this()
        {
