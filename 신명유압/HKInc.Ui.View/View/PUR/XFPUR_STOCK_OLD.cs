...
namespace HKInc.Ui.View.View.PUR
{
    ...
    /// 자재재고관리
    /// </summary>
    public partial class XFPUR_STOCK_OLD : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            DetailGridExControl.MainGrid.AddColumn("InOutQty", LabelConvert.GetLabelText("InOutQty"), HorzAlignment.Far, FormatType.Numeric, "#,0.##");
        ...
        protected override void DataLoad()
        {
            ...
            //else
            //{
            searchYearMonthDate = DateTime.Today;// new DateTime(searchDivision.Left(4).GetIntNullToZero(), searchDivision.Substring(5).GetIntNullToZero(), 1);
