...
namespace HKInc.Ui.View.View.REPORT
{
    ...
    /// 출고증
    /// </summary>
    public partial class XRORD1101 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XRORD1101()
        {
            ...
            cell_OrderSeq.BeforePrint += Cell_OrderSeq_BeforePrint;;
            cell_OutDate.BeforePrint += Cell_OutDate_BeforePrint;
            cell_CarType.BeforePrint += Cell_CarType_BeforePrint;
        ...
        public XRORD1101(List<TN_ORD1101> list) : this()
        {
        ...
        private void Cell_StockQty_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else
            {
                ...
                if (stockObj == null)
                    ...
                    cell_StockQty.Text = stockObj.SumStockQty.ToString("#,#.##");
            }
        }

        private void Cell_OrderSeq_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (cell_OrderSeq.Text == "0")
                cell_OrderSeq.Text = string.Empty;
        }

        private void Cell_OutDate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (cell_OutDate.Text == "0001-01-01")
                cell_OutDate.Text = string.Empty;
        }
