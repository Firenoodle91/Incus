...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_MPS1000 : BaseDomain.MES_BaseDomain
    {
        ...
        [Key,Column("PROCESS_CODE",Order =1), Required(ErrorMessage = "공정명은 필수입니다")] public string ProcessCode { get; set; }
        [Column("PROCESS_SEQ"), Required(ErrorMessage = "공정순서는 필수입니다")] public Nullable<int> ProcessSeq { get; set; }
