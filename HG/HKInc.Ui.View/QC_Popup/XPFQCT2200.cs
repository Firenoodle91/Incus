...
namespace HKInc.Ui.View.QC_Popup
{
    public partial class XPFQCT2200 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void InitCombo()
        {
            ...
            lup_item.SetDefault(false, "ItemCode", "ItemNm1", MEA1000Service.GetChildList<TN_STD1100>(p => p.UseYn == "Y").OrderBy(o => o.ItemNm1).ToList());
        ...
        protected override void DataLoad()
        {
            ...
            {
                ModelBindingSource.Add(new TN_QCT2200 { No = DbRequesHandler.GetRequestNumberNew("RQC")});
        ...
        protected override void DataSave()
        {
            ...
            param.SetValue(PopupParameter.GridRowId_1, obj.No);
