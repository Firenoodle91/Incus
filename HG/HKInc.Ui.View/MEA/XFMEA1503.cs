...
namespace HKInc.Ui.View.MEA
{
    ...
    public partial class XFMEA1503 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("MoldClass", DbRequesHandler.GetCommCode(MasterCodeSTR.MOLDCLASS), "Mcode", "Codename");
        ...
        protected override void MasterFocusedRowChanged()
        {
            ...
            DetailGridBindingSource.DataSource = obj.Mold003List.OrderBy(o=>o.InoutDt).ToList();
