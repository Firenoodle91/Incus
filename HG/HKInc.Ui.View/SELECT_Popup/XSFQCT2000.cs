...
{
    public partial class XSFQCT2000 : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        IService<VI_ADD_QC2000_LIST> ModelService = (IService<VI_ADD_QC2000_LIST>)ProductionFactory.GetDomainService("VI_ADD_QC2000_LIST");
        ...
        public XSFQCT2000(PopupDataParam parameter, PopupCallback callback) :this()
        {
            dp_workdt.DateFrEdit.DateTime = DateTime.Today.AddDays(-20);
            dp_workdt.DateToEdit.DateTime = DateTime.Today.AddDays(20);
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("PackQty", "포장수량", HorzAlignment.Far, FormatType.Numeric, "n0");
        ...
        protected override void Confirm()
        {
            ...
            param.SetValue(PopupParameter.ReturnObject, ModelService.Detached((VI_ADD_QC2000_LIST)bindingSource.Current));           
