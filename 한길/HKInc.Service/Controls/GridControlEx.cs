    ...
    public partial class GridControlEx : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void View_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            else
            {
                ...
                if (KeyCheck != null && type.GetProperty("NewRowFlag").GetValue(currentObj).ToString() == "N")
                {
                    MessageBoxHandler.Show("Key 값은 수정이 불가합니다.", "경고");
                    EditProperty.SetValue(currentObj, gv.ActiveEditor.OldEditValue.GetNullToEmpty());
