...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_STD1400 : BaseDomain.MES_BaseDomain
    {
        ...
        [Key, Column("CUSTOMER_CODE",Order = 0), StringLength(20), Required(ErrorMessage = "거래처코드는 필수입니다.")]
        public string CustomerCode { get; set; }

        [Column("CUSTOMER_NAME"), StringLength(100), Required(ErrorMessage = "거래처명은 필수입니다.")]
        ...
        [Column("USE_PLAG"), Required(ErrorMessage = "사용여부는 필수입니다.")]
