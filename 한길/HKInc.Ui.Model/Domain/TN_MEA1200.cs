...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_MEA1200 : BaseDomain.MES_BaseDomain
    {
        ...
        [Key,Column("INSTR_NO",Order =0), Required(ErrorMessage = "계측기코드는 필수입니다")] public string InstrNo { get; set; }
        [Column("INSTR_NM"), Required(ErrorMessage = "계측기명은 필수입니다")] public string InstrNm { get; set; }
