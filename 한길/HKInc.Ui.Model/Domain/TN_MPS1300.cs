...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_MPS1300 : BaseDomain.MES_BaseDomain
    {
        ...
        [Column("PLAN_QTY"), Required(ErrorMessage = "계획수량은 필수입니다")] public int PlanQty { get; set; }
        [Column("DELIV_DATE")] public Nullable<DateTime> DelivDate { get; set; }
        [Column("PLAN_STARTDT"), Required(ErrorMessage = "계획시작일은 필수입니다")] public Nullable<DateTime> PlanStartdt { get; set; }
        [Column("PLAN_ENDDT"), Required(ErrorMessage = "계획종료일은 필수입니다")] public Nullable<DateTime> PlanEnddt { get; set; }
        ...
        [ForeignKey("DelivSeq")]
        public virtual VI_MPSPLAN_LIST VI_MPSPLAN_LIST { get; set; }
    }
}
