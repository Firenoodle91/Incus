...
namespace HKInc.Ui.View.SYS
{
    ...
    {                
        ...
        {
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("Rank", MasterCode.GetMasterCode(27).ToList());
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("DepartmentCode", UserGroupService.GetChildList<UserDepartment>(p => 1 == 1), "DepartmentCode", "DepartmentName");
