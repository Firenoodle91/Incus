...
namespace HKInc.Ui.View.SYS
{
    ...
    {                
        ...
        protected override void InitCombo()
        {
            ...
            lupGroupCode.SetDefault(true, "Mcode", "Codename", Service.Service.DbRequesHandler.GetCommCode(MasterCodeSTR.NationalCode), DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor);
        ...
        protected override void InitRepository()
        {
            ...
            gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("UserGroupId", userGroupList, "UserGroupId", HKInc.Service.Helper.LookUpFieldHelper.GetCultureFieldName("UserGroup"));
        }
        ...
        protected override void DataSave()
        {
            ...
            if(!textPassword.EditValue.GetNullToEmpty().IsNullOrEmpty())
                TextPassword_Validated(sender: null, e: null);
