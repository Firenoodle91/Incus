...
namespace HKInc.Ui.View.ORD
{
    ...
    public partial class XFOUT1101 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("ItemCode", "스페어파트코드",true, HorzAlignment.Center);
            MasterGridExControl.MainGrid.AddColumn("ItemNm", "스페어파트명", true, HorzAlignment.Center);
        ...
        protected override void InitRepository()
        {
            ...
            MasterGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("SrcCode", ModelService.GetChildList<TN_STD1100>(P => P.UseYn == "Y"&&(P.TopCategory=="P03"||P.TopCategory == "P02")).OrderBy(o => o.ItemNm1).ToList(), "ItemCode", "ItemNm1");
            ...
            MasterGridExControl.MainGrid.MainView.Columns["Memo1"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(MasterGridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            MasterGridExControl.MainGrid.MainView.Columns["Memo2"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(MasterGridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            MasterGridExControl.MainGrid.MainView.Columns["Memo3"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(MasterGridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            MasterGridExControl.MainGrid.SetRepositoryItemSpinEdit("SafeQty");
            ...
            DetailGridExControl.MainGrid.SetRepositoryItemSpinEdit("Retqty");
        ...
        protected override void DataLoad()
        {
            ...
            MasterGridBindingSource.DataSource = ModelService.GetList(p => (string.IsNullOrEmpty(item) ? true : p.ItemCode == item)
                                                                     )
        ...
        private void LoadDetail()
        {
            ...
            DetailGridBindingSource.DataSource = obj.OUT1101List.ToList();
        ...
        {
            TN_STD1101 obj = new TN_STD1101() { ItemCode = DbRequesHandler.GetRequestNumberNew("SITEM") };
        ...
        protected override void DetailAddRowClicked()
        {
            ...
            obj.OUT1101List.Add(nobj);
        }

        protected override void DeleteDetailRow()
        {
            TN_STD1101 MasterObj = MasterGridBindingSource.Current as TN_STD1101;
            if (MasterObj == null) return;
            TN_OUT1101 obj = DetailGridBindingSource.Current as TN_OUT1101;
            if (obj == null) return;
            DetailGridBindingSource.RemoveCurrent();
            MasterObj.OUT1101List.Remove(obj);
        }
