...
namespace HKInc.Ui.View.STD
{
    public partial class XFSTD1500 :  HKInc.Service.Base.TreeListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            TreeListExControl.AddColumn("TN_STD1100.ItemNm", LabelConvert.GetLabelText("품명"), DevExpress.Utils.HorzAlignment.Center);
            //TreeListExControl.AddColumn("Spec1", LabelConvert.GetLabelText("규격1"), DevExpress.Utils.HorzAlignment.Center); 
            //TreeListExControl.AddColumn("Spec2", LabelConvert.GetLabelText("규격2"), DevExpress.Utils.HorzAlignment.Center); 
            //TreeListExControl.AddColumn("Spec3", LabelConvert.GetLabelText("규격3"), DevExpress.Utils.HorzAlignment.Center); 
            //TreeListExControl.AddColumn("Spec4", LabelConvert.GetLabelText("규격4"), DevExpress.Utils.HorzAlignment.Center);
            TreeListExControl.AddColumn("Spec1", "원재료)");
            TreeListExControl.AddColumn("Spec2", "색상)");
            TreeListExControl.AddColumn("Spec3", "재료규격");
            TreeListExControl.AddColumn("Temp2", "실리콘농도");
            TreeListExControl.AddColumn("Spec4", "제품규격");
        ...
        protected override void DataLoad()
        {
            ...
            TreeListBindingSource.DataSource = BomMasterService.GetList(p => string.IsNullOrEmpty(ItemCode) ? true : (p.TN_STD1100.ItemNm.Contains(ItemCode) || p.TN_STD1100.ItemNm1.Contains(ItemCode)))
