...
namespace HKInc.Ui.View.STD
{
    ...
    public partial class XFSTD1700 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        protected override void InitRepository()
        {
            ...
            GridExControl.MainGrid.MainView.Columns["ChgNote"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.MainView.Columns["ChgMemo"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.MainView.Columns["Memo1"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.MainView.Columns["Memo2"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.MainView.Columns["Memo3"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            GridExControl.MainGrid.MainView.Columns["Memo4"].ColumnEdit = new HKInc.Service.Controls.CommentGridButtonEdit(GridExControl, UserRight.HasEdit, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
                        
            GridExControl.MainGrid.MainView.Columns["ChkQcfile1cha"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true,"ChkQcfile1cha");
            GridExControl.MainGrid.MainView.Columns["ChkQcfile2cha"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "ChkQcfile2cha");
            GridExControl.MainGrid.MainView.Columns["ChkQcfile3cha"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "ChkQcfile3cha");
            GridExControl.MainGrid.MainView.Columns["EtcFile1"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "EtcFile1");
            GridExControl.MainGrid.MainView.Columns["EtcFile2"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "EtcFile2");
            GridExControl.MainGrid.MainView.Columns["EtcFile3"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "EtcFile3");
            GridExControl.MainGrid.MainView.Columns["EtcFile4"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "EtcFile4");
            GridExControl.MainGrid.MainView.Columns["EtcFile5"].ColumnEdit = new HKInc.Service.Controls.ftpFileGridButtonEdit(GridExControl, true, "EtcFile5");
            ...
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ChgCust", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList(), "CustomerCode", "CustomerName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ReqCust", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList(), "CustomerCode", "CustomerName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ChkCust1cha", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList(), "CustomerCode", "CustomerName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ChkCust2cha", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList(), "CustomerCode", "CustomerName");
            GridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("ChkCust3cha", ModelService.GetChildList<TN_STD1400>(p => p.UseFlag == "Y").ToList(), "CustomerCode", "CustomerName");
        ...
        protected override void DataLoad()
        {
            ...
            GridBindingSource.DataSource = ModelService.GetList(p => string.IsNullOrEmpty(itemcode) ? true : (p.TN_STD1100.ItemNm.Contains(itemcode) || p.TN_STD1100.ItemNm1.Contains(itemcode)))
