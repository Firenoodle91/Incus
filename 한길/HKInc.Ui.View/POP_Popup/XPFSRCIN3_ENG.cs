...
{
    public partial class XPFSRCIN3_ENG : XtraForm
    {
        ...
        public XPFSRCIN3_ENG()
        {
            InitializeComponent();
            this.Text = "Raw material and knife input processing";
        ...
        private void XPFSRCIN3_ENG_Load(object sender, EventArgs e)
        {
        ...
        private void tx_srcin_KeyDown(object sender, KeyEventArgs e)
       {
        ...
        private void SrcInfo(string tx,string idx)
        {
            ...
            if (dt == null)
            {
                ...
                MessageBox.Show("There is no raw material available.", "Warning");          
            }
            else
            {                
                switch (idx)
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            if (tx_srcname1.Text == "")
            {
                MessageBox.Show("Check the raw materials.", "Warning");
                return;
            }
