...
namespace HKInc.Ui.View.POP_Popup
{
    ...
    /// POP실적등록창
    /// </summary>
    public partial class XPFQTYIN2 : XtraForm
    {
        ...
        public XPFQTYIN2(TP_POPJOBLIST obj, string lotno, string processName)
        {
            InitializeComponent();
        ...
        private void GridColumnInit()
        {
            ...
            gridEx1.SetToolbarButtonCaption(GridToolbarButton.AddRow, "불량추가[F3]");
            gridEx1.SetToolbarButtonVisible(GridToolbarButton.DeleteRow, true);
            gridEx1.SetToolbarButtonCaption(GridToolbarButton.DeleteRow, "불량삭제[F7]");
            gridEx1.SetToolbarButtonFont(new Font("Tahoma", 14.25f, FontStyle.Bold));
            ...
            gridEx1.MainGrid.AddColumn("FailCode", "불량유형", HorzAlignment.Center, true);
            gridEx1.MainGrid.AddColumn("FailQty", "불량수량", HorzAlignment.Far, true);
            ...
            {
                ap.Font = new Font("Tahoma", 14.25f, FontStyle.Bold);
            }
        ...
        private bool PackLabelPrint()
        {
            ...
            else
            {
                ...
                POP_Popup.XPFPACKLABEL form = new POP_Popup.XPFPACKLABEL(qty- badQty, tn1401.LotNo, ItemObj.ItemNm1, ItemObj.ItemNm, tn1401, ItemObj.StdPackQty.GetIntNullToZero());
