...
namespace HKInc.Ui.View.MEA_Popup
{
    public partial class XPFMEA1200 : HKInc.Service.Base.ListEditFormTemplate
    {
        ...
        protected override void InitControls()
        {
            ...
            lcMachineMaker.SetDefault(false, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.TOOLMAKER));
        ...
        protected override void DataLoad()
        {
            if (EditMode == PopupEditMode.New) // 신규 추가
            {
                ...
                ModelBindingSource.Add(new TN_MEA1200 { InstrNo = DbRequestHandler.GetRequestNumberNew("INS") ,UseYn="Y"});
