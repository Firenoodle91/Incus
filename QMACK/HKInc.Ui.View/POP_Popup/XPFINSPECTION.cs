...
namespace HKInc.Ui.View.POP_Popup
{
    ...
    public partial class XPFINSPECTION : HKInc.Service.Base.ListFormTemplate
    {
        ...
        public XPFINSPECTION(TP_XFPOP1000_V2_LIST obj, string productLotNo)
        {
            InitializeComponent();
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("ProcessGu", "검사종류");
            gridEx1.MainGrid.AddColumn("CheckName", "검사항목");
            gridEx1.MainGrid.AddColumn("CheckProv", "검사방법");
            gridEx1.MainGrid.AddColumn("CheckStand", "규격");
            gridEx1.MainGrid.AddColumn("UpQuad", "상한", HorzAlignment.Center, true);

            gridEx1.MainGrid.AddColumn("DownQuad", "하한", HorzAlignment.Center, true);            
            ...
            gridEx1.MainGrid.AddColumn("CheckFlag", "판정");
