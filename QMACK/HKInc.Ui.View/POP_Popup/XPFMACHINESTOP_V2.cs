...
namespace HKInc.Ui.View.POP_POPUP
{
    ...
    public partial class XPFMACHINESTOP_V2 : Service.Base.BaseForm
    {
        ...
        public XPFMACHINESTOP_V2(TP_XFPOP1000_V2_LIST tempObj)
        {
            InitializeComponent();
        ...
        // 미사용 주석
        public XPFMACHINESTOP_V2(TP_XFPOP1000_V2_LIST tempObj, bool bPLC)
        {
            //InitializeComponent();
        ...
        protected override void InitControls()
        {
            ...
            List<TN_STD1000> stop_Arr = DbRequestHandler.GetCommCode(MasterCodeSTR.STOPTYPE);
