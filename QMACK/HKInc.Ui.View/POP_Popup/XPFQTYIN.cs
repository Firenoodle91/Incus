...
namespace HKInc.Ui.View.POP_Popup
{
    public partial class XPFQTYIN : XtraForm
    {
        ...
        public XPFQTYIN(TP_POPJOBLIST obj,string lotno)
        {
            ...
            lup_fail.SetDefault(true, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.QCFAIL));
            lup_stop.SetDefault(true, "Mcode", "Codename", DbRequestHandler.GetCommCode(MasterCodeSTR.STOPTYPE, "", "", ""));
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
           ...
           int badqty = tx_sumbad.EditValue.GetIntNullToZero();
            ...
            int seq = DbRequestHandler.GetRowCount("exec SP_MPS1405_CNT '" + lsobj.WorkDate + "','" + lsobj.WorkNo + "','" + lsobj.Process + "'") == 0 ? 1 : DbRequestHandler.GetRowCount("exec SP_MPS1405_CNT '" + lsobj.WorkDate + "','" + lsobj.WorkNo + "','" + lsobj.Process + "'") + 1;
            ...
            string sql2= ",'" + SUMQTY + "', '" + badqty + "', getdate() ,'"+ lupWork.EditValue.GetNullToEmpty() + "') ";
               int s = DbRequestHandler.SetDataQury(sql+sql1+sql2);
            if (badqty > 0)
            {                
                ...
                for (int i = 0; i < gv.RowCount; i++)
                {
                    TN_MPS1404 nobj = new TN_MPS1404()
                    {
                        ...
                        WorkNo = tn.WorkNo,
                        Seq = DbRequestHandler.GetRowCount("exec SP_MPS1404_CNT '" + tn.WorkDate + "','" + tn.WorkNo + "','" + tn.ProcessCode + "'") == 0 ? 1 : DbRequestHandler.GetRowCount("exec SP_MPS1404_CNT '" + tn.WorkDate + "','" + tn.WorkNo + "','" + tn.ProcessCode + "'") + 1,
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            obj.StopSeq = DbRequestHandler.GetRequestNumber("STOP");
