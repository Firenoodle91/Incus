...
namespace HKInc.Ui.View.POP_POPUP
{
    ...
    public partial class XPFMACHINECHECK : Service.Base.ListFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            gridEx1.MainGrid.AddColumn("CheckPosition", "점검위치");
            gridEx1.MainGrid.AddColumn("CheckList", "점검항목");
            gridEx1.MainGrid.AddColumn("CheckWay", "점검방법");
            gridEx1.MainGrid.AddColumn("Temp", false);
            gridEx1.MainGrid.AddColumn("CheckCycle", "점검주기");

            gridEx1.MainGrid.AddColumn("CheckStandardDate", "점검기준일");
            gridEx1.MainGrid.AddColumn("ManagementStandard", "관리기준");
            gridEx1.MainGrid.AddColumn("LastCheckDate", "최종점검일", HorzAlignment.Center, FormatType.DateTime, "yyyy-MM-dd");
            gridEx1.MainGrid.AddColumn("CheckValue", "점검", HorzAlignment.Center, true);
            gridEx1.MainGrid.AddColumn("Temp2", "최종점검자", HorzAlignment.Center, true);
