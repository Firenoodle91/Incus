...
namespace HKInc.Ui.View.QC
{
    ...
    /// 초중종검사관리
    /// </summary>
    public partial class XFQC1200 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void DataLoad()
        {
            ...
            MasterGridBindingSource.DataSource = ModelService.GetList(p => (p.CheckDate >= dp_procdate.DateFrEdit.DateTime && p.CheckDate <= dp_procdate.DateToEdit.DateTime)
                                                                        ...
                                                                        && p.FmeNo == MasterCodeSTR.FMECheckManagement)
        ...
        protected override void AddRowClicked()
        {
            ...
            param.SetValue(PopupParameter.Value_1, MasterCodeSTR.FMECheckManagement);         // 2022-03-10 김진우 추가

            IPopupForm form = ProductionPopupFactory.GetPopupForm(ProductionPopupView.XSFQCT, param, AddList);       // 2022-03-10 김진우 수정        SELECTMPS1401LIST => XSFQCT
            form.ShowPopup(true);
        }
        ...
        private void AddList(object sender, HKInc.Utils.Common.PopupArgument e)
        {
            ...
            QCT1200.No = DbRequestHandler.GetRequestNumber(MasterCodeSTR.FMECheckManagement);
            QCT1200.FmeNo = MasterCodeSTR.FMECheckManagement;
            QCT1200.WorkNo = partList.WorkNo;
            QCT1200.WorkDate = partList.WorkDate;
            QCT1200.CheckDate = DateTime.Today;
            QCT1200.FmeDivision = DbRequestHandler.GetCellValue("exec SP_QCSTEP_STEP '" + MasterCodeSTR.FMECheckManagement + "','" + partList.WorkDate + "','" + partList.WorkNo + "','" + partList.ProcessCode + "','" + DateTime.Today + "'", 0);
            QCT1200.ItemCode = partList.ItemCode;
            QCT1200.LotNo = partList.LotNo;
            QCT1200.ProcessCode = partList.ProcessCode;
            QCT1200.CheckResult = "NG";                                         // 2022-02-15 김진우 추가
            QCT1200.TN_STD1100 = ModelService.GetChildList<TN_STD1100>(p => p.ItemCode == partList.ItemCode).FirstOrDefault();          // 2022-02-15 김진우 추가
        ...
        protected override void DetailAddRowClicked()
        {
            ...
            List<TN_QCT1000> qc = ModelService.GetChildList<TN_QCT1000>(p => p.ItemCode == obj.ItemCode && p.ProcessGu == MasterCodeSTR.FMECheckManagement && p.ProcessCode == obj.ProcessCode && p.UseYn == "Y").ToList();
