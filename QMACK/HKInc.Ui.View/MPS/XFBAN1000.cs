    ...
    public partial class XFBAN1000 :  HKInc.Service.Base.ListMasterDetailFormTemplate
    {
      ...
      //  IService<TN_PUR1301> DtlModelService = (IService<TN_PUR1301>)ProductionFactory.GetDomainService("TN_PUR1301");
        ...
        private void MainView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (wh.Count >= 1)
            {
                DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("WhPosition", wh, "WhPositionCode", "WhPositionName");       // 2021-11-04 김진우 주임 수정

            }
            else
            {
                wh.Add(new TN_WMS2000() { WhPositionCode = "", WhPositionName = "" });                                                      // 2021-11-04 김진우 주임 수정
                DetailGridExControl.MainGrid.SetRepositoryItemSearchLookUpEdit("WhPosition", wh, "WhPositionCode", "WhPositionName");       // 2021-11-04 김진우 주임 수정
        ...
        protected override void AddRowClicked()
        {
            ...
            {
                InputNo = DbRequestHandler.GetRequestNumber("BIN"),
