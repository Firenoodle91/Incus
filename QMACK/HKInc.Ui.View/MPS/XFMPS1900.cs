...
namespace HKInc.Ui.View.MPS
{
    ...
    public partial class XFMPS1900 : HKInc.Service.Base.ListMasterDetailFormTemplate
    {
        ...
        protected override void InitGrid()
        {
            ...
            MasterGridExControl.MainGrid.AddColumn("P01", "컷팅", HorzAlignment.Far, FormatType.Numeric, "#,###.##");
            MasterGridExControl.MainGrid.AddColumn("P02", false);
            MasterGridExControl.MainGrid.AddColumn("P03", "면취", HorzAlignment.Far, FormatType.Numeric, "#,###.##");
            MasterGridExControl.MainGrid.AddColumn("P04", "가공", HorzAlignment.Far, FormatType.Numeric, "#,###.##");
            MasterGridExControl.MainGrid.AddColumn("P05", false);
            MasterGridExControl.MainGrid.AddColumn("P06", "검사포장", HorzAlignment.Far, FormatType.Numeric, "#,###.##");
