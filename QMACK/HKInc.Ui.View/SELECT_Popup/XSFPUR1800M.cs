...
namespace HKInc.Ui.View.SELECT_Popup
{
    public partial class XSFPUR1800M : HKInc.Service.Base.PopupCallbackFormTemplate
    {
        ...
        {
            //gridEx1.MainGrid.SetRepositoryItemSearchLookUpEdit("WorkId", ModelService.GetChildList<UserView>(p => p.Active == "Y").ToList(), "LoginId", "UserName");        // 2022-01-25 김진우 대리 추가         추후 확인
