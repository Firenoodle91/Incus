...
namespace HKInc.Ui.View.POP
{
    public partial class XFPOP002 : HKInc.Service.Base.ListFormTemplate
    {
        ...
        private void inicombo()
        {
            ...
            luptem.EditValue = DbRequestHandler.GetCellValue("SELECT [Property8]  FROM [VI_USER] where LoginId='" + HKInc.Ui.Model.BaseDomain.GsValue.UserId + "'", 0);
        ...
        private void jobstart()
        {
            ...
            if (obj.PSeq == 1)
            {
                if (obj.JobStatus == ((int)MasterCodeEnum.POP_Status_Wait).ToString())
                {
                    ...
                    if (fm.DialogResult == System.Windows.Forms.DialogResult.OK)
                    {
                     ...
                     ",@srclot7='" + fm.returnval[15] + "'";
                        ...
                        string slotno = DbRequestHandler.GetCellValue(sql, 0);
                ...
                {
                    DataSet ds1 = DbRequestHandler.GetDataQury("exec SP_LOTMAKE @workno='" + obj.WorkNo + "',@date='" + DateTime.Today.ToString("yyyyMMdd") + "'");
