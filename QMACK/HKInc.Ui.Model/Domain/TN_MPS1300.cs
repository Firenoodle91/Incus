...
namespace HKInc.Ui.Model.Domain
{
    ...
    public class TN_MPS1300 : BaseDomain.MES_BaseDomain
    {
        ...
        [Column("DELIV_DATE")] public DateTime? DelivDate { get; set; }        //Nullable<DateTime> => DateTime?
        [Column("PLAN_STARTDT")] public DateTime PlanStartdt { get; set; }     //Nullable<DateTime> => DateTime?
        [Column("PLAN_ENDDT")] public DateTime? PlanEnddt { get; set; }         //Nullable<DateTime> => DateTime?
