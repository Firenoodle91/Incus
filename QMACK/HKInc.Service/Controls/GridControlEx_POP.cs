...
namespace HKInc.Service.Controls
{
    ...
    public partial class GridControlEx_POP : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void Grid_LayoutSave_Pmenu_Click(object sender, EventArgs e)
        {
            ...
            if (obj != null)
            {
                DialogResult result = Handler.MessageBoxHandler.Show("등록된 UI가 있습니다. 덮어 씌우시겠습니까?", FieldNameConverter.GetLabelText("Confirm"), MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    ModelService.Save();
                    Handler.MessageBoxHandler.Show("UI가 저장되었습니다.", FieldNameConverter.GetLabelText("Confirm"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
        ...
        private void View_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            else
            {
                ...
                if (EditProperty != null)
                {
                    ...
                    {
                        MessageBoxHandler.Show("기본키는 수정활 수 없습니다.");
        ...
        public void GridLayoutInit()
        {
            ...
            ModelService.Dispose();
            MessageBoxHandler.Show("UI가 초기화되었습니다. 화면을 닫고 재실행하시기 바랍니다. ");
        }
