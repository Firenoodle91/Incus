...
namespace HKInc.Service.Controls
{
    public class CommentGridButtonEdit : GridButtonEdit
    {
        ...
        /// <summary>
        /// 20220313 오세완 차장 
        /// XPFMACHINECHECK때문에 추가 
        /// </summary>
        /// <param name="gridEx_POP"></param>
        /// <param name="hasEdit"></param>
        /// <param name="textEditStyle"></param>
        public CommentGridButtonEdit(GridEx_POP gridEx_POP, bool hasEdit = false, TextEditStyles textEditStyle = TextEditStyles.DisableTextEditor)
        {
            SetCommentButtonEdit((GridView)gridEx_POP.MainGrid.MainView, hasEdit, textEditStyle);
        }
