...
namespace HKInc.Utils.Common
{
    static class DefaultValueList
    {
        ...
        private static readonly string RegistryCompanyName = @"\HKIncMES_QMack";   // 2022-01-28 김진우 대리     로그인시 사업관리시스템 아이디와 중복되어서 변경
        ...
        private static readonly Dictionary<Enum.DefaultValue, string> DefaultStringValueList = new Dictionary<Enum.DefaultValue, string>()
        {
            ...
            {Enum.DefaultValue.DefaultFontName,             @"맑은 고딕"},  // 2022-01-28 김진우 대리        소수점 , . 구분 안되서 변경
